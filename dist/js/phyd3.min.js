...
$jscomp.polyfill=function(b,d,a,e){if(d){a=$jscomp.global;b=b.split(".");for(e=0;e<b.length-1;e++){var g=b[e];g in a||(a[g]={});a=a[g]}b=b[b.length-1];e=a[b];d=d(e);d!=e&&null!=d&&$jscomp.defineProperty(a,b,{configurable:!0,writable:!0,value:d})}};$jscomp.polyfill("Array.prototype.values",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b,a){return a})}},"es6","es3");$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6-impl","es3");
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(b){var d=[],a={};b=b.split(/\s*(;|\(|\)|,|:)\s*/);for(var e=0,g=0;g<b.length;g++){var t=b[g];switch(t){case "(":t={};a.id=e;e++;a.branchset=[t];d.push(a);a=t;break;case ",":t={};d[d.length-1].branchset.push(t);a=t;break;case ")":a=d.pop();break;case ":":break;default:var q=b[g-1];")"==q||"("==q||","==q?a.name=t:":"==q&&(a.branchLength=parseFloat(t));a.id=e;e++}}return a}})();
...
end:d[2]});!b.children&&d[2][0]>phyd3.phylogram.dx&&(phyd3.phylogram.dx=d[2][0]);return"M"+d[0]+" "+d[1]+" "+d[2]};phyd3.phylogram.scaleBranchLengths=function(b,d){function a(b,d){d(b);if(b.children)for(var e=b.children.length-1;0<=e;e--)a(b.children[e],d)}a(b[0],function(a){0>a.branchLength&&(a.branchLength*=-1);a.rootDist=(a.parent?a.parent.rootDist:0)+(a.branchLength||0)});var e=b.map(function(a){return a.rootDist}),g=d3.scale.linear().domain([0,d3.max(e)]).range([0,d]);a(b[0],function(a){a.y=
parseInt(g(a.rootDist))});return g};phyd3.phylogram.randomColor=function(){function b(a,b,d){0>d&&(d+=1);1<d&&--d;return d<1/6?a+6*(b-a)*d:.5>d?b:d<2/3?a+(b-a)*(2/3-d)*6:a}var d=Math.random();return function(a,d,g){if(0==d)g=d=a=g;else{var e=.5>g?g*(1+d):g+d-g*d,q=2*g-e;g=b(q,e,a+1/3);d=b(q,e,a);a=b(q,e,a-1/3)}return"#"+Math.round(255*g).toString(16)+Math.round(255*d).toString(16)+Math.round(255*a).toString(16)}((d+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(b,d){b=b.map(function(a){return a.sequences&&
a.sequences[0]&&a.sequences[0].domainArchitecture&&a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(b)]).range([0,d])};phyd3.phylogram.build=function(b,d,a){function e(){return a.invertColors?a.backgroundColor:a.foregroundColor}function g(){d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var k=e();n.selectAll("path.link").attr("stroke",k);n.selectAll("text.legend").attr("fill",
k);n.selectAll("text.nodelabel").attr("stroke",k).attr("fill",k);z.selectAll("path.support").attr("stroke",k);z.selectAll("path.domain").attr("stroke",k);X();Y()}function t(){var k=b.replace("#",""),k=document.getElementById(k).querySelector("svg"),d=k.getElementById("main"),f=d.getBBox(),d=d.getAttributeNode("transform"),e=k.getAttributeNode("width"),l=k.getAttributeNode("height"),h=d.value,p=e.value,m=l.value;d.value="translate("+a.marginX+", "+a.marginY+")";e.value=(Math.max(+e.value.replace("px",
""),f.width)+a.marginX).toString();l.value=(Math.max(+l.value.replace("px",""),f.height)+a.marginY).toString();if("undefined"!=typeof window.XMLSerializer)var g=(new XMLSerializer).serializeToString(k);else"undefined"!=typeof k.xml&&(g=k.xml);d.value=h;e.value=p;l.value=m;return g}function q(){a.showDomains?(J=phyd3.phylogram.scaledomainWidths(D,a.domainWidth),z.append("svg:path").attr("class","domain").attr("stroke",e()).attr("visibility",function(a,d){return a.show?"visibile":"hidden"}),E=E.data(function(a,
d,f){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(f=0;f<a.length;f++)a[f].i=d;a.sort(function(a,f){return Math.abs(f.to-f.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),E.append("svg:rect").attr("class","domain hover-visible").attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a){return a.name}),x(),G(),Y()):(E.remove(),z.selectAll("path.domain").remove(),
E=z.selectAll("g.domain"))}function w(){a.showDomainNames?(E.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",e()).attr("font-size","10px").text(function(a){return a.name}),G()):E.selectAll("text.domain").remove()}function x(){var d=z.data();z.selectAll("g.domain").attr("visibility",function(b,f,k){return d[k].show&&b.confidence<=a.domainLevel?"visible":"hidden"});z.selectAll("path.domain").attr("visibility",function(a){return a.show?"visible":"hidden"});d3.select("#domainLevel").attr("value",
a.domainLevel.toPrecision(1))}function Y(){E.selectAll("rect.domain").attr("fill",function(b){return a.showDomainColors&&d.domcolors[b.name]?d.domcolors[b.name].color.replace(/0x/,"#"):e()})}function G(){var d=z.data(),b=K+(a.showLabels?L:0)+(a.showGraphs?v:0);J=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);z.selectAll("path.domain").attr("d",function(a,k,e){k=phyd3.phylogram.dx-d[e].y;a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.sequenceLength:
0;return"M"+parseInt(b+k)+",0L"+parseInt(b+k+J(a))+",0"});E.selectAll("rect.domain").attr("width",function(a){return parseInt(J(a.to-a.from))}).attr("transform",function(f,k,e){return"translate("+parseInt(b+(phyd3.phylogram.dx-d[f.i].y)+J(f.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);E.selectAll("text.domain").attr("transform",function(f){return"translate("+parseInt(b+(phyd3.phylogram.dx-d[f.i].y)+J(f.from))+","+parseInt(-1*a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",
a.domainWidth)}function ea(){a.showSupportValues?(n.selectAll("g.inner.node").append("svg:text").attr("class","supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(a){var d="";if(a.confidences)for(var f=0;f<a.confidences.length;f++)d+=parseFloat(a.confidences[f].value)+" ";return d}),B(),F()):n.selectAll("text.supportValue").remove()}function fa(){a.showLengthValues?(n.selectAll("g.node").append("svg:text").attr("class","branchLength").attr("dx",-2).attr("text-anchor",
"end").attr("fill",a.branchLengthColor).text(function(a){return a.branchLength?parseFloat(a.branchLength).toFixed(5):""}),B(),F()):n.selectAll("text.branchLength").remove()}function Z(a,d,f){var b=a.attr("id")+"_"+a.selectAll("div.panel-default").size(),k=a.append("div").attr("class","panel panel-default");k.append("div").attr("class","panel-heading").attr("role","tab").attr("id","heading"+b).append("h4").attr("class","panel-title").append("a").attr("class","collapsed").attr("aria-expanded",f?"true":
"false").attr("role","button").attr("data-toggle","collapse").attr("data-parent","#"+a.attr("id")).attr("href","#collapse"+b).attr("aria-controls","collapse"+b).html(d);return k.append("div").attr("id","collapse"+b).attr("class","panel-collapse collapse "+(f?"in":"")).attr("role","tabpanel").attr("aria-labelledby","heading"+b).append("div").attr("class","panel-body table-responsive")}function oa(k){var e=d3.event,f=e.layerX;y=e.layerY;var u="popup"+parseInt(Date.now()*Math.random()*1E3),f=d3.select(b).append("div").attr("class",
"popup").attr("id",u).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(f)+"px").style("width",parseInt(a.popupWidth)+"px").style("color",a.foregroundColor).style("background-color",a.backgroundColor),l=f.append("button").attr("class","btn btn-link").style("position","absolute").style("right","8px");l.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden","true");l.on("click",function(){d3.select("#"+u).remove();n.selectAll("g.node.cid_"+k.id).selectAll("rect.pointer").style("opacity",
"0")});f=f.append("div").attr("class","panel-group").attr("id","accordion_"+parseInt(Date.now()*Math.random()*1E3)).attr("role","tablist").attr("aria-multiselectable","true");l="text"==e.target.nodeName||e.target.classList.contains("pointer")?!0:!1;l=Z(f,"Node",l).append("table").attr("class","table table-condensed table-bordered").append("tbody");if(k.name){var h=l.append("tr");h.append("td").text("Name");h.append("td").text(k.name)}if(k.taxonomies)for(var p=0;p<k.taxonomies.length;p++){var m=k.taxonomies[p],
h=l.append("tr");h.append("td").text("Taxononomy");h=h.append("td");d.taxcolors[m.code]&&d.taxcolors[m.code].url&&(h=h.append("a").attr("href",d.taxcolors[m.code].url).attr("target","_blank"));var g="",g=g+(d.taxcolors[m.code]&&d.taxcolors[m.code].name?d.taxcolors[m.code].name+" ":""),g=g+" ",g=g+(m.scientificName?"\x3ci\x3e"+m.scientificName+"\x3c/i\x3e":""),g=g+" ",g=g+(m.commonName?m.commonName:""),g=g+" ",g=g+(m.code?"("+m.code+")":"");h.html(g)}if(k.confidences)for(p=0;p<k.confidences.length;p++)h=
l.append("tr"),h.append("td").text("Confidence"),h.append("td").html(k.confidences[p].value);h=l.append("tr");h.append("td").text("Depth");h.append("td").text(k.depth);h=l.append("tr");h.append("td").text("Branch length");h.append("td").text(k.branchLength?k.branchLength:0);h=l.append("tr");h.append("td").text("Distance from root");h.append("td").text(k.rootDist);for(p=0;p<k.properties.length;p++)h=k.properties[p],r=h.ref,m=h.value,m=m.trim(),/^http:\/\//.test(m)&&(m="\x3ca href\x3d'"+m+"' target\x3d'_blank'\x3e"+
m+"\x3c/a\x3e\x3cbr /\x3e"),h=l.append("tr"),h.append("td").text(r),h.append("td").html(m);for(var r in k.events)m=k.events[r],h=l.append("tr"),h.append("td").text(r),h.append("td").html(m);if(k.sequences)for(p=0;p<k.sequences.length;p++){r=k.sequences[p];m="";m+=r.symbol?r.symbol+" ":"";m+=r.name?r.name+" ":"";m+=r.location?r.location+" ":"";m+=r.geneName?r.geneName:"";m.length&&(h=l.append("tr"),h.append("td").text("Sequence"),h.append("td").html(m));r.accession&&(m="",m+=r.accession.value?r.accession.value+
" ":"",m+=r.accession.source?"["+r.accession.source+"] ":"",m+=r.accession.comment?"("+r.accession.comment+")":"",m.length&&(h=l.append("tr"),h.append("td").text("Accession"),h.append("td").html(m)));r.molSeq&&r.molSeq.value&&(h=l.append("tr"),h.append("td").text("Molecular Sequence"),h.append("td").html(r.molSeq.value));if(r.uris){m="";for(h=0;h<r.uris.length;h++)m=r.uris[h],m="\x3ca href\x3d'"+m.value+"'\x3e"+(m.desc?m.desc:m.value)+"\x3c/a\x3e";m.length&&(h=l.append("tr"),h.append("td").text("See also"),
h.append("td").html(m))}if(k.sequences[p].domainArchitecture&&k.sequences[p].domainArchitecture.domains){l=e.target.parentNode.classList.contains("domain")?!0:!1;l=Z(f,"Domains",l).append("table").attr("id","dt"+u).attr("class","table table-condensed table-bordered");r=l.append("thead").append("tr");r.append("th").text("#");r.append("th").text("Name");r.append("th").text("Description");r.append("th").text("From");r.append("th").text("To");r.append("th").text("P value");g=l.append("tbody");for(m=0;m<
k.sequences[p].domainArchitecture.domains.length;m++){var C=k.sequences[p].domainArchitecture.domains[m],h=g.append("tr");h.append("td").style("background",d.domcolors[C.name]&&d.domcolors[C.name].color?d.domcolors[C.name].color.replace("0x","#"):"").text(" ");r=h.append("td");d.domcolors[C.name]&&d.domcolors[C.name].url&&(r=r.append("a").attr("href",d.domcolors[C.name].url).attr("target","_blank"));r.text(C.name);h.append("td").text(d.domcolors[C.name]?d.domcolors[C.name].description:"");h.append("td").text(C.from);
h.append("td").text(C.to);h.append("td").text(C.confidence)}jQuery("#dt"+u).dataTable({searching:!1,paging:!1,language:{info:""},order:[[3,"asc"]],columns:[{orderable:!1},null,null,null,null,null]})}}if(d.graphs)for(p=0;p<d.graphs.length;p++)if(g=d.graphs[p],g.data&&g.data[k.id]&&g.data[k.id].length)for(l=e.target.parentNode.classList.contains(g.type)?!0:!1,l=Z(f,g.name,l).append("table").attr("class","table table-condensed table-bordered").append("tbody"),m=0;m<g.legend.fields.length;m++)h=l.append("tr"),
r=h.append("td"),g.legend.fields[m].url&&(r=r.append("a").attr("href",g.legend.fields[m].url).attr("target","_blank")),r.text(g.legend.fields[m].name),h.append("td").text(g.data[k.id][m]);n.selectAll("g.node.cid_"+k.id).selectAll("rect.pointer").style("opacity","1");e.stopPropagation()}function ga(){a.lineupNodes?n.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",e()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):n.selectAll("path.support").remove()}function V(b,
e){if(!e&&(b.children&&"only leaf"==a.showNodesType||!b.children&&"only inner"==a.showNodesType))return"";e="";if(a.showTaxonomy&&b.taxonomies)for(var f=0;f<b.taxonomies.length;f++){var k=b.taxonomies[f];a.showFullTaxonomy&&(e+=d.taxcolors[k.code]&&d.taxcolors[k.code].name?d.taxcolors[k.code].name:"",e+=" ",e+=k.scientificName?k.scientificName:"",e+=" ",e+=k.commonName?k.commonName:"",e+=" ");e+=k.code?k.code:"";e+=" "}e+=(a.showNodeNames&&b.name?b.name:"")+" ";if(a.showSequences&&b.sequences)for(f=
0;f<b.sequences.length;f++)if(k=b.sequences[f],e+=k.symbol?k.symbol:"",e+=" ",e+=k.accession?k.accession.value:"",e+=" ",e+=k.name?k.name:"",e+=" ",e+=k.geneName?k.geneName:"",e+=" ",k.annotations)for(var l=0;l<k.annotations.length;l++)e+=k.annotations[l].desc?k.annotations[l].desc:"",e+=" ";return e}function N(){var d=0;aa=0;z.selectAll("text.name").text(function(a){var b=V(a);b.length>d&&(d=b.length,aa=a.id);return b});n.selectAll("g.node.inner").selectAll("text.name").text(V);a.showGraphs&&O();
a.showDomains&&G()}function F(){n.selectAll("text.branchLength").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("text.supportValues").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&z.selectAll("path.support").attr("visibility",function(a){return a.show?"visible":"hidden"});a.showLabels&&ha();a.showGraphs&&ia();a.showDomains&&x()}function X(){n.selectAll("text.name").attr("stroke",
e()).attr("stroke-width",a.outline+"px").attr("fill",function(b){var k=null;if(a.showTaxonomyColors&&d.taxcolors&&b.taxonomies)for(var f=0;f<b.taxonomies.length;f++){var g=b.taxonomies[f];d.taxcolors[g.code]&&d.taxcolors[g.code].color&&(k=d.taxcolors[g.code].color.replace(/0x/,"#"))}return k?k:e()})}function ja(){z.selectAll("text.name").attr("dx",function(b){return parseInt(a.lineupNodes?phyd3.phylogram.dx-b.y+5:5)});z.selectAll("path.support").attr("d",function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-
a.y)+",0"});a.showLabels&&ba();a.showGraphs&&O();a.showDomains&&G()}function B(){var b=0;n.selectAll("text.name").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.branchLength").attr("dy",-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("g.leaf.cid_"+aa).selectAll("text.name").each(function(){var a=this.getBBox();a.width>b&&(b=a.width)});K=b+=
10;d3.select("#nodeHeight").attr("value",2*a.nodeHeight+"px");ja();a.showLabels&&ba();a.showGraphs&&O();a.showDomains&&G()}function ka(){if(a.showLabels&&d.labels){for(var b=0;b<d.labels.length;b++){var g=d.labels[b];g.id||(g.id=parseInt(Date.now()*Math.random()*1E3));g.data.tag&&n.selectAll("g.node").each(function(a){var b=a[g.data.tag],d=g.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==g.data.tag)for(pid=0;pid<a.properties.length;pid++){var f=a.properties[pid];if(f.ref==d){b=
f.value;break}}b&&(g.data[a.id]=b)});switch(g.type){case "text":for(cid in g.data)g.data[cid]&&n.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+g.id).attr("dy",3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",e()).attr("fill",e()).attr("font-size",1.5*a.nodeHeight+"px").text(g.data[cid]).append("title").text(g.name+": "+g.data[cid]);break;case "color":for(cid in g.data)if(g.data[cid]){var f=a.nodeHeight,u=g.data[cid].replace(/0x/,"#");n.selectAll(".cid_"+
cid).append("rect").attr("height",2*f).attr("width",2*f).attr("class","nodelabel color lid"+g.id).attr("style","fill: "+u+"; stroke: "+u).append("title").text(g.name)}}n.append("text").attr("class","labellegend lid"+g.id).text(0!=g.showLegend?g.name:"")}ha();ba()}else n.selectAll(".nodelabel").remove(),n.selectAll(".labellegend").remove(),L=0;O();G()}function ba(){var b=a.nodeHeight;L=0;if(d.labels){for(var e=0;e<d.labels.length;e++){var f=d.labels[e],g=0;n.selectAll(".nodelabel.lid"+f.id).attr("transform",
function(a){var d=0,e=0;"color"==f.type&&(d=e=-b);var k=0;"text"==this.nodeName&&this.firstChild?k=this.firstChild.length*b/1.5:"rect"==this.nodeName&&(k=2*b);k>g&&(g=k);a.branchset.length?(d+=a.y,d-=b):d+=phyd3.phylogram.dx+K;return"translate("+parseInt(d+b+L-a.y)+","+e+")"});n.selectAll("text.labellegend.lid"+f.id).attr("transform","translate("+parseInt(phyd3.phylogram.dx+L+K+2*b)+",-10) rotate(-90)");L+=g+2*b}e=z.selectAll(".nodelabel");e.selectAll("text").attr("dy",a.nodeHeight/2).attr("font-size",
1.5*a.nodeHeight+"px");e.selectAll("rect").attr("width",2*a.nodeHeight).attr("height",2*a.nodeHeight)}}function ha(){n.selectAll(".nodelabel").attr("visibility",function(b){return b.branchset.length&&"only leaf"==a.showNodesType||!b.branchset.length&&"only inner"==a.showNodesType?"hidden":b.show?"visible":"hidden"})}function la(){if(a.showGraphs&&d.graphs&&d.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);for(var b=d3.layout.pie().value(function(a){return a.value}).sort(null),
g=v=0;g<d.graphs.length;g++){var f=d.graphs[g];f.id||(f.id=parseInt(Date.now()*Math.random()*1E3));if(f.data.tag)var u=n.selectAll("g.node").each(function(a){var b=a[f.data.tag],d=f.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==f.data.tag)for(var e=0;e<a.properties.length;e++){var k=a.properties[e];if(k.ref==d){b=k.value;break}}b&&(f.data[a.id]=[],f.data[a.id][0]=b,"pie"==f.type&&f.data.max&&(f.data[a.id][1]=f.data.max-b,f.legend.fields[1]={name:f.legend.fields[0].name,color:f.legend.fields[0].background?
f.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(f.type){case "pie":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){var l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});for(var u=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph pie gid"+f.id),h=[],p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p],leaf:l});u=u.selectAll("path.pie.gid"+f.id).data(b(h)).enter().append("path").attr("class",
...
a.data.value):""})}break;case "binary":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){h=[];l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});u=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+f.id);for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p],shape:f.legend.fields[p]?f.legend.fields[p].shape:"",leaf:l});u=u.selectAll("path.binary.gid"+f.id).data(h).enter().append("path").attr("class","binary hover-visible gid"+
f.id).attr("style",function(a,b){b=(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":P[f.id]=[];for(p=0;p<f.legend.fields.length;p++)u=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),P[f.id][p]=d3.scale.linear().domain([0,u]);for(cid in f.data)if(f.data[cid]){u=n.select(".cid_"+
cid).append("svg:g").attr("class","graph multibar gid"+f.id);h=[];for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p]});u=u.selectAll("rect.multibar.gid"+f.id).data(h).enter().append("rect").attr("class","multibar hover-visible gid"+f.id).attr("fill",function(a,b){return(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a,b){return(f.legend.fields[b]?
f.legend.fields[b].name+": ":"")+a.value})}break;case "boxplot":A[f.id]=null;u=0;h=Number.MAX_SAFE_INTEGER;for(p=0;5>p;p++){var m=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),q=d3.max(d3.values(f.data),function(a){if(a)return a[p]});m>u&&(u=m);q<h&&(h=q)}A[f.id]=d3.scale.linear().domain([h,u]);for(cid in f.data)f.data[cid]&&(u=n.select(".cid_"+cid).append("svg:g").attr("class","graph boxplot gid"+f.id),h=[],h.push({min:f.data[cid][0],q1:f.data[cid][1],median:f.data[cid][2],q3:f.data[cid][3],
max:f.data[cid][4]}),u=u.selectAll("rect.boxplot.gid"+f.id).data(h).enter(),u.append("line").attr("class","boxplot baseline hover-visible gid"+f.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",e()),u.append("rect").attr("class","boxplot q1 hover-visible gid"+f.id).attr("fill",(f.legend.fields[0]?f.legend.fields[0].color:"").replace(/0x/,"#")).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a){return"Min: "+
a.min+", Q1: "+a.q1+", Median: "+a.median}),u.append("rect").attr("class","boxplot q3 hover-visible gid"+f.id).attr("fill",(f.legend.fields[1]?f.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",e()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+a.median+", Q3: "+a.q3+", Max: "+a.max}),u.append("line").attr("class","boxplot median hover-visible gid"+f.id).attr("stroke",e()).attr("stroke-width","2px"));break;case "heatmap":var m=d3.max(d3.values(f.data),
function(a){if(a)return d3.max(a)}),q=d3.min(d3.values(f.data),function(a){if(a)return d3.min(a)}),r=d3.scale.quantize().domain([q,m]).range(colorbrewer[f.legend.gradient.name][f.legend.gradient.classes]);for(cid in f.data)if(f.data[cid]){u=n.select(".cid_"+cid).append("svg:g").attr("class","graph heatmap gid"+f.id);h=[];if(f.data[cid])for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p]});u=u.selectAll("rect.heatmap.gid"+f.id).data(h).enter().append("rect").attr("class",
"heatmap hover-visible gid"+f.id).attr("fill",function(a,b){return r(a.value)}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+f.type)}}ia();O()}else v=0,n.selectAll("g.graph").remove(),n.selectAll("text.legend").remove();G()}function O(){var b=a.nodeHeight,g=K+L;z.selectAll("g.graph").attr("transform",function(a){return"translate("+
(phyd3.phylogram.dx-a.y+g)+",0)"});var f=n.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);n.selectAll("text.legend").remove();v=0;if(d.graphs){for(var u=0;u<d.graphs.length;u++){var l=d.graphs[u];switch(l.type){case "pie":f.selectAll("path.pie.gid"+l.id).attr("d",function(a){if(0<a.value)return d3.svg.arc().innerRadius(0).outerRadius(b)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?b+v:0)+",0)"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class",
"legend").text(0!=l.legend.show?l.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+v+2*b)+",-10) rotate(-90)");v+=2*b+5;break;case "binary":f.selectAll("path.binary.gid"+l.id).attr("d",function(a){var d=d3.svg.symbol().size(4*(b-2)*(b-2));d.type(l.legend.fields[a.i].shape);return d(a)}).attr("transform",function(a){return" translate("+(a.leaf?v+10+a.i*(2*b+5):0)+" ,0)"});if(a.showGraphs&&a.showGraphLegend)for(var h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=
l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+v+h*(2*b+5)+2*b)+", -10) rotate(-90)");v+=(l.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":for(h=0;h<l.legend.fields.length;h++)P[l.id][h]=P[l.id][h].range([0,a.graphWidth]);f.selectAll("rect.multibar.gid"+l.id).attr("height",parseInt(2*b)).attr("width",function(a,b){return parseInt(P[l.id][a.i]?P[l.id][a.i](a.value):0)}).attr("transform",function(d,f){return" translate("+parseInt(v+d.i*(a.graphWidth+
5))+",-"+parseInt(b)+")"});if(a.showGraphs&&a.showGraphLegend)for(h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+v+h*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");v+=l.legend.fields.length*(a.graphWidth+5);break;case "boxplot":A[l.id]=A[l.id].range([0,a.graphWidth]);f.selectAll("rect.q1.boxplot.gid"+l.id).attr("height",parseInt(2*b)).attr("width",function(a){return parseInt(A[l.id](a.median)-
A[l.id](a.q1))}).attr("transform",function(a,d){a=v+A[l.id](a.q1);return" translate("+parseInt(a)+",-"+parseInt(b)+")"});f.selectAll("rect.q3.boxplot.gid"+l.id).attr("height",parseInt(2*b)).attr("width",function(a){return parseInt(A[l.id](a.q3)-A[l.id](a.median))}).attr("transform",function(a,d){a=v+A[l.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(b)+")"});f.selectAll("line.baseline.boxplot.gid"+l.id).attr("y1",parseInt(b)).attr("y2",parseInt(b)).attr("x1",function(a){return A[l.id](a.min)}).attr("x2",
function(a){return A[l.id](a.max)}).attr("transform",function(a,d){return" translate("+parseInt(v)+",-"+parseInt(b)+")"});f.selectAll("line.median.boxplot.gid"+l.id).attr("y1",0).attr("y2",parseInt(2*b)).attr("x1",function(a){return A[l.id](a.median)}).attr("x2",function(a){return A[l.id](a.median)}).attr("transform",function(a,d){return" translate("+parseInt(v)+",-"+parseInt(b)+")"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class","legend").text(0!=l.legend.show?l.name:"").attr("transform",
"translate("+(phyd3.phylogram.dx+g+v+2*b)+", -10) rotate(-90)");v+=a.graphWidth+5;break;case "heatmap":f.selectAll("rect.heatmap.gid"+l.id).attr("width",2*b).attr("height",2*b).attr("transform",function(a,d){return" translate("+(v+2*a.i*b)+",-"+b+")"});if(a.showGraphs&&a.showGraphLegend)for(h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+v+(h+1)*b*2)+",-10) rotate(-90)");
v+=2*l.legend.fields.length*b+5}}n.selectAll("text.legend").attr("fill",e()).attr("font-size",2*a.nodeHeight)}}function pa(){var b=a.nodeHeight;v=0;if(d.graphs)for(var e=0;e<d.graphs.length;e++){var f=d.graphs[e];switch(f.type){case "pie":v+=2*b+5;break;case "binary":v+=(f.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":v+=f.legend.fields.length*(a.graphWidth+5);break;case "heatmap":v+=2*f.legend.fields.length*b+5}}return 2*a.margin+(a.showNodeNames?K:0)+(a.showGraphs?v:0)+(a.showDomains?
a.domainWidth:0)}function ia(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,f=a.nodeHeight,g=d.x,k=d.y,m=0;m<b.length;m++){var n=b[m].x,r=b[m].y;if((n-g)*(n-g)+(r-k)*(r-k)<=4*f*f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};z.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);n.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function H(b){phyd3.phylogram.lineAreas=
[];phyd3.phylogram.dx=0;var g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([Q*a.scaleY,I*a.scaleX]);D=g(d);a.showPhylogram||phyd3.phylogram.scaleBranchLengths(D,I*a.scaleX);var f=n.selectAll("path.link");b||(f=f.data(g.links(D)),f.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",e()));f.attr("d",phyd3.phylogram.rightAngleDiagonal);R=void 0;c=0;f=D.filter(function(a){return!a.children});for(g=0;g<
f.length;g++)f[g].show=a.dynamicHide?ma(f[g],!a.lineupNodes):!0;R=void 0;f=D.filter(function(a){return a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?ma(f[g],!0):!0;b||(T=T.data(D),T.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",void 0===a.popupAction?oa:a.popupAction).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",
2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+"px"));T.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function M(){H(!0);U()}function ma(b,d){var e=!0,g=b.y+1,k=b.y+5.5*V(b,!0).length,h=b.x-a.nodeHeight,p=b.x+a.nodeHeight;if(!R)return R=b,!0;a.lineupNodes&&!b.children&&(g+=phyd3.phylogram.dx-b.y,k+=phyd3.phylogram.dx-b.y);var m=R,
n=m.y+1,r=m.y+5.5*V(m,!0).length,q=m.x-a.nodeHeight,t=m.x+a.nodeHeight;a.lineupNodes&&!m.children&&(n+=phyd3.phylogram.dx-m.y,r+=phyd3.phylogram.dx-m.y);if(n<=g&&g<=r&&q<=h&&h<=t||n<=k&&k<=r&&q<=h&&h<=t||n<=g&&g<=r&&q<=p&&p<=t||n<=k&&k<=r&&q<=p&&p<=t)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(q=phyd3.phylogram.lineAreas[d],m=q.start[0],n=q.end[0],r=q.start[1],q=q.end[1],r==q){if(h<=r&&q<=p&&!(m>k||n<g)){e=!1;break}}else if(m==n&&g<=m&&n<=k&&!(r>p||q<h)){e=!1;break}e&&(R=b);return e}
function U(){var b=ca.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;n.attr("transform",function(a){return"translate("+parseInt(d)+","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(ja(),a.dynamicHide&&F())}a=a||{};a.scaleY=a.scaleY||1;a.scaleX=a.scaleX||1;a.translateX=a.translateX||0;a.translateY=a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||
...
a.treeWidth=a.treeWidth||"auto";a.showFullTaxonomy="showFullTaxonomy"in a?a.showFullTaxonomy:!1;a.showLabels="showLabels"in a?a.showLabels:!0;a.showDomains="showDomains"in a?a.showDomains:!0;a.dynamicHide="dynamicHide"in a?a.dynamicHide:!1;a.invertColors="invertColors"in a?a.invertColors:!1;a.lineupNodes="lineupNodes"in a?a.lineupNodes:!0;a.showSupportValues="showSupportValues"in a?a.showSupportValues:!1;a.showLengthValues="showLengthValues"in a?a.showLengthValues:!1;a.showTaxonomy="showTaxonomy"in
a?a.showTaxonomy:!0;a.showTaxonomyColors="showTaxonomyColors"in a?a.showTaxonomyColors:!0;a.showDomainNames="showDomainNames"in a?a.showDomainNames:!1;a.showDomainColors="showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend="showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames="showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in a?a.showPhylogram:!1;var D,J,R,A=[],P=[],L=100,K=100,v=0,S=100,aa=0,na=!1;if(d.graphs)for(var da=
0;da<d.graphs.length;da++)if(0!=d.graphs[da].legend.show){na=!0;break}S=na?S:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?S:0);var W=jQuery(b).width(),I="auto"==a.treeWidth?W-pa():a.treeWidth,Q=a.height-(2*a.margin+(a.showGraphs?S:0)),I=parseInt(I),Q=parseInt(Q);0>I&&(I=W-2*K-(a.showGraphs?2*S:0));var ca=d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;
var e=.5,g=.5;d.altKey||d.ctrlKey||(e=d.layerX/W,g=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=Q*b*g;if(d.altKey||!d.ctrlKey)a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=I*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(M):
requestAnimFrame(U)}});d3.select(b).select("svg").remove();var n=d3.select(b).insert("svg").attr("width",W+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version","1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(ca);n.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height","100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);n.append("svg:text").attr("dy","20px").attr("stroke",e()).attr("stroke-width",
"1px").attr("font-size","15px").text(d.name?d.name:"");n.append("svg:text").attr("dy","40px").attr("stroke",e()).attr("stroke-width","0.5px").attr("font-size","10px").text(d.description?d.description:"");n.append("defs").append("marker").attr("id","markerBoxplot").attr("markerWidth","1").attr("markerHeight","10").attr("refX","1").attr("refY","5").append("line").attr("x1","0").attr("x2","0").attr("y1","0").attr("y2","10").attr("stroke",e()).attr("stroke-width","2px");var n=n.append("svg:g").attr("id",
"main").attr("transform","translate("+a.marginX+", "+a.marginY+")"),T=n.selectAll("g.node");H();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,H());var z=n.selectAll("g.leaf.node"),E=z.selectAll("g.domain");ea();fa();q();w();la();ga();ka();T.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");X();N();F();U();B();d3.select("#dynamicHide").on("click",function(){a.dynamicHide=!a.dynamicHide;
H(!0);F()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;g()});jQuery("#foregroundColorButton").colorpicker().on("changeColor",function(){a.foregroundColor=jQuery("#foregroundColor").val();g()});jQuery("#backgroundColorButton").colorpicker().on("changeColor",function(){a.backgroundColor=jQuery("#backgroundColor").val();g()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();M();N()});d3.select("#phylogram").on("click",function(){a.showPhylogram=
!a.showPhylogram;H(!0);B();F()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;H(!0);ga();B();F()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=!a.showLengthValues;fa()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;ea();F()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=!a.showNodeNames;N();B()});d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;ka()});d3.select("#taxonomy").on("click",
function(){a.showTaxonomy=!a.showTaxonomy;N();B()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;N();B()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();M();N()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;X()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);H(!0);B();F()});d3.select("#nodeHeightHigher").on("click",
function(){a.nodeHeight+=a.nodeHeightStep;H(!0);B();F()});d3.select("#resetZoom").on("click",function(){a.domainWidth=a.domainWidthStep;a.scaleX=1;a.scaleY=1;a.translateX=0;a.translateY=0;H(!0);ca.translate([0,0]);U();B()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=Q*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(M)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=Q*a.scaleStep/
2;a.lastScale=-1*a.scaleStep;requestAnimFrame(M)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=I*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(M)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=I*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(M)});d3.select("#domains").on("click",function(){a.showDomains=!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",
null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",null),d3.select("#domainWidthHigher").attr("disabled",null),d3.select("#domainLevelLower").attr("disabled",null),d3.select("#domainLevelHigher").attr("disabled",null)):(d3.select("#domainNames").attr("disabled","disabled"),d3.select("#domainColors").attr("disabled","disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled",
"disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));q();w()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;Y()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;w()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);J=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);G()});d3.select("#domainWidthHigher").on("click",
function(){a.domainWidth+=a.domainWidthStep;J=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);G()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;x()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=a.domainLevelStep;x()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?S:0);O();U()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?
(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));la()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);B()});d3.select("#graphWidthHigher").on("click",
function(){a.graphWidth+=a.graphWidthStep;B()});d3.select("#linkSVG").on("click",function(){var a=t();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",function(){var a=t(),b=document.createElement("canvas");d3.select("g#main").node().getBBox();canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})})}})();
...
b[a];d.domains.push({confidence:parseFloat(e.getAttribute("confidence")),from:parseInt(e.getAttribute("from")),to:parseInt(e.getAttribute("to")),id:e.getAttribute("id"),name:e.textContent})}return d};phyd3.phyloxml.parseCrossReferences=function(b){var d=[];b=b.getElementsByTagName("accession");for(var a=0;a<b.length;a++)d.push(phyd3.phyloxml.parseAccession(b[a]));return d};phyd3.phyloxml.parseEvents=function(b){for(var d={},a=0;a<b.childNodes.length;a++){var e=b.childNodes[a];switch(e.nodeName){case "type":d.type=
...
break;case "confidence":d.confidences.push(phyd3.phyloxml.parseConfidence(e));break;case "sequence":d.sequences.push(phyd3.phyloxml.parseSequence(e));break;case "color":d.color=phyd3.phyloxml.parseColor(e);break;case "events":d.events=phyd3.phyloxml.parseEvents(e);break;case "id":case "name":d[e.nodeName]=e.textContent;break;case "#text":case "#comment":break;default:d[e.nodeName]=e.textContent}}d.id||(phyd3.phyloxml.cid++,d.id="_"+phyd3.phyloxml.cid);return d};phyd3.phyloxml.parseLegend=function(b){for(var d=
{show:parseInt(b.getAttribute("show")),fields:[],gradient:{}},a=b.getElementsByTagName("field"),e=0;e<a.length;e++){var g=a[e],t=g.getElementsByTagName("name")[0],t=t?t.textContent:"",q=g.getElementsByTagName("color")[0],q=q?q.textContent:"",w=g.getElementsByTagName("background")[0],w=w?w.textContent:"",x=g.getElementsByTagName("shape")[0],x=x?x.textContent:"",g=(g=g.getElementsByTagName("url")[0])?g.textContent:"";d.fields.push({name:t,color:q,background:w,shape:x,url:g})}if(b=b.getElementsByTagName("gradient")[0])t=
(t=b.getElementsByTagName("name")[0])?t.textContent:"",b=(b=b.getElementsByTagName("classes")[0])?parseInt(b.textContent):0,d.gradient={name:t,classes:b};return d};phyd3.phyloxml.parseData=function(b){var d={tag:b.getAttribute("tag"),ref:b.getAttribute("ref")},a=b.getElementsByTagName("min")[0];d.min=a?a.textContent:void 0;a=b.getElementsByTagName("max")[0];d.max=a?a.textContent:void 0;b=b.getElementsByTagName("values");for(a=0;a<b.length;a++){var e=b[a].getAttribute("for"),g=b[a].getElementsByTagName("value");
d[e]=[];for(var t=0;t<g.length;t++)d[e].push(parseFloat(g[t].textContent))}return d};phyd3.phyloxml.parseGraph=function(b){for(var d={name:"",legend:{},data:{},type:b.getAttribute("type")},a=0;a<b.childNodes.length;a++){var e=b.childNodes[a];switch(e.nodeName){case "name":d.name=e.textContent;break;case "legend":d.legend=phyd3.phyloxml.parseLegend(e);break;case "data":d.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+
" - skipping...")}}return d};phyd3.phyloxml.parseLabel=function(b){for(var d={showLegend:!1,name:"",data:{},type:b.getAttribute("type")},a=0;a<b.childNodes.length;a++){var e=b.childNodes[a];switch(e.nodeName){case "name":d.name=e.textContent;d.showLegend=e.getAttribute("show");break;case "data":d.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+" - skipping...")}}return d};phyd3.phyloxml.parse=function(b){var d=
{branchset:[],properties:[],confidence:[]},a=b.getElementsByTagName("phylogeny"),a=a[0];d.rooted=a.getAttribute("rooted");d.rerootable=a.getAttribute("rerootable");d.branch_length_unit=a.getAttribute("branch_length_unit");d.type=a.getAttribute("type");if(a&&a.childNodes)for(var e=0;e<a.childNodes.length;e++){var g=a.childNodes[e];switch(g.nodeName){case "clade":d.branchset.push(phyd3.phyloxml.parseClade(g));break;case "confidence":d.confidence.push(phyd3.phyloxml.parseConfidence(g));break;case "date":d.date=
g.textContent;break;case "description":d.description=g.textContent;break;case "id":d.id=g.textContent;break;case "name":d.name=g.textContent;break;case "property":d.properties.push(phyd3.phyloxml.parseProperty(g));break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+g.nodeName+" "+g.textContent+" - skipping...")}}var a=b.getElementsByTagName("taxonomies"),a=a[0],t={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++){var q=a.childNodes[e];if("color"==q.nodeName){var g=
q.getElementsByTagName("code")[0].textContent,w=q.getElementsByTagName("value")[0].textContent;t[g]={color:w}}if("taxonomy"==q.nodeName){var g=q.getAttribute("code"),w=(w=q.getElementsByTagName("color")[0])?w.textContent:w,x=q.getElementsByTagName("name")[0],x=x?x.textContent:x,q=(q=q.getElementsByTagName("url")[0])?q.textContent:q;t[g]={color:w,name:x,url:q}}}d.taxcolors=t;a=b.getElementsByTagName("domains");a=a[0];t={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)q=a.childNodes[e],"color"==
q.nodeName&&(g=q.getElementsByTagName("code")[0].textContent,w=q.getElementsByTagName("value")[0].textContent,t[g]={color:w}),"domain"==q.nodeName&&(g=q.getAttribute("name"),w=(w=q.getElementsByTagName("color")[0])?w.textContent:w,x=(x=q.getElementsByTagName("description")[0])?x.textContent:x,q=(q=q.getElementsByTagName("url")[0])?q.textContent:q,t[g]={color:w,description:x,url:q});d.domcolors=t;a=b.getElementsByTagName("graphs");a=a[0];g=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)w=
a.childNodes[e],"graph"==w.nodeName&&g.push(phyd3.phyloxml.parseGraph(w));d.graphs=g;a=b.getElementsByTagName("labels");a=a[0];b=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)g=a.childNodes[e],"label"==g.nodeName&&b.push(phyd3.phyloxml.parseLabel(g));d.labels=b;return d}})();
/* Blob.js
