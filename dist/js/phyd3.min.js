...
$jscomp.polyfill=function(d,b,a,e){if(b){a=$jscomp.global;d=d.split(".");for(e=0;e<d.length-1;e++){var g=d[e];g in a||(a[g]={});a=a[g]}d=d[d.length-1];e=a[d];b=b(e);b!=e&&null!=b&&$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:b})}};$jscomp.polyfill("Array.prototype.values",function(d){return d?d:function(){return $jscomp.iteratorFromArray(this,function(d,a){return a})}},"es6","es3");$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6-impl","es3");
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(d){var b=[],a={};d=d.split(/\s*(;|\(|\)|,|:)\s*/);for(var e=0,g=0;g<d.length;g++){var q=d[g];switch(q){case "(":q={};a.id=e;e++;a.branchset=[q];b.push(a);a=q;break;case ",":q={};b[b.length-1].branchset.push(q);a=q;break;case ")":a=b.pop();break;case ":":break;default:var l=d[g-1];")"==l||"("==l||","==l?a.name=q:":"==l&&(a.branchLength=parseFloat(q));a.id=e;e++}}return a}})();
...
end:b[2]});!d.children&&b[2][0]>phyd3.phylogram.dx&&(phyd3.phylogram.dx=b[2][0]);return"M"+b[0]+" "+b[1]+" "+b[2]};phyd3.phylogram.scaleBranchLengths=function(d,b){function a(d,b){b(d);if(d.children)for(var e=d.children.length-1;0<=e;e--)a(d.children[e],b)}a(d[0],function(a){a.rootDist=(a.parent?a.parent.rootDist:0)+(a.branchLength||0)});var e=d.map(function(a){return a.rootDist}),g=d3.scale.linear().domain([0,d3.max(e)]).range([0,b]);a(d[0],function(a){a.y=parseInt(g(a.rootDist))});return g};phyd3.phylogram.randomColor=
function(){function d(a,d,b){0>b&&(b+=1);1<b&&--b;return b<1/6?a+6*(d-a)*b:.5>b?d:b<2/3?a+(d-a)*(2/3-b)*6:a}var b=Math.random();return function(a,b,g){if(0==b)g=b=a=g;else{var e=.5>g?g*(1+b):g+b-g*b,l=2*g-e;g=d(l,e,a+1/3);b=d(l,e,a);a=d(l,e,a-1/3)}return"#"+Math.round(255*g).toString(16)+Math.round(255*b).toString(16)+Math.round(255*a).toString(16)}((b+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(d,b){d=d.map(function(a){return a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture&&
a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(d)]).range([0,b])};phyd3.phylogram.build=function(d,b,a){function e(){return a.invertColors?a.backgroundColor:a.foregroundColor}function g(){var b=d.replace("#",""),b=document.getElementById(b).querySelector("svg"),e=b.getElementById("main"),f=e.getBBox(),e=e.getAttributeNode("transform"),r=b.getAttributeNode("width"),h=b.getAttributeNode("height"),k=e.value,
p=r.value,u=h.value;e.value="translate("+a.marginX+", "+a.marginY+")";r.value=(Math.max(+r.value.replace("px",""),f.width)+a.marginX).toString();h.value=(Math.max(+h.value.replace("px",""),f.height)+a.marginY).toString();if("undefined"!=typeof window.XMLSerializer)var g=(new XMLSerializer).serializeToString(b);else"undefined"!=typeof b.xml&&(g=b.xml);e.value=k;r.value=p;h.value=u;return g}function q(){a.showDomains?(H=phyd3.phylogram.scaledomainWidths(B,a.domainWidth),w.append("svg:path").attr("class",
"domain").attr("stroke",e()).attr("visibility",function(a,b){return a.show?"visibile":"hidden"}),C=C.data(function(a,b,f){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(f=0;f<a.length;f++)a[f].i=b;a.sort(function(a,b){return Math.abs(b.to-b.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),C.append("svg:rect").attr("class","domain hover-visible").attr("stroke",a.foregroundColor).attr("stroke-width",
a.outline+"px").append("title").text(function(a){return a.name}),v(),E(),x()):(C.remove(),w.selectAll("path.domain").remove(),C=w.selectAll("g.domain"))}function l(){a.showDomainNames?(C.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",e()).attr("font-size","10px").text(function(a){return a.name}),E()):C.selectAll("text.domain").remove()}function v(){var b=w.data();w.selectAll("g.domain").attr("visibility",function(d,f,n){return b[n].show&&d.confidence<=a.domainLevel?"visible":
"hidden"});w.selectAll("path.domain").attr("visibility",function(a){return a.show?"visible":"hidden"});d3.select("#domainLevel").attr("value",a.domainLevel.toPrecision(1))}function x(){C.selectAll("rect.domain").attr("fill",function(d){return a.showDomainColors&&b.domcolors[d.name]?b.domcolors[d.name].color.replace(/0x/,"#"):e()})}function E(){var b=w.data(),d=I+(a.showLabels?J:0)+(a.showGraphs?t:0);H=phyd3.phylogram.scaledomainWidths(B,a.domainWidth);w.selectAll("path.domain").attr("d",function(f,
n,e){n=a.lineupNodes?phyd3.phylogram.dx-b[e].y:0;f=f.sequences&&f.sequences[0]&&f.sequences[0].domainArchitecture?f.sequences[0].domainArchitecture.sequenceLength:0;return"M"+parseInt(d+n)+",0L"+parseInt(d+n+H(f))+",0"});C.selectAll("rect.domain").attr("width",function(a){return parseInt(H(a.to-a.from))}).attr("transform",function(f,n,e){return"translate("+parseInt(d+(a.lineupNodes?phyd3.phylogram.dx-b[f.i].y:0)+H(f.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);C.selectAll("text.domain").attr("transform",
function(f){return"translate("+parseInt(d+(a.lineupNodes?phyd3.phylogram.dx-b[f.i].y:0)+H(f.from))+","+parseInt(-1*a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",a.domainWidth)}function ba(){a.showSupportValues?(m.selectAll("g.inner.node").append("svg:text").attr("class","supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(a){var b="";if(a.confidences)for(var f=0;f<a.confidences.length;f++)b+=parseFloat(a.confidences[f].value)+" ";return b}),
A(),D()):m.selectAll("text.supportValue").remove()}function ca(){a.showLengthValues?(m.selectAll("g.node").append("svg:text").attr("class","branchLength").attr("dx",-2).attr("text-anchor","end").attr("fill",a.branchLengthColor).text(function(a){return a.branchLength?parseFloat(a.branchLength).toFixed(5):""}),A(),D()):m.selectAll("text.branchLength").remove()}function V(a,b,f){var d=a.attr("id")+"_"+a.selectAll("div.panel-default").size(),e=a.append("div").attr("class","panel panel-default");e.append("div").attr("class",
"panel-heading").attr("role","tab").attr("id","heading"+d).append("h4").attr("class","panel-title").append("a").attr("class","collapsed").attr("aria-expanded",f?"true":"false").attr("role","button").attr("data-toggle","collapse").attr("data-parent","#"+a.attr("id")).attr("href","#collapse"+d).attr("aria-controls","collapse"+d).html(b);return e.append("div").attr("id","collapse"+d).attr("class","panel-collapse collapse "+(f?"in":"")).attr("role","tabpanel").attr("aria-labelledby","heading"+d).append("div").attr("class",
"panel-body table-responsive")}function la(e){var n=d3.event,f=n.layerX;y=n.layerY;var r="popup"+parseInt(Date.now()*Math.random()*1E3),f=d3.select(d).append("div").attr("class","popup").attr("id",r).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(f)+"px").style("width",parseInt(a.popupWidth)+"px").style("color",a.foregroundColor).style("background-color",a.backgroundColor),h=f.append("button").attr("class","btn btn-link").style("position","absolute").style("right",
"8px");h.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden","true");h.on("click",function(){d3.select("#"+r).remove();m.selectAll("g.node.cid_"+e.id).selectAll("rect.pointer").style("opacity","0")});f=f.append("div").attr("class","panel-group").attr("id","accordion_"+parseInt(Date.now()*Math.random()*1E3)).attr("role","tablist").attr("aria-multiselectable","true");h="text"==n.target.nodeName||n.target.classList.contains("pointer")?!0:!1;h=V(f,"Node",h).append("table").attr("class",
"table table-condensed table-bordered").append("tbody");if(e.name){var k=h.append("tr");k.append("td").text("Name");k.append("td").text(e.name)}if(e.taxonomies)for(var p=0;p<e.taxonomies.length;p++){var u=e.taxonomies[p],k=h.append("tr");k.append("td").text("Taxononomy");k=k.append("td");b.taxcolors[u.code]&&b.taxcolors[u.code].url&&(k=k.append("a").attr("href",b.taxcolors[u.code].url).attr("target","_blank"));var g="",g=g+(b.taxcolors[u.code]&&b.taxcolors[u.code].name?b.taxcolors[u.code].name+" ":
""),g=g+" ",g=g+(u.scientificName?"\x3ci\x3e"+u.scientificName+"\x3c/i\x3e":""),g=g+" ",g=g+(u.commonName?u.commonName:""),g=g+" ",g=g+(u.code?"("+u.code+")":"");k.html(g)}if(e.confidences)for(p=0;p<e.confidences.length;p++)k=h.append("tr"),k.append("td").text("Confidence"),k.append("td").html(e.confidences[p].value);k=h.append("tr");k.append("td").text("Depth");k.append("td").text(e.depth);k=h.append("tr");k.append("td").text("Branch length");k.append("td").text(e.branchLength?e.branchLength:0);
k=h.append("tr");k.append("td").text("Distance from root");k.append("td").text(e.rootDist);for(p=0;p<e.properties.length;p++)k=e.properties[p],l=k.ref,u=k.value,u=u.trim(),/^http:\/\//.test(u)&&(u="\x3ca href\x3d'"+u+"' target\x3d'_blank'\x3e"+u+"\x3c/a\x3e\x3cbr /\x3e"),k=h.append("tr"),k.append("td").text(l),k.append("td").html(u);for(var l in e.events)u=e.events[l],k=h.append("tr"),k.append("td").text(l),k.append("td").html(u);if(e.sequences)for(p=0;p<e.sequences.length;p++)if(e.sequences[p].domainArchitecture&&
e.sequences[p].domainArchitecture.domains){h=n.target.parentNode.classList.contains("domain")?!0:!1;h=V(f,"Domains",h).append("table").attr("id","dt"+r).attr("class","table table-condensed table-bordered");l=h.append("thead").append("tr");l.append("th").text("#");l.append("th").text("Name");l.append("th").text("Description");l.append("th").text("From");l.append("th").text("To");l.append("th").text("P value");h=h.append("tbody");for(u=0;u<e.sequences[p].domainArchitecture.domains.length;u++)g=e.sequences[p].domainArchitecture.domains[u],
k=h.append("tr"),k.append("td").style("background",b.domcolors[g.name]&&b.domcolors[g.name].color?b.domcolors[g.name].color.replace("0x","#"):"").text(" "),l=k.append("td"),b.domcolors[g.name]&&b.domcolors[g.name].url&&(l=l.append("a").attr("href",b.domcolors[g.name].url).attr("target","_blank")),l.text(g.name),k.append("td").text(b.domcolors[g.name]?b.domcolors[g.name].description:""),k.append("td").text(g.from),k.append("td").text(g.to),k.append("td").text(g.confidence);jQuery("#dt"+r).dataTable({searching:!1,
paging:!1,language:{info:""},order:[[3,"asc"]],columns:[{orderable:!1},null,null,null,null,null]})}if(b.graphs)for(p=0;p<b.graphs.length;p++)if(g=b.graphs[p],g.data&&g.data[e.id]&&g.data[e.id].length)for(h=n.target.parentNode.classList.contains(g.type)?!0:!1,h=V(f,g.name,h).append("table").attr("class","table table-condensed table-bordered").append("tbody"),u=0;u<g.legend.fields.length;u++)k=h.append("tr"),l=k.append("td"),g.legend.fields[u].url&&(l=l.append("a").attr("href",g.legend.fields[u].url).attr("target",
"_blank")),l.text(g.legend.fields[u].name),k.append("td").text(g.data[e.id][u]);m.selectAll("g.node.cid_"+e.id).selectAll("rect.pointer").style("opacity","1");n.stopPropagation()}function da(){a.lineupNodes?m.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",e()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):m.selectAll("path.support").remove()}function T(d,e){if(!e&&(d.children&&"only leaf"==a.showNodesType||!d.children&&"only inner"==a.showNodesType))return"";
e="";if(a.showTaxonomy&&d.taxonomies)for(var f=0;f<d.taxonomies.length;f++){var n=d.taxonomies[f];a.showFullTaxonomy&&(e+=b.taxcolors[n.code]&&b.taxcolors[n.code].name?b.taxcolors[n.code].name:"",e+=" ",e+=n.scientificName?n.scientificName:"",e+=" ",e+=n.commonName?n.commonName:"",e+=" ");e+=n.code?n.code:"";e+=" "}e+=(a.showNodeNames&&d.name?d.name:"")+" ";if(a.showSequences&&d.sequences)for(f=0;f<d.sequences.length;f++)if(n=d.sequences[f],e+=n.symbol?n.symbol:"",e+=" ",e+=n.accession?n.accession.value:
"",e+=" ",e+=n.name?n.name:"",e+=" ",e+=n.geneName?n.geneName:"",e+=" ",n.annotations)for(var g=0;g<n.annotations.length;g++)e+=n.annotations[g].desc?n.annotations[g].desc:"",e+=" ";return e}function Q(){var b=0;w.selectAll("text.name").text(function(a){a=T(a);a.length>b&&(b=a.length);return a});m.selectAll("g.node.inner").selectAll("text.name").text(T);a.showGraphs&&K();a.showDomains&&E()}function D(){m.selectAll("text.branchLength").attr("visibility",function(a){return a.show?"visible":"hidden"});
m.selectAll("text.supportValues").attr("visibility",function(a){return a.show?"visible":"hidden"});w.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&w.selectAll("path.support").attr("visibility",function(a){return a.show?"visible":"hidden"});a.showLabels&&ea();a.showGraphs&&fa();a.showDomains&&v()}function W(){m.selectAll("text.name").attr("stroke",e()).attr("stroke-width",a.outline+"px").attr("fill",function(d){var n=null;if(a.showTaxonomyColors&&
b.taxcolors&&d.taxonomies)for(var f=0;f<d.taxonomies.length;f++){var g=d.taxonomies[f];b.taxcolors[g.code]&&b.taxcolors[g.code].color&&(n=b.taxcolors[g.code].color.replace(/0x/,"#"))}return n?n:e()})}function ga(){w.selectAll("text.name").attr("dx",function(b){return parseInt(a.lineupNodes?phyd3.phylogram.dx-b.y+5:5)});w.selectAll("path.support").attr("d",function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-a.y)+",0"});a.showLabels&&X();a.showGraphs&&K();a.showDomains&&E()}function A(){m.selectAll("text.name").attr("dy",
a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");m.selectAll("text.branchLength").attr("dy",-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");m.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");I=100*a.nodeHeight/6+10;d3.select("#nodeHeight").attr("value",a.nodeHeight);ga();a.showLabels&&X();a.showGraphs&&K();a.showDomains&&E()}function ha(){if(a.showLabels&&b.labels){for(var d=0;d<b.labels.length;d++){var g=b.labels[d];g.id||(g.id=parseInt(Date.now()*
Math.random()*1E3));g.data.tag&&m.selectAll("g.node").each(function(a){var b=a[g.data.tag],d=g.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==g.data.tag)for(pid=0;pid<a.properties.length;pid++){var e=a.properties[pid];if(e.ref==d){b=e.value;break}}b&&(g.data[a.id]=b)});switch(g.type){case "text":for(cid in g.data)g.data[cid]&&m.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+g.id).attr("dy",3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",
e()).attr("fill",e()).attr("font-size",1.5*a.nodeHeight+"px").text(g.data[cid]).append("title").text(g.name+": "+g.data[cid]);break;case "color":for(cid in g.data)if(g.data[cid]){var f=a.nodeHeight,r=g.data[cid].replace(/0x/,"#");m.selectAll(".cid_"+cid).append("rect").attr("height",2*f).attr("width",2*f).attr("class","nodelabel color lid"+g.id).attr("style","fill: "+r+"; stroke: "+r).append("title").text(g.name)}}}ea();X()}else m.selectAll(".nodelabel").remove(),J=0;K();E()}function X(){var d=a.nodeHeight;
J=0;if(b.labels){for(var e=0;e<b.labels.length;e++){var f=b.labels[e],g=0;w.selectAll(".nodelabel.lid"+f.id).attr("transform",function(b){var e=0,n=0;"color"==f.type&&(e=n=-d);var h=0;"text"==this.nodeName&&this.firstChild?h=this.firstChild.length*d/1.5:"rect"==this.nodeName&&(h=2*d);h>g&&(g=h);return"translate("+parseInt(e+d+J+(a.lineupNodes?phyd3.phylogram.dx-b.y+I:I))+","+n+")"});J+=g+2*d}e=w.selectAll(".nodelabel");e.selectAll("text").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+
"px");e.selectAll("rect").attr("width",2*a.nodeHeight).attr("height",2*a.nodeHeight)}}function ea(){m.selectAll(".nodelabel").attr("visibility",function(b){return b.branchset.length&&"only leaf"==a.showNodesType||!b.branchset.length&&"only inner"==a.showNodesType?"hidden":b.show?"visible":"hidden"})}function ia(){if(a.showGraphs&&b.graphs&&b.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);for(var d=d3.layout.pie().value(function(a){return a.value}).sort(null),g=t=0;g<b.graphs.length;g++){var f=
b.graphs[g];f.id||(f.id=parseInt(Date.now()*Math.random()*1E3));if(f.data.tag)var r=m.selectAll("g.node").each(function(a){var b=a[f.data.tag],d=f.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==f.data.tag)for(var e=0;e<a.properties.length;e++){var g=a.properties[e];if(g.ref==d){b=g.value;break}}b&&(f.data[a.id]=[],f.data[a.id][0]=b,"pie"==f.type&&f.data.max&&(f.data[a.id][1]=f.data.max-b,f.legend.fields[1]={name:f.legend.fields[0].name,color:f.legend.fields[0].background?f.legend.fields[0].background:
phyd3.phylogram.randomColor(),invert:!0}))});switch(f.type){case "pie":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){var h=!1;m.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(h=!0)});for(var r=m.selectAll(".cid_"+cid).append("svg:g").attr("class","graph pie gid"+f.id),k=[],p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&k.push({i:p,value:f.data[cid][p],leaf:h});r=r.selectAll("path.pie.gid"+f.id).data(d(k)).enter().append("path").attr("class","pie hover-visible gid"+
f.id).attr("stroke",e()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return f.legend.fields?(f.legend.fields[b]||(f.legend.fields[b]={},f.legend.fields[b].name="Series "+(b+1),f.legend.fields[b].color=phyd3.phylogram.randomColor()),f.legend.fields[b].color.replace(/0x/,"#")):""}).append("title").text(function(a,b){return f.legend.fields?(f.legend.fields[b]&&f.legend.fields[b].name?f.legend.fields[b].name+": ":"")+(f.legend.fields[b].invert?f.data.max-a.data.value:a.data.value):""})}break;
case "binary":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){k=[];h=!1;m.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(h=!0)});r=m.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+f.id);for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&k.push({i:p,value:f.data[cid][p],shape:f.legend.fields[p]?f.legend.fields[p].shape:"",leaf:h});r=r.selectAll("path.binary.gid"+f.id).data(k).enter().append("path").attr("class","binary hover-visible gid"+f.id).attr("style",
function(a,b){b=(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":L[f.id]=[];for(p=0;p<f.legend.fields.length;p++)r=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),L[f.id][p]=d3.scale.linear().domain([0,r]);for(cid in f.data)if(f.data[cid]){r=m.select(".cid_"+cid).append("svg:g").attr("class",
"graph multibar gid"+f.id);k=[];for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&k.push({i:p,value:f.data[cid][p]});r=r.selectAll("rect.multibar.gid"+f.id).data(k).enter().append("rect").attr("class","multibar hover-visible gid"+f.id).attr("fill",function(a,b){return(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+
a.value})}break;case "boxplot":z[f.id]=null;r=0;k=Number.MAX_SAFE_INTEGER;for(p=0;5>p;p++){var u=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),l=d3.max(d3.values(f.data),function(a){if(a)return a[p]});u>r&&(r=u);l<k&&(k=l)}z[f.id]=d3.scale.linear().domain([k,r]);for(cid in f.data)f.data[cid]&&(r=m.select(".cid_"+cid).append("svg:g").attr("class","graph boxplot gid"+f.id),k=[],k.push({min:f.data[cid][0],q1:f.data[cid][1],median:f.data[cid][2],q3:f.data[cid][3],max:f.data[cid][4]}),r=r.selectAll("rect.boxplot.gid"+
f.id).data(k).enter(),r.append("line").attr("class","boxplot baseline hover-visible gid"+f.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",e()),r.append("rect").attr("class","boxplot q1 hover-visible gid"+f.id).attr("fill",(f.legend.fields[0]?f.legend.fields[0].color:"").replace(/0x/,"#")).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a){return"Min: "+a.min+", Q1: "+a.q1+", Median: "+a.median}),r.append("rect").attr("class",
"boxplot q3 hover-visible gid"+f.id).attr("fill",(f.legend.fields[1]?f.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",e()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+a.median+", Q3: "+a.q3+", Max: "+a.max}),r.append("line").attr("class","boxplot median hover-visible gid"+f.id).attr("stroke",e()).attr("stroke-width","2px"));break;case "heatmap":var u=d3.max(d3.values(f.data),function(a){if(a)return d3.max(a)}),l=d3.min(d3.values(f.data),function(a){if(a)return d3.min(a)}),
q=d3.scale.quantize().domain([l,u]).range(colorbrewer[f.legend.gradient.name][f.legend.gradient.classes]);for(cid in f.data)if(f.data[cid]){r=m.select(".cid_"+cid).append("svg:g").attr("class","graph heatmap gid"+f.id);k=[];if(f.data[cid])for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&k.push({i:p,value:f.data[cid][p]});r=r.selectAll("rect.heatmap.gid"+f.id).data(k).enter().append("rect").attr("class","heatmap hover-visible gid"+f.id).attr("fill",function(a,b){return q(a.value)}).attr("stroke",
a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+f.type)}}fa();K()}else t=0,m.selectAll("g.graph").remove(),m.selectAll("text.legend").remove();E()}function K(){var d=a.nodeHeight,g=I+J;w.selectAll("g.graph").attr("transform",function(b){return"translate("+(a.lineupNodes?phyd3.phylogram.dx-b.y+g:g)+",0)"});var f=m.selectAll("g.graph");d3.select("#graphWidth").attr("value",
a.graphWidth);m.selectAll("text.legend").remove();t=0;if(b.graphs){for(var r=0;r<b.graphs.length;r++){var h=b.graphs[r];switch(h.type){case "pie":f.selectAll("path.pie.gid"+h.id).attr("d",function(a){if(0<a.value)return d3.svg.arc().innerRadius(0).outerRadius(d)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?d+t:0)+",0)"});a.showGraphs&&a.showGraphLegend&&m.append("text").attr("class","legend").text(0!=h.legend.show?h.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+
g+t+2*d)+",-10) rotate(-90)");t+=2*d+5;break;case "binary":f.selectAll("path.binary.gid"+h.id).attr("d",function(a){var b=d3.svg.symbol().size(4*(d-2)*(d-2));b.type(h.legend.fields[a.i].shape);return b(a)}).attr("transform",function(a){return" translate("+(a.leaf?t+10+a.i*(2*d+5):0)+" ,0)"});if(a.showGraphs&&a.showGraphLegend)for(var k=0;k<h.legend.fields.length;k++)m.append("text").attr("class","legend").text(0!=h.legend.show?h.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+
g+t+k*(2*d+5)+2*d)+", -10) rotate(-90)");t+=(h.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":for(k=0;k<h.legend.fields.length;k++)L[h.id][k]=L[h.id][k].range([0,a.graphWidth]);f.selectAll("rect.multibar.gid"+h.id).attr("height",parseInt(2*d)).attr("width",function(a,b){return parseInt(L[h.id][a.i]?L[h.id][a.i](a.value):0)}).attr("transform",function(b,e){return" translate("+parseInt(t+b.i*(a.graphWidth+5))+",-"+parseInt(d)+")"});if(a.showGraphs&&a.showGraphLegend)for(k=0;k<h.legend.fields.length;k++)m.append("text").attr("class",
"legend").text(0!=h.legend.show?h.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+t+k*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");t+=h.legend.fields.length*(a.graphWidth+5);break;case "boxplot":z[h.id]=z[h.id].range([0,a.graphWidth]);f.selectAll("rect.q1.boxplot.gid"+h.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(z[h.id](a.median)-z[h.id](a.q1))}).attr("transform",function(a,b){a=t+z[h.id](a.q1);return" translate("+parseInt(a)+",-"+
parseInt(d)+")"});f.selectAll("rect.q3.boxplot.gid"+h.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(z[h.id](a.q3)-z[h.id](a.median))}).attr("transform",function(a,b){a=t+z[h.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});f.selectAll("line.baseline.boxplot.gid"+h.id).attr("y1",parseInt(d)).attr("y2",parseInt(d)).attr("x1",function(a){return z[h.id](a.min)}).attr("x2",function(a){return z[h.id](a.max)}).attr("transform",function(a,b){return" translate("+
parseInt(t)+",-"+parseInt(d)+")"});f.selectAll("line.median.boxplot.gid"+h.id).attr("y1",0).attr("y2",parseInt(2*d)).attr("x1",function(a){return z[h.id](a.median)}).attr("x2",function(a){return z[h.id](a.median)}).attr("transform",function(a,b){return" translate("+parseInt(t)+",-"+parseInt(d)+")"});t+=a.graphWidth+5;break;case "heatmap":f.selectAll("rect.heatmap.gid"+h.id).attr("width",2*d).attr("height",2*d).attr("transform",function(a,b){return" translate("+(t+2*a.i*d)+",-"+d+")"});if(a.showGraphs&&
a.showGraphLegend)for(k=0;k<h.legend.fields.length;k++)m.append("text").attr("class","legend").text(0!=h.legend.show?h.legend.fields[k].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+t+(k+1)*d*2)+",-10) rotate(-90)");t+=2*h.legend.fields.length*d+5}}m.selectAll("text.legend").attr("fill",e()).attr("font-size",2*a.nodeHeight)}}function ma(){var d=a.nodeHeight;t=0;if(b.graphs)for(var e=0;e<b.graphs.length;e++){var f=b.graphs[e];switch(f.type){case "pie":t+=2*d+5;break;case "binary":t+=
(f.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":t+=f.legend.fields.length*(a.graphWidth+5);break;case "heatmap":t+=2*f.legend.fields.length*d+5}}return 2*a.margin+(a.showNodeNames?I:0)+(a.showGraphs?t:0)+(a.showDomains?a.domainWidth:0)}function fa(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,f=a.nodeHeight,g=d.x,n=d.y,l=0;l<b.length;l++){var m=b[l].x,aa=b[l].y;if((m-g)*(m-g)+(aa-n)*(aa-n)<=4*f*f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};w.selectAll("g.graph").attr("visibility",
function(a){return a.show?"visible":"hidden"});m.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);m.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function F(d){phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;var g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([M*a.scaleY,G*a.scaleX]);B=g(b);a.showPhylogram||phyd3.phylogram.scaleBranchLengths(B,G*a.scaleX);var f=m.selectAll("path.link");d||
(f=f.data(g.links(B)),f.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",e()));f.attr("d",phyd3.phylogram.rightAngleDiagonal);N=void 0;c=0;f=B.filter(function(a){return!a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?ja(f[g],!a.lineupNodes):!0;N=void 0;f=B.filter(function(a){return a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?ja(f[g],!0):!0;d||(R=R.data(B),R.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+
a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",void 0===a.popupAction?la:a.popupAction).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+"px"));R.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function O(){F(!0);
S()}function ja(b,d){var e=!0,g=b.y+1,h=b.y+5.5*T(b,!0).length,k=b.x-a.nodeHeight,l=b.x+a.nodeHeight;if(!N)return N=b,!0;a.lineupNodes&&!b.children&&(g+=phyd3.phylogram.dx-b.y,h+=phyd3.phylogram.dx-b.y);var n=N,m=n.y+1,q=n.y+5.5*T(n,!0).length,t=n.x-a.nodeHeight,v=n.x+a.nodeHeight;a.lineupNodes&&!n.children&&(m+=phyd3.phylogram.dx-n.y,q+=phyd3.phylogram.dx-n.y);if(m<=g&&g<=q&&t<=k&&k<=v||m<=h&&h<=q&&t<=k&&k<=v||m<=g&&g<=q&&t<=l&&l<=v||m<=h&&h<=q&&t<=l&&l<=v)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(t=
phyd3.phylogram.lineAreas[d],n=t.start[0],m=t.end[0],q=t.start[1],t=t.end[1],q==t){if(k<=q&&t<=l&&!(n>h||m<g)){e=!1;break}}else if(n==m&&g<=n&&m<=h&&!(q>l||t<k)){e=!1;break}e&&(N=b);return e}function S(){var b=Y.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;m.attr("transform",function(a){return"translate("+parseInt(d)+","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(ga(),a.dynamicHide&&D())}a=a||{};a.scaleY=a.scaleY||1;a.scaleX=a.scaleX||1;a.translateX=a.translateX||0;a.translateY=
a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||100;a.domainWidth=a.domainWidth||100;a.domainWidthStep=a.domainWidthStep||100;a.graphWidth=a.graphWidth||20;a.graphWidthStep=a.graphWidthStep||10;a.domainLevel=a.domainLevel||1;a.domainLevelStep=a.domainLevelStep||10;a.outline=a.outline||.3;a.popupWidth=a.popupWidth||500;a.foregroundColor=a.foregroundColor||"#000";a.backgroundColor=
a.backgroundColor||"#fff";a.branchLengthColor=a.branchLengthColor||"red";a.supportValuesColor=a.supportValuesColor||"blue";a.showNodesType=a.showNodesType||"only leaf";a.treeWidth=a.treeWidth||"auto";a.showFullTaxonomy="showFullTaxonomy"in a?a.showFullTaxonomy:!1;a.showLabels="showLabels"in a?a.showLabels:!0;a.showDomains="showDomains"in a?a.showDomains:!0;a.dynamicHide="dynamicHide"in a?a.dynamicHide:!1;a.invertColors="invertColors"in a?a.invertColors:!1;a.lineupNodes="lineupNodes"in a?a.lineupNodes:
!0;a.showSupportValues="showSupportValues"in a?a.showSupportValues:!1;a.showLengthValues="showLengthValues"in a?a.showLengthValues:!1;a.showTaxonomy="showTaxonomy"in a?a.showTaxonomy:!0;a.showTaxonomyColors="showTaxonomyColors"in a?a.showTaxonomyColors:!0;a.showDomainNames="showDomainNames"in a?a.showDomainNames:!1;a.showDomainColors="showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend="showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames=
"showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in a?a.showPhylogram:!1;var B,H,N,z=[],L=[],J=100,I=100,t=0,P=100,ka=!1;if(b.graphs)for(var Z=0;Z<b.graphs.length;Z++)if(0!=b.graphs[Z].legend.show){ka=!0;break}P=ka?P:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?P:0);var U=jQuery(d).width(),G="auto"==a.treeWidth?U-ma():a.treeWidth,M=a.height-(2*a.margin+(a.showGraphs?P:0)),G=parseInt(G),M=parseInt(M);0>G&&(G=U-2*I-(a.showGraphs?2*P:0));var Y=d3.behavior.zoom().scaleExtent([1,
1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,g=.5;d.altKey||d.ctrlKey||(e=d.layerX/U,g=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=M*b*g;if(d.altKey||!d.ctrlKey)a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&
(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=G*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(O):requestAnimFrame(S)}});d3.select(d).select("svg").remove();var m=d3.select(d).insert("svg").attr("width",U+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version","1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(Y);m.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height",
"100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);m.append("svg:text").attr("dy","20px").attr("stroke",e()).attr("stroke-width","1px").attr("font-size","15px").text(b.name?b.name:"");m.append("svg:text").attr("dy","40px").attr("stroke",e()).attr("stroke-width","0.5px").attr("font-size","10px").text(b.description?b.description:"");m.append("defs").append("marker").attr("id","markerBoxplot").attr("markerWidth","1").attr("markerHeight","10").attr("refX","1").attr("refY","5").append("line").attr("x1",
"0").attr("x2","0").attr("y1","0").attr("y2","10").attr("stroke",e()).attr("stroke-width","2px");var m=m.append("svg:g").attr("id","main").attr("transform","translate("+a.marginX+", "+a.marginY+")"),R=m.selectAll("g.node");F();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,F());var w=m.selectAll("g.leaf.node"),C=w.selectAll("g.domain");ba();ca();q();l();ia();da();ha();R.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+
1).attr("dy",3).attr("text-anchor","start");W();Q();D();S();A();d3.select("#dynamicHide").on("click",function(){a.dynamicHide=!a.dynamicHide;F(!0);D()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var b=e();m.selectAll("path.link").attr("stroke",b);m.selectAll("text.legend").attr("fill",b);w.selectAll("path.support").attr("stroke",b);w.selectAll("path.domain").attr("stroke",
b);w.selectAll("text.nodelabel").attr("stroke",b).attr("fill",b);W();x()});d3.select("#phylogram").on("click",function(){a.showPhylogram=!a.showPhylogram;F(!0);A();D()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;F(!0);da();A();D()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=!a.showLengthValues;ca()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;ba();D()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=
!a.showNodeNames;Q();A()});d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;ha()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;Q();A()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;Q();A()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();O();Q()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;W()});d3.select("#nodeHeightLower").on("click",
function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);F(!0);A();D()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=a.nodeHeightStep;F(!0);A();D()});d3.select("#resetZoom").on("click",function(){a.domainWidth=a.domainWidthStep;a.scaleX=1;a.scaleY=1;a.translateX=0;a.translateY=0;F(!0);Y.translate([0,0]);S();A()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=M*a.scaleStep/2;a.lastScale=a.scaleStep;
requestAnimFrame(O)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=M*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(O)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=G*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(O)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=G*a.scaleStep/2;a.lastScale=
...
"disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled","disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));q();l()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;x()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;l()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=
a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);H=phyd3.phylogram.scaledomainWidths(B,a.domainWidth);E()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;H=phyd3.phylogram.scaledomainWidths(B,a.domainWidth);E()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;v()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=a.domainLevelStep;v()});d3.select("#graphLegend").on("click",
function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?P:0);K();S()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));
ia()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);A()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=a.graphWidthStep;A()});d3.select("#linkSVG").on("click",function(){var a=g();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",function(){var a=g(),b=document.createElement("canvas");canvg(b,a);
...
return b};phyd3.phyloxml.parseLegend=function(d){for(var b={show:parseInt(d.getAttribute("show")),fields:[],gradient:{}},a=d.getElementsByTagName("field"),e=0;e<a.length;e++){var g=a[e],q=g.getElementsByTagName("name")[0],q=q?q.textContent:"",l=g.getElementsByTagName("color")[0],l=l?l.textContent:"",v=g.getElementsByTagName("background")[0],v=v?v.textContent:"",x=g.getElementsByTagName("shape")[0],x=x?x.textContent:"",g=(g=g.getElementsByTagName("url")[0])?g.textContent:"";b.fields.push({name:q,color:l,
background:v,shape:x,url:g})}if(d=d.getElementsByTagName("gradient")[0])q=(q=d.getElementsByTagName("name")[0])?q.textContent:"",d=(d=d.getElementsByTagName("classes")[0])?parseInt(d.textContent):0,b.gradient={name:q,classes:d};return b};phyd3.phyloxml.parseData=function(d){var b={tag:d.getAttribute("tag"),ref:d.getAttribute("ref")},a=d.getElementsByTagName("min")[0];b.min=a?a.textContent:void 0;a=d.getElementsByTagName("max")[0];b.max=a?a.textContent:void 0;d=d.getElementsByTagName("values");for(a=
0;a<d.length;a++){var e=d[a].getAttribute("for"),g=d[a].getElementsByTagName("value");b[e]=[];for(var q=0;q<g.length;q++)b[e].push(parseFloat(g[q].textContent))}return b};phyd3.phyloxml.parseGraph=function(d){for(var b={name:"",legend:{},data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "name":b.name=e.textContent;break;case "legend":b.legend=phyd3.phyloxml.parseLegend(e);break;case "data":b.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;
...
break;case "date":b.date=g.textContent;break;case "description":b.description=g.textContent;break;case "id":b.id=g.textContent;break;case "name":b.name=g.textContent;break;case "property":b.properties.push(phyd3.phyloxml.parseProperty(g));break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+g.nodeName+" "+g.textContent+" - skipping...")}}var a=d.getElementsByTagName("taxonomies"),a=a[0],q={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++){var l=a.childNodes[e];if("color"==
l.nodeName){var g=l.getElementsByTagName("code")[0].textContent,v=l.getElementsByTagName("value")[0].textContent;q[g]={color:v}}if("taxonomy"==l.nodeName){var g=l.getAttribute("code"),v=(v=l.getElementsByTagName("color")[0])?v.textContent:v,x=l.getElementsByTagName("name")[0],x=x?x.textContent:x,l=(l=l.getElementsByTagName("url")[0])?l.textContent:l;q[g]={color:v,name:x,url:l}}}b.taxcolors=q;a=d.getElementsByTagName("domains");a=a[0];q={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)l=a.childNodes[e],
"color"==l.nodeName&&(g=l.getElementsByTagName("code")[0].textContent,v=l.getElementsByTagName("value")[0].textContent,q[g]={color:v}),"domain"==l.nodeName&&(g=l.getAttribute("name"),v=(v=l.getElementsByTagName("color")[0])?v.textContent:v,x=(x=l.getElementsByTagName("description")[0])?x.textContent:x,l=(l=l.getElementsByTagName("url")[0])?l.textContent:l,q[g]={color:v,description:x,url:l});b.domcolors=q;a=d.getElementsByTagName("graphs");a=a[0];g=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)v=
a.childNodes[e],"graph"==v.nodeName&&g.push(phyd3.phyloxml.parseGraph(v));b.graphs=g;a=d.getElementsByTagName("labels");a=a[0];d=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)g=a.childNodes[e],"label"==g.nodeName&&d.push(phyd3.phyloxml.parseLabel(g));b.labels=d;return b}})();
/* Blob.js
