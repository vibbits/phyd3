...
$jscomp.polyfill=function(d,b,a,f){if(b){a=$jscomp.global;d=d.split(".");for(f=0;f<d.length-1;f++){var g=d[f];g in a||(a[g]={});a=a[g]}d=d[d.length-1];f=a[d];b=b(f);b!=f&&null!=b&&$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:b})}};$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
$jscomp.symbolCounter_=0;$jscomp.Symbol=function(d){return $jscomp.SYMBOL_PREFIX+(d||"")+$jscomp.symbolCounter_++};$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var d=$jscomp.global.Symbol.iterator;d||(d=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[d]&&$jscomp.defineProperty(Array.prototype,d,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};
$jscomp.arrayIterator=function(d){var b=0;return $jscomp.iteratorPrototype(function(){return b<d.length?{done:!1,value:d[b++]}:{done:!0}})};$jscomp.iteratorPrototype=function(d){$jscomp.initSymbolIterator();d={next:d};d[$jscomp.global.Symbol.iterator]=function(){return this};return d};$jscomp.array=$jscomp.array||{};
$jscomp.iteratorFromArray=function(d,b){$jscomp.initSymbolIterator();d instanceof String&&(d+="");var a=0,f={next:function(){if(a<d.length){var g=a++;return{value:b(g,d[g]),done:!1}}f.next=function(){return{done:!0,value:void 0}};return f.next()}};f[Symbol.iterator]=function(){return f};return f};$jscomp.polyfill("Array.prototype.values",function(d){return d?d:function(){return $jscomp.iteratorFromArray(this,function(b,a){return a})}},"es6","es3");
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(d){var b=[],a={};d=d.split(/\s*(;|\(|\)|,|:)\s*/);for(var f=0,g=0;g<d.length;g++){var u=d[g];switch(u){case "(":u={};a.id=f;f++;a.branchset=[u];b.push(a);a=u;break;case ",":u={};b[b.length-1].branchset.push(u);a=u;break;case ")":a=b.pop();break;case ":":break;default:var q=d[g-1];")"==q||"("==q||","==q?a.name=u:":"==q&&(a.branchLength=parseFloat(u));a.id=f;f++}}return a}})();
...
end:b[2]});!d.children&&b[2][0]>phyd3.phylogram.dx&&(phyd3.phylogram.dx=b[2][0]);return"M"+b[0]+" "+b[1]+" "+b[2]};phyd3.phylogram.scaleBranchLengths=function(d,b){function a(b,d){d(b);if(b.children)for(var f=b.children.length-1;0<=f;f--)a(b.children[f],d)}a(d[0],function(a){0>a.branchLength&&(a.branchLength*=-1);a.rootDist=(a.parent?a.parent.rootDist:0)+(a.branchLength||0)});var f=d.map(function(a){return a.rootDist}),g=d3.scale.linear().domain([0,d3.max(f)]).range([0,b]);a(d[0],function(a){a.y=
parseInt(g(a.rootDist))});return g};phyd3.phylogram.randomColor=function(){function d(a,b,d){0>d&&(d+=1);1<d&&--d;return d<1/6?a+6*(b-a)*d:.5>d?b:d<2/3?a+(b-a)*(2/3-d)*6:a}var b=Math.random();return function(a,b,g){if(0==b)g=b=a=g;else{var f=.5>g?g*(1+b):g+b-g*b,q=2*g-f;g=d(q,f,a+1/3);b=d(q,f,a);a=d(q,f,a-1/3)}return"#"+Math.round(255*g).toString(16)+Math.round(255*b).toString(16)+Math.round(255*a).toString(16)}((b+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(d,b){d=d.map(function(a){return a.sequences&&
a.sequences[0]&&a.sequences[0].domainArchitecture&&a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(d)]).range([0,b])};phyd3.phylogram.build=function(d,b,a){function f(){n.selectAll("text.groupLabel").remove();n.selectAll("rect.groupLabel").remove();var h=0;for(gid in b.groups){var d=b.groups[gid];d.x1=Number.MAX_SAFE_INTEGER;d.x2=0;d.y1=Number.MAX_SAFE_INTEGER;d.y2=0;h<d.depth&&(h=d.depth);u(b,d)}for(;0<=
h;h--)for(gid in b.groups)d=b.groups[gid],d.depth==h&&(n.insert("text",":first-child").attr("class","groupLabel").attr("y",d.x1).attr("x",0).attr("dy",2*a.nodeHeight).attr("text-anchor","start").attr("stroke",d.foregroundColor).attr("stroke-width",a.outline+"px").attr("font-size",1.5*a.nodeHeight+"px").text(d.label),n.insert("rect",":first-child").attr("class","groupLabel").attr("stroke",d.backgroundColor).attr("fill",d.backgroundColor).attr("y",d.x1).attr("height",d.x2-d.x1).attr("x",0).attr("width",
phyd3.phylogram.dx).append("title").text(d.label))}function g(a,d,e){if(e||a.id==d){e=!0;a.groupIDs||(a.groupIDs=[]);a.groupIDs.push(d);var h=b.groups[d];a.x<h.x1&&(h.x1=a.x);a.x>h.x2&&(h.x2=a.x);a.y<h.y1&&(h.y1=a.y);a.y>h.y2&&(h.y2=a.y)}if(a.children)for(h=0;h<a.children.length;h++)g(a.children[h],d,e)}function u(a,b){if(a.groupIDs)for(var h=0;h<a.groupIDs.length;h++)a.groupIDs[h]==b.id&&(a.id==b.id&&(b.depth=a.depth),a.x<b.x1&&(b.x1=a.x),a.x>b.x2&&(b.x2=a.x),a.y<b.y1&&(b.y1=a.y),a.y>b.y2&&(b.y2=
a.y));if(a.children)for(h=0;h<a.children.length;h++)u(a.children[h],b)}function q(a,b){if(a.groupIDs){var h=a.groupIDs.indexOf(b);-1!=h&&a.groupIDs.splice(h,1)}if(a.children)for(h=0;h<a.children.length;h++)q(a.children[h],b)}function w(){a.domainWidth=a.domainWidthStep;a.graphWidth=a.initialGraphWidth;a.scaleX=1;a.scaleY=1;a.translateX=0;a.translateY=0;ca.translate([0,0])}function z(){d3.select(d).select("svg").remove();svg=d3.select(d).insert("svg");svg.attr("width",Y+"px").attr("height",a.height+
...
"10").attr("stroke",x()).attr("stroke-width","2px");n=svg.append("svg:g",":first-child").attr("id","main").attr("transform","translate("+a.marginX+", "+a.marginY+")");svg.append("svg:text").attr("dy","20px").attr("class","title").attr("stroke",x()).attr("stroke-width","1px").attr("font-size","15px").text(b.name?b.name:"");svg.append("svg:text").attr("class","title").attr("dy","40px").attr("stroke",x()).attr("stroke-width","0.5px").attr("font-size","10px").text(b.description?b.description:"");Q=n.selectAll("g.node");
L();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,L());A=n.selectAll("g.leaf.node");F=A.selectAll("g.domain");ma();da();na();ea();fa();oa();pa();Q.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");Z();R();I();aa();D()}function qa(){n.selectAll("rect.searchResults").remove();var a=jQuery("#searchQuery").val(),d=new RegExp(a,"i");a.length&&ra(b,d)}function x(){return a.invertColors?
a.backgroundColor:a.foregroundColor}function ga(){d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var h=x();n.selectAll("path.link").attr("stroke",h);d3.selectAll("text").attr("fill",h);d3.selectAll("marker").selectAll("line").attr("stroke",h);d3.selectAll("text.title").attr("stroke",h);n.selectAll("text.nodelabel").attr("stroke",h).attr("fill",h);A.selectAll("path").attr("stroke",h);A.selectAll("line").attr("stroke",h);A.selectAll("rect").attr("stroke",h);
Z();ha()}function sa(){var h=d.replace("#",""),h=document.getElementById(h).querySelector("svg"),b=h.getElementById("main"),e=b.getBBox(),b=b.getAttributeNode("transform"),f=h.getAttributeNode("width"),l=h.getAttributeNode("height"),k=b.value,p=f.value,m=l.value;b.value="translate("+a.marginX+", "+a.marginY+")";f.value=(Math.max(+f.value.replace("px",""),e.width)+a.marginX).toString();l.value=(Math.max(+l.value.replace("px",""),e.height)+a.marginY).toString();if("undefined"!=typeof window.XMLSerializer)var g=
(new XMLSerializer).serializeToString(h);else"undefined"!=typeof h.xml&&(g=h.xml);b.value=k;f.value=p;l.value=m;return g}function ma(){a.showDomains?(M=phyd3.phylogram.scaledomainWidths(H,a.domainWidth),A.append("svg:path").attr("class","domain").attr("stroke",x()).attr("visibility",function(a,b){return a.show?"visibile":"hidden"}),F=F.data(function(a,b,e){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(e=0;e<a.length;e++)a[e].i=b;
a.sort(function(a,h){return Math.abs(h.to-h.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),F.append("svg:rect").attr("class","domain hover-visible").attr("stroke",x()).attr("stroke-width",a.outline+"px").append("title").text(function(a){return a.name}),ba(),J(),ha()):(F.remove(),A.selectAll("path.domain").remove(),F=A.selectAll("g.domain"))}function da(){a.showDomainNames?(F.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",x()).attr("font-size",
1.5*a.nodeHeight+"px").text(function(a){return a.name}),J()):F.selectAll("text.domain").remove()}function ba(){var h=A.data();A.selectAll("g.domain").attr("visibility",function(b,e,d){return h[d].show&&b.confidence<=a.domainLevel?"visible":"hidden"});A.selectAll("path.domain").attr("visibility",function(a){return a.show?"visible":"hidden"});d3.select("#domainLevel").attr("value",a.domainLevel.toPrecision(1))}function ha(){F.selectAll("rect.domain").attr("fill",function(h){return a.showDomainColors&&
b.domcolors[h.name]?b.domcolors[h.name].color.replace(/0x/,"#"):x()})}function J(){var h=A.data(),b=N+(a.showLabels?O:0)+(a.showGraphs?v:0);M=phyd3.phylogram.scaledomainWidths(H,a.domainWidth);A.selectAll("path.domain").attr("d",function(a,d,l){d=phyd3.phylogram.dx-h[l].y;a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.sequenceLength:0;return"M"+parseInt(b+d)+",0L"+parseInt(b+d+M(a))+",0"});F.selectAll("rect.domain").attr("width",function(a){return parseInt(M(a.to-
a.from))}).attr("transform",function(e,d,l){return"translate("+parseInt(b+(phyd3.phylogram.dx-h[e.i].y)+M(e.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);F.selectAll("text.domain").attr("transform",function(e){return"translate("+parseInt(b+(phyd3.phylogram.dx-h[e.i].y)+M(e.from))+","+parseInt(-1*a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",a.domainWidth)}function ea(){n.selectAll("text.supportValue").remove();a.showSupportValues&&(n.selectAll("g.inner.node").append("svg:text").attr("class",
"supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(h){var b="";if(h.confidences)for(var e=0;e<h.confidences.length;e++)b+=parseFloat(h.confidences[e].value).toFixed(a.maxDecimalsSupportValues)+" ";return b}),d3.select("#maxDecimalsSupportValues").attr("value",a.maxDecimalsSupportValues),D(),I())}function fa(){n.selectAll("text.branchLength").remove();a.showLengthValues&&(n.selectAll("g.node").append("svg:text").attr("class","branchLength").attr("dx",
-2).attr("text-anchor","end").attr("fill",a.branchLengthColor).text(function(h){return h.branchLength?parseFloat(h.branchLength).toFixed(a.maxDecimalsLengthValues):""}),d3.select("#maxDecimalsLengthValues").attr("value",a.maxDecimalsLengthValues),D(),I())}function ia(a,b,e){var h=a.attr("id")+"_"+a.selectAll("div.panel-default").size(),d=a.append("div").attr("class","panel panel-default");d.append("div").attr("class","panel-heading").attr("role","tab").attr("id","heading"+h).append("h4").attr("class",
"panel-title").append("a").attr("class","collapsed").attr("aria-expanded",e?"true":"false").attr("role","button").attr("data-toggle","collapse").attr("data-parent","#"+a.attr("id")).attr("href","#collapse"+h).attr("aria-controls","collapse"+h).html(b);return d.append("div").attr("id","collapse"+h).attr("class","panel-collapse collapse "+(e?"in":"")).attr("role","tabpanel").attr("aria-labelledby","heading"+h).append("div").attr("class","panel-body table-responsive")}function za(h){var f=d3.event,e=
f.layerX;y=f.layerY;var X="popup"+parseInt(Date.now()*Math.random()*1E3),e=d3.select(d).append("div").attr("class","popup").attr("id",X).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(e)+"px").style("width",parseInt(a.popupWidth)+"px").style("color","black").style("background-color","white"),l=e.append("button").attr("class","btn btn-link").style("position","absolute").style("right","8px");l.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden",
"true");l.on("click",function(){d3.select("#"+X).remove();n.selectAll("g.node.cid_"+h.id).selectAll("rect.pointer").style("opacity","0")});e=e.append("div").attr("class","panel-group").attr("id","accordion_"+parseInt(Date.now()*Math.random()*1E3)).attr("role","tablist").attr("aria-multiselectable","true");l="text"==f.target.nodeName||f.target.classList&&f.target.classList.contains("pointer")?!0:!1;l=ia(e,"Node",l).append("table").attr("class","table table-condensed table-bordered").append("tbody");
if(h.name){var k=l.append("tr");k.append("td").text("Name");k.append("td").text(h.name)}if(h.taxonomies)for(var p=0;p<h.taxonomies.length;p++){var m=h.taxonomies[p],k=l.append("tr");k.append("td").text("Taxononomy");k=k.append("td");b.taxcolors[m.code]&&b.taxcolors[m.code].url&&(k=k.append("a").attr("href",b.taxcolors[m.code].url).attr("target","_blank"));var g="",g=g+(b.taxcolors[m.code]&&b.taxcolors[m.code].name?b.taxcolors[m.code].name+" ":""),g=g+" ",g=g+(m.scientificName?"\x3ci\x3e"+m.scientificName+
"\x3c/i\x3e":""),g=g+" ",g=g+(m.commonName?m.commonName:""),g=g+" ",g=g+(m.code?"("+m.code+")":"");k.html(g)}if(h.confidences)for(p=0;p<h.confidences.length;p++)k=l.append("tr"),k.append("td").text("Confidence"),k.append("td").html(h.confidences[p].value);k=l.append("tr");k.append("td").text("Depth");k.append("td").text(h.depth);k=l.append("tr");k.append("td").text("Branch length");k.append("td").text(h.branchLength?h.branchLength:0);k=l.append("tr");k.append("td").text("Distance from root");k.append("td").text(h.rootDist);
for(p=0;p<h.properties.length;p++)k=h.properties[p],t=k.ref,m=k.value,m=m.trim(),/^http:\/\//.test(m)&&(m="\x3ca href\x3d'"+m+"' target\x3d'_blank'\x3e"+m+"\x3c/a\x3e\x3cbr /\x3e"),k=l.append("tr"),k.append("td").text(t),k.append("td").html(m);for(var t in h.events)m=h.events[t],k=l.append("tr"),k.append("td").text(t),k.append("td").html(m);if(h.sequences)for(p=0;p<h.sequences.length;p++){t=h.sequences[p];m="";m+=t.symbol?t.symbol+" ":"";m+=t.name?t.name+" ":"";m+=t.location?t.location+" ":"";m+=
t.geneName?t.geneName:"";m.length&&(k=l.append("tr"),k.append("td").text("Sequence"),k.append("td").html(m));t.accession&&(m="",m+=t.accession.value?t.accession.value+" ":"",m+=t.accession.source?"["+t.accession.source+"] ":"",m+=t.accession.comment?"("+t.accession.comment+")":"",m.length&&(k=l.append("tr"),k.append("td").text("Accession"),k.append("td").html(m)));t.molSeq&&t.molSeq.value&&(k=l.append("tr"),k.append("td").text("Molecular Sequence"),k.append("td").html(t.molSeq.value));if(t.uris){m=
"";for(k=0;k<t.uris.length;k++)m=t.uris[k],m="\x3ca href\x3d'"+m.value+"'\x3e"+(m.desc?m.desc:m.value)+"\x3c/a\x3e";m.length&&(k=l.append("tr"),k.append("td").text("See also"),k.append("td").html(m))}if(h.sequences[p].domainArchitecture&&h.sequences[p].domainArchitecture.domains){l=f.target.parentNode.classList&&f.target.parentNode.classList.contains("domain")?!0:!1;l=ia(e,"Domains",l).append("table").attr("id","dt"+X).attr("class","table table-condensed table-bordered");t=l.append("thead").append("tr");
t.append("th").text("#");t.append("th").text("Name");t.append("th").text("Description");t.append("th").text("From");t.append("th").text("To");t.append("th").text("P value");g=l.append("tbody");for(m=0;m<h.sequences[p].domainArchitecture.domains.length;m++){var E=h.sequences[p].domainArchitecture.domains[m],k=g.append("tr");k.append("td").style("background",b.domcolors[E.name]&&b.domcolors[E.name].color?b.domcolors[E.name].color.replace("0x","#"):"").text(" ");t=k.append("td");b.domcolors[E.name]&&
b.domcolors[E.name].url&&(t=t.append("a").attr("href",b.domcolors[E.name].url).attr("target","_blank"));t.text(E.name);k.append("td").text(b.domcolors[E.name]?b.domcolors[E.name].description:"");k.append("td").text(E.from);k.append("td").text(E.to);k.append("td").text(E.confidence)}jQuery("#dt"+X).dataTable({searching:!1,paging:!1,language:{info:""},order:[[3,"asc"]],columns:[{orderable:!1},null,null,null,null,null]})}}if(b.graphs)for(p=0;p<b.graphs.length;p++)if(g=b.graphs[p],g.data&&g.data[h.id]&&
g.data[h.id].length)for(l=f.target.parentNode.classList&&f.target.parentNode.classList.contains(g.type)?!0:!1,l=ia(e,g.name,l).append("table").attr("class","table table-condensed table-bordered").append("tbody"),m=0;m<g.legend.fields.length;m++)k=l.append("tr"),t=k.append("td"),g.legend.fields[m].url&&(t=t.append("a").attr("href",g.legend.fields[m].url).attr("target","_blank")),t.text(g.legend.fields[m].name),k.append("td").text(g.data[h.id][m]);n.selectAll("g.node.cid_"+h.id).selectAll("rect.pointer").style("opacity",
"1");f.stopPropagation()}function oa(){a.lineupNodes?n.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",x()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):n.selectAll("path.support").remove()}function W(h,d){var e="";if(a.showTaxonomy&&h.taxonomies)for(var f=0;f<h.taxonomies.length;f++){var l=h.taxonomies[f];a.showFullTaxonomy&&(e+=b.taxcolors[l.code]&&b.taxcolors[l.code].name?b.taxcolors[l.code].name:"",e+=" ",e+=l.scientificName?l.scientificName:"",e+=" ",e+=
l.commonName?l.commonName:"",e+=" ");e+=l.code?l.code:"";e+=" "}f="";if(a.showSequences&&h.sequences)for(l=0;l<h.sequences.length;l++){var k=h.sequences[l],f=f+(k.symbol?k.symbol:""),f=f+" ",f=f+(k.accession?k.accession.value:""),f=f+" ",f=f+(k.name?k.name:""),f=f+" ",f=f+(k.geneName?k.geneName:""),f=f+" ";if(k.annotations)for(var p=0;p<k.annotations.length;p++)text+=k.annotations[p].desc?k.annotations[p].desc:"",text+=" "}l=a.showNodeNames&&h.name?h.name+" ":" ";d||(h.children&&"only leaf"==a.showNodesType&&
(l=" "),h.children||"only inner"!=a.showNodesType||(l=" "));return e+l+f}function R(){var h=0;ja=0;A.selectAll("text.name").text(function(a){var b=W(a);b.length>h&&(h=b.length,ja=a.id);return b});n.selectAll("g.node.inner").selectAll("text.name").text(W);a.showGraphs&&S();a.showDomains&&J()}function I(){n.selectAll("text.branchLength").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("text.supportValues").attr("visibility",function(a){return a.show?"visible":"hidden"});
n.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&A.selectAll("path.support").attr("visibility",function(a){return a.show?"visible":"hidden"});a.showLabels&&ta();a.showGraphs&&ua();a.showDomains&&ba()}function Z(){n.selectAll("text.name").attr("stroke",x()).attr("stroke-width",a.outline+"px").attr("fill",function(h){var d=null;if(a.showTaxonomyColors&&b.taxcolors&&h.taxonomies)for(var e=0;e<h.taxonomies.length;e++){var f=h.taxonomies[e];b.taxcolors[f.code]&&
b.taxcolors[f.code].color&&(d=b.taxcolors[f.code].color.replace(/0x/,"#"))}return d?d:x()})}function va(){A.selectAll("text.name").attr("dx",function(b){return parseInt(a.lineupNodes?phyd3.phylogram.dx-b.y+5:5)});A.selectAll("path.support").attr("d",function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-a.y)+",0"});a.showLabels&&ka();a.showGraphs&&S();a.showDomains&&J()}function D(){var b=0;n.selectAll("text.name").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.branchLength").attr("dy",
-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("g.leaf.cid_"+ja).selectAll("text.name").each(function(){var a=this.getBBox();a.width>b&&(b=a.width)});b+=10;b<a.textLength&&(b=a.textLength);console.log(b);N=b;d3.select("#nodeHeight").attr("value",2*a.nodeHeight+"px");va();a.showLabels&&ka();a.showGraphs&&S();a.showDomains&&J()}function pa(){if(a.showLabels&&b.labels){for(var h=
0;h<b.labels.length;h++){var d=b.labels[h];d.id||(d.id=parseInt(Date.now()*Math.random()*1E3));d.data.tag&&n.selectAll("g.node").each(function(a){var b=a[d.data.tag],h=d.data.ref,h=h?h:"value",b="object"==typeof b?b[h]:b;if("property"==d.data.tag)for(pid=0;pid<a.properties.length;pid++){var e=a.properties[pid];if(e.ref==h){b=e.value;break}}b&&(d.data[a.id]=b)});switch(d.type){case "text":for(cid in d.data)d.data[cid]&&n.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+d.id).attr("dy",
3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",x()).attr("fill",x()).attr("font-size",1.5*a.nodeHeight+"px").text(d.data[cid]).append("title").text(d.name+": "+d.data[cid]);break;case "color":for(cid in d.data)if(d.data[cid]){var e=a.nodeHeight,f=d.data[cid].replace(/0x/,"#");n.selectAll(".cid_"+cid).append("rect").attr("height",2*e).attr("width",2*e).attr("class","nodelabel color lid"+d.id).attr("style","fill: "+f+"; stroke: "+f).append("title").text(d.name)}}n.append("text").attr("class",
"labellegend lid"+d.id).attr("fill",x()).text(0!=d.showLegend?d.name:"")}ta();ka()}else n.selectAll(".nodelabel").remove(),n.selectAll(".labellegend").remove(),O=0;S();J()}function ka(){var d=a.nodeHeight;O=0;if(b.labels){for(var f=0;f<b.labels.length;f++){var e=b.labels[f],g=0;n.selectAll(".nodelabel.lid"+e.id).attr("transform",function(a){var b=0,h=0;"color"==e.type&&(b=h=-d);var f=0;"text"==this.nodeName&&this.firstChild?f=this.firstChild.length*d/1.5:"rect"==this.nodeName&&(f=2*d);f>g&&(g=f);
a.branchset.length?(b+=a.y,b-=d):b+=phyd3.phylogram.dx+N;return"translate("+parseInt(b+d+O-a.y)+","+h+")"});n.selectAll("text.labellegend.lid"+e.id).attr("transform","translate("+parseInt(phyd3.phylogram.dx+O+N+2*d)+",-10) rotate(-90)");O+=g+2*d}f=A.selectAll(".nodelabel");f.selectAll("text").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");f.selectAll("rect").attr("width",2*a.nodeHeight).attr("height",2*a.nodeHeight)}}function ta(){n.selectAll(".nodelabel").attr("visibility",function(a){return a.show?
"visible":"hidden"})}function na(){if(a.showGraphs&&b.graphs&&b.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);for(var d=d3.layout.pie().value(function(a){return a.value}).sort(null),f=v=0;f<b.graphs.length;f++){var e=b.graphs[f];e.id||(e.id=parseInt(Date.now()*Math.random()*1E3));if(e.data.tag)var g=n.selectAll("g.node").each(function(a){var b=a[e.data.tag],d=e.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==e.data.tag)for(var h=0;h<a.properties.length;h++){var f=
a.properties[h];if(f.ref==d){b=f.value;break}}b&&(e.data[a.id]=[],e.data[a.id][0]=b,"pie"==e.type&&e.data.max&&(e.data[a.id][1]=e.data.max-b,e.legend.fields[1]={name:e.legend.fields[0].name,color:e.legend.fields[0].background?e.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(e.type){case "pie":for(cid in e.data)if(e.data[cid]&&Array.isArray(e.data[cid])){var l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});for(var g=n.selectAll(".cid_"+cid).append("svg:g").attr("class",
"graph pie gid"+e.id),k=[],p=0;p<e.data[cid].length;p++)void 0!=e.data[cid][p]&&k.push({i:p,value:e.data[cid][p],leaf:l});g=g.selectAll("path.pie.gid"+e.id).data(d(k)).enter().append("path").attr("class","pie hover-visible gid"+e.id).attr("stroke",x()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return e.legend.fields?(e.legend.fields[b]||(e.legend.fields[b]={},e.legend.fields[b].name="Series "+(b+1),e.legend.fields[b].color=phyd3.phylogram.randomColor()),e.legend.fields[b].color.replace(/0x/,
"#")):""}).append("title").text(function(a,b){return e.legend.fields?(e.legend.fields[b]&&e.legend.fields[b].name?e.legend.fields[b].name+": ":"")+(e.legend.fields[b].invert?e.data.max-a.data.value:a.data.value):""})}break;case "binary":for(cid in e.data)if(e.data[cid]&&Array.isArray(e.data[cid])){k=[];l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});g=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+e.id);for(p=0;p<e.data[cid].length;p++)void 0!=
e.data[cid][p]&&k.push({i:p,value:e.data[cid][p],shape:e.legend.fields[p]?e.legend.fields[p].shape:"",leaf:l});g=g.selectAll("path.binary.gid"+e.id).data(k).enter().append("path").attr("class","binary hover-visible gid"+e.id).attr("style",function(a,b){b=(e.legend.fields[b]?e.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(e.legend.fields[b]?e.legend.fields[b].name+": ":"")+a.value})}break;
case "multibar":B[e.id]=[];for(p=0;p<e.legend.fields.length;p++)g=d3.max(d3.values(e.data),function(a){if(a)return a[p]}),k=d3.min(d3.values(e.data),function(a){if(a)return a[p]}),0<k&&(k=0),B[e.id][p]=d3.scale.linear().domain([k,g]);for(cid in e.data)if(e.data[cid]){g=n.select(".cid_"+cid).append("svg:g").attr("class","graph multibar gid"+e.id);k=[];for(p=0;p<e.data[cid].length;p++)void 0!=e.data[cid][p]&&k.push({i:p,value:e.data[cid][p]});g=g.selectAll("rect.multibar.gid"+e.id).data(k).enter().append("rect").attr("class",
"multibar hover-visible gid"+e.id).attr("fill",function(a,b){return(e.legend.fields[b]?e.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",x()).attr("stroke-width",a.outline).append("title").text(function(a,b){return(e.legend.fields[b]?e.legend.fields[b].name+": ":"")+a.value})}break;case "boxplot":C[e.id]=null;for(var m=0,q=Number.MAX_SAFE_INTEGER,p=0;5>p;p++)g=d3.max(d3.values(e.data),function(a){if(a)return a[p]}),k=d3.max(d3.values(e.data),function(a){if(a)return a[p]}),g>m&&(m=g),
k<q&&(q=k);C[e.id]=d3.scale.linear().domain([q,m]);for(cid in e.data)e.data[cid]&&(g=n.select(".cid_"+cid).append("svg:g").attr("class","graph boxplot gid"+e.id),k=[],k.push({min:e.data[cid][0],q1:e.data[cid][1],median:e.data[cid][2],q3:e.data[cid][3],max:e.data[cid][4]}),g=g.selectAll("rect.boxplot.gid"+e.id).data(k).enter(),g.append("line").attr("class","boxplot baseline hover-visible gid"+e.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",x()),
g.append("rect").attr("class","boxplot q1 hover-visible gid"+e.id).attr("fill",(e.legend.fields[0]?e.legend.fields[0].color:"").replace(/0x/,"#")).attr("stroke",x()).attr("stroke-width",a.outline).append("title").text(function(a){return"Min: "+a.min+", Q1: "+a.q1+", Median: "+a.median}),g.append("rect").attr("class","boxplot q3 hover-visible gid"+e.id).attr("fill",(e.legend.fields[1]?e.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",x()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+
a.median+", Q3: "+a.q3+", Max: "+a.max}),g.append("line").attr("class","boxplot median hover-visible gid"+e.id).attr("stroke",x()).attr("stroke-width","2px"));break;case "heatmap":var g=d3.max(d3.values(e.data),function(a){if(a)return d3.max(a)}),k=d3.min(d3.values(e.data),function(a){if(a)return d3.min(a)}),t=d3.scale.quantize().domain([k,g]).range(colorbrewer[e.legend.gradient.name][e.legend.gradient.classes]);for(cid in e.data)if(e.data[cid]){g=n.select(".cid_"+cid).append("svg:g").attr("class",
"graph heatmap gid"+e.id);k=[];if(e.data[cid])for(p=0;p<e.data[cid].length;p++)void 0!=e.data[cid][p]&&k.push({i:p,value:e.data[cid][p]});g=g.selectAll("rect.heatmap.gid"+e.id).data(k).enter().append("rect").attr("class","heatmap hover-visible gid"+e.id).attr("fill",function(a,b){return t(a.value)}).attr("stroke",x()).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(e.legend.fields[b]?e.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+
e.type)}}ua();S()}else v=0,n.selectAll("g.graph").remove(),n.selectAll("text.legend").remove();J()}function S(){var d=a.nodeHeight,f=N+O;A.selectAll("g.graph").attr("transform",function(a){return"translate("+(phyd3.phylogram.dx-a.y+f)+",0)"});var e=n.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);n.selectAll("text.legend").remove();v=0;if(b.graphs){for(var g=0;g<b.graphs.length;g++){var l=b.graphs[g];switch(l.type){case "pie":e.selectAll("path.pie.gid"+l.id).attr("d",function(a){if(0<
a.value)return d3.svg.arc().innerRadius(0).outerRadius(d)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?d+v:0)+",0)"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class","legend").text(0!=l.legend.show?l.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+f+v+2*d)+",-10) rotate(-90)");v+=2*d+5;break;case "binary":e.selectAll("path.binary.gid"+l.id).attr("d",function(a){var b=d3.svg.symbol().size(4*(d-2)*(d-2));b.type(l.legend.fields[a.i].shape);
return b(a)}).attr("transform",function(a){return" translate("+(a.leaf?v+10+a.i*(2*d+5):0)+" ,0)"});if(a.showGraphs&&a.showGraphLegend)for(var k=0;k<l.legend.fields.length;k++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+f+v+k*(2*d+5)+2*d)+", -10) rotate(-90)");v+=(l.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":for(k=0;k<l.legend.fields.length;k++)B[l.id][k]=B[l.id][k].range([0,a.graphWidth]);
e.selectAll("rect.multibar.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a,b){b=parseInt(B[l.id]&&B[l.id][a.i]?B[l.id][a.i](a.value):0);a=parseInt(B[l.id]&&B[l.id][a.i]?B[l.id][a.i](0):0);return b>a?b-a:a-b}).attr("transform",function(b,e){e=v+b.i*(a.graphWidth+5);var h=parseInt(B[l.id]&&B[l.id][b.i]?B[l.id][b.i](b.value):0);b=parseInt(B[l.id]&&B[l.id][b.i]?B[l.id][b.i](0):0);return" translate("+parseInt(e+(b<h?b:h))+",-"+parseInt(d)+")"}).attr("x",function(a,b){});if(a.showGraphs&&
a.showGraphLegend)for(k=0;k<l.legend.fields.length;k++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+f+v+k*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");v+=l.legend.fields.length*(a.graphWidth+5);break;case "boxplot":C[l.id]=C[l.id].range([0,a.graphWidth]);e.selectAll("rect.q1.boxplot.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(C[l.id](a.median)-C[l.id](a.q1))}).attr("transform",
function(a,b){a=v+C[l.id](a.q1);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});e.selectAll("rect.q3.boxplot.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(C[l.id](a.q3)-C[l.id](a.median))}).attr("transform",function(a,b){a=v+C[l.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});e.selectAll("line.baseline.boxplot.gid"+l.id).attr("y1",parseInt(d)).attr("y2",parseInt(d)).attr("x1",function(a){return C[l.id](a.min)}).attr("x2",function(a){return C[l.id](a.max)}).attr("transform",
function(a,b){return" translate("+parseInt(v)+",-"+parseInt(d)+")"});e.selectAll("line.median.boxplot.gid"+l.id).attr("y1",0).attr("y2",parseInt(2*d)).attr("x1",function(a){return C[l.id](a.median)}).attr("x2",function(a){return C[l.id](a.median)}).attr("transform",function(a,b){return" translate("+parseInt(v)+",-"+parseInt(d)+")"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class","legend").text(0!=l.legend.show?l.name:"").attr("transform","translate("+(phyd3.phylogram.dx+f+v+2*d)+", -10) rotate(-90)");
v+=a.graphWidth+5;break;case "heatmap":e.selectAll("rect.heatmap.gid"+l.id).attr("width",2*d).attr("height",2*d).attr("transform",function(a,b){return" translate("+(v+2*a.i*d)+",-"+d+")"});if(a.showGraphs&&a.showGraphLegend)for(k=0;k<l.legend.fields.length;k++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[k].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+f+v+(k+1)*d*2)+",-10) rotate(-90)");v+=2*l.legend.fields.length*d+5}}n.selectAll("text.legend").attr("fill",
x()).attr("font-size",2*a.nodeHeight+"px")}}function Aa(){var d=a.nodeHeight;v=0;if(b.graphs)for(var f=0;f<b.graphs.length;f++){var e=b.graphs[f];switch(e.type){case "pie":v+=2*d+5;break;case "binary":v+=(e.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":v+=e.legend.fields.length*(a.graphWidth+5);break;case "heatmap":v+=2*e.legend.fields.length*d+5}}return 2*a.margin+(a.showNodeNames?N:0)+(a.showGraphs?v:0)+(a.showDomains?a.domainWidth:0)}function ua(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";
for(var e=!0,f=a.nodeHeight,h=d.x,g=d.y,m=0;m<b.length;m++){var n=b[m].x,t=b[m].y;if((n-h)*(n-h)+(t-g)*(t-g)<=4*f*f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};A.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);n.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function L(d,g){phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;g=d3.layout.cluster().separation(function(a,
b){return 1}).children(a.children||function(a){return a.branchset}).size([T*a.scaleY,K*a.scaleX]);H=g(b);a.showPhylogram||phyd3.phylogram.scaleBranchLengths(H,K*a.scaleX);var e=n.selectAll("path.link");d||(e=e.data(g.links(H)),e.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",function(a){if(a.source.groupIDs&&a.source.groupIDs.length){for(var d={depth:0},e=0;e<a.source.groupIDs.length;e++){var f=b.groups[a.source.groupIDs[e]];f&&f.depth>=d.depth&&(d=f)}return d.foregroundColor}return x()}));
e.attr("d",phyd3.phylogram.rightAngleDiagonal);U=void 0;c=0;e=H.filter(function(a){return!a.children});for(g=0;g<e.length;g++)e[g].show=a.dynamicHide?wa(e[g],!a.lineupNodes):!0;U=void 0;e=H.filter(function(a){return a.children});for(g=0;g<e.length;g++)e[g].show=a.dynamicHide?wa(e[g],!0):!0;d||(Q=Q.data(H),Q.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",function(d){var e=
d3.event;!e.ctrlKey||e.altKey||e.shiftKey?!e.altKey||e.ctrlKey||e.shiftKey?!e.shiftKey||e.altKey||e.ctrlKey?e.shiftKey||e.altKey||e.ctrlKey||(void 0!==a.popupAction?a.popupAction(d):za(d)):(jQuery("#groupID").val(d.id),jQuery("#groupDepth").val(d.depth),b.groups[d.id]?(jQuery("#groupLabel").val(b.groups[d.id].label),jQuery("#groupLabelForegroundCP").colorpicker("setValue",b.groups[d.id].foregroundColor),jQuery("#groupLabelBackgroundCP").colorpicker("setValue",b.groups[d.id].backgroundColor)):(jQuery("#groupLabel").val(""),
jQuery("#groupLabelForegroundCP").colorpicker("setValue",x()),jQuery("#groupLabelBackgroundCP").colorpicker("setValue",a.invertColors?a.foregroundColor:a.backgroundColor)),jQuery("#groupLabelModal").modal("show")):(xa(b,d.id),w(),z()):(ya(b,d.id),f(),z())}).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+"px"));
Q.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function ra(b,d){if(W(b,!0).match(d)){var e=!b.children&&a.lineupNodes?phyd3.phylogram.dx-b.y:0;n.selectAll("g.node.cid_"+b.id).append("rect").attr("class","searchResults").attr("width",N+"px").attr("height",2*a.nodeHeight+2+"px").attr("fill","yellow").style("opacity","0.3").attr("x",e+"px").attr("y","-"+(a.nodeHeight+1)+"px")}if(b.children)for(e=0;e<b.children.length;e++)r=ra(b.children[e],
d);return!1}function ya(a,b,d){if(d||a.id==b)d=!0,a.branchset=a.branchset.reverse();if(a.children)for(var e=0;e<a.children.length;e++)ya(a.children[e],b,d)}function xa(a,d){if(a.id==d)b.branchset=[a];else if(a.children)for(var e=0;e<a.children.length;e++)xa(a.children[e],d)}function P(){L(!0);aa()}function wa(b,d){var e=!0,f=b.y+1,h=b.y+5.5*W(b,!0).length,g=b.x-a.nodeHeight,p=b.x+a.nodeHeight;if(!U)return U=b,!0;a.lineupNodes&&!b.children&&(f+=phyd3.phylogram.dx-b.y,h+=phyd3.phylogram.dx-b.y);var m=
U,n=m.y+1,t=m.y+5.5*W(m,!0).length,q=m.x-a.nodeHeight,u=m.x+a.nodeHeight;a.lineupNodes&&!m.children&&(n+=phyd3.phylogram.dx-m.y,t+=phyd3.phylogram.dx-m.y);if(n<=f&&f<=t&&q<=g&&g<=u||n<=h&&h<=t&&q<=g&&g<=u||n<=f&&f<=t&&q<=p&&p<=u||n<=h&&h<=t&&q<=p&&p<=u)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(q=phyd3.phylogram.lineAreas[d],m=q.start[0],n=q.end[0],t=q.start[1],q=q.end[1],t==q){if(g<=t&&q<=p&&!(m>h||n<f)){e=!1;break}}else if(m==n&&f<=m&&n<=h&&!(t>p||q<g)){e=!1;break}e&&(U=b);return e}
function aa(){var b=ca.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;n.attr("transform",function(a){return"translate("+parseInt(d)+","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(va(),a.dynamicHide&&I());qa();f()}a=a||{};a.scaleY=a.scaleY||1;a.scaleX=a.scaleX||1;a.translateX=a.translateX||0;a.translateY=a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||
100;a.domainWidth=a.domainWidth||100;a.domainWidthStep=a.domainWidthStep||100;a.graphWidth=a.graphWidth||20;a.graphWidthStep=a.graphWidthStep||10;a.domainLevel=a.domainLevel||1;a.domainLevelStep=a.domainLevelStep||10;a.outline=a.outline||.3;a.popupWidth=a.popupWidth||500;a.maxDecimalsSupportValues=a.maxDecimalsSupportValues||0;a.maxDecimalsLengthValues=a.maxDecimalsLengthValues||2;a.foregroundColor=a.foregroundColor||"#000";a.backgroundColor=a.backgroundColor||"#fff";a.branchLengthColor=a.branchLengthColor||
"red";a.supportValuesColor=a.supportValuesColor||"blue";a.showNodesType=a.showNodesType||"only leaf";a.treeWidth=a.treeWidth||"auto";a.showFullTaxonomy="showFullTaxonomy"in a?a.showFullTaxonomy:!1;a.showLabels="showLabels"in a?a.showLabels:!0;a.showDomains="showDomains"in a?a.showDomains:!0;a.dynamicHide="dynamicHide"in a?a.dynamicHide:!1;a.invertColors="invertColors"in a?a.invertColors:!1;a.lineupNodes="lineupNodes"in a?a.lineupNodes:!0;a.showSupportValues="showSupportValues"in a?a.showSupportValues:
!1;a.showLengthValues="showLengthValues"in a?a.showLengthValues:!1;a.showTaxonomy="showTaxonomy"in a?a.showTaxonomy:!0;a.showTaxonomyColors="showTaxonomyColors"in a?a.showTaxonomyColors:!0;a.showDomainNames="showDomainNames"in a?a.showDomainNames:!1;a.showDomainColors="showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend="showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames="showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in
a?a.showPhylogram:!1;b.groups=b.groups?b.groups:{};var n,Q,A,F,H,M,U,C=[],B=[],O=100,N=100,v=0,V=100,ja=0,Ba=jQuery.extend(!0,{},b),G=!1;if(b.graphs)for(var la=0;la<b.graphs.length;la++)if(0!=b.graphs[la].legend.show){G=!0;break}V=G?V:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?V:0);a.initialGraphWidth=a.graphWidth;var Y=jQuery(d).width(),K="auto"==a.treeWidth?Y-Aa():a.treeWidth,T=a.height-(2*a.margin+(a.showGraphs?V:0)),K=parseInt(K),T=parseInt(T);0>K&&(K=Y-2*N-(a.showGraphs?2*V:0));var ca=
d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,f=.5;d.altKey||d.ctrlKey||(e=d.layerX/Y,f=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=T*b*f;if(d.altKey||!d.ctrlKey)a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,
a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=K*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(P):requestAnimFrame(aa)}});d3.select("#dynamicHide").on("click",function(){a.dynamicHide=!a.dynamicHide;L(!0);I()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;ga()});jQuery("#foregroundColorButton").colorpicker().on("changeColor",function(){a.foregroundColor=jQuery("#foregroundColor").val();
ga()});jQuery("#backgroundColorButton").colorpicker().on("changeColor",function(){a.backgroundColor=jQuery("#backgroundColor").val();ga()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();P();R()});d3.select("#phylogram").on("click",function(){a.showPhylogram=!a.showPhylogram;L(!0);D();I()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;L(!0);oa();D();I()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=!a.showLengthValues;
a.showLengthValues?d3.select("#maxDecimalsLengthValues").attr("disabled",null):d3.select("#maxDecimalsLengthValues").attr("disabled","disabled");fa()});d3.select("#maxDecimalsLengthValues").on("change",function(){a.maxDecimalsLengthValues=jQuery(this).val();fa()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;a.showSupportValues?d3.select("#maxDecimalsSupportValues").attr("disabled",null):d3.select("#maxDecimalsSupportValues").attr("disabled","disabled");
ea()});d3.select("#maxDecimalsSupportValues").on("change",function(){a.maxDecimalsSupportValues=jQuery(this).val();ea()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=!a.showNodeNames;R();D()});d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;pa()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;R();D()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;R();D()});d3.select("#nodesType").on("change",
function(){a.showNodesType=jQuery(this).val();P();R();D()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;Z()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);L(!0);D();I();f()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=a.nodeHeightStep;L(!0);D();I();f()});d3.select("#resetZoom").on("click",function(){b=jQuery.extend(!0,{},Ba);
w();z()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=T*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(P)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=T*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(P)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=K*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(P)});d3.select("#zoomoutX").on("click",
function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=K*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(P)});d3.select("#domains").on("click",function(){a.showDomains=!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",null),d3.select("#domainWidthHigher").attr("disabled",null),d3.select("#domainLevelLower").attr("disabled",null),d3.select("#domainLevelHigher").attr("disabled",
null)):(d3.select("#domainNames").attr("disabled","disabled"),d3.select("#domainColors").attr("disabled","disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled","disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));ma();da()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;ha()});d3.select("#domainNames").on("click",function(){a.showDomainNames=
!a.showDomainNames;da()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);M=phyd3.phylogram.scaledomainWidths(H,a.domainWidth);J()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;M=phyd3.phylogram.scaledomainWidths(H,a.domainWidth);J()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;ba()});d3.select("#domainLevelHigher").on("click",
function(){a.domainLevel*=a.domainLevelStep;ba()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?V:0);S();aa()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled",
"disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));na()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);D()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=a.graphWidthStep;D()});d3.select("#linkSVG").on("click",function(){var a=sa();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",
function(){var a=sa(),b=document.createElement("canvas");d3.select("g#main").node().getBBox();canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})});d3.select("#searchQuery").on("change",function(){qa()});d3.select("#applyTaxonomyColors").on("click",function(){d3.selectAll("input.taxColor").each(function(a){b.taxcolors[a.taxonomy].color=jQuery(this).val()});jQuery("#taxonomyColorsModal").modal("hide");Z()});d3.select("#applyGroupLabel").on("click",function(){var a=jQuery("#groupID").val(),
d=jQuery("#groupDepth").val(),e=jQuery("#groupLabel").val(),n=jQuery("#groupLabelBackground").val(),l=jQuery("#groupLabelForeground").val();jQuery("#groupLabelModal").modal("hide");b.groups[a]={id:a,depth:d,label:e,foregroundColor:l,backgroundColor:n};g(b,a);z();f()});d3.select("#clearGroupLabel").on("click",function(){var a=jQuery("#groupID").val();jQuery("#groupLabelModal").modal("hide");delete b.groups[a];q(b,a);z()});G=function(){var a=[],d;for(d in b.taxcolors){var e=b.taxcolors[d];e.taxonomy=
d;a.push(e)}return a}();G.length?(G=d3.select("#taxonomyColorsList").selectAll("div.taxColor").data(G).enter().append("div").attr("class","form-group col-xs-4 taxColor"),G.append("label").attr("class","col-xs-4 control-label").text(function(a){return a.taxonomy}),G=G.append("div").attr("class","col-xs-8").append("div").attr("class","input-group colorpicker-component"),G.append("input").attr("class","form-control taxColor").attr("type","text").attr("value",function(a){return a.color.replace("0x","#")}),
G.append("span").attr("class","input-group-btn").append("span").attr("class","input-group-addon btn btn-fab btn-fab-mini").append("i"),jQuery(".colorpicker-component").colorpicker(),jQuery("#taxonomyColorsModal").on("hide.bs.modal",function(){jQuery(".colorpicker-component").colorpicker("hide")}),jQuery("#groupLabelModal").on("hide.bs.modal",function(){jQuery(".colorpicker-component").colorpicker("hide")})):d3.select("#taxonomyColorsList").append("div").attr("class","col-sm-12 text-center").text("No taxonomy information available");
z()}})();
...
{show:parseInt(d.getAttribute("show")),fields:[],gradient:{}},a=d.getElementsByTagName("field"),f=0;f<a.length;f++){var g=a[f],u=g.getElementsByTagName("name")[0],u=u?u.textContent:"",q=g.getElementsByTagName("color")[0],q=q?q.textContent:"",w=g.getElementsByTagName("background")[0],w=w?w.textContent:"",z=g.getElementsByTagName("shape")[0],z=z?z.textContent:"",g=(g=g.getElementsByTagName("url")[0])?g.textContent:"";b.fields.push({name:u,color:q,background:w,shape:z,url:g})}if(d=d.getElementsByTagName("gradient")[0])u=
(u=d.getElementsByTagName("name")[0])?u.textContent:"",d=(d=d.getElementsByTagName("classes")[0])?parseInt(d.textContent):0,b.gradient={name:u,classes:d};return b};phyd3.phyloxml.parseData=function(d){var b={tag:d.getAttribute("tag"),ref:d.getAttribute("ref")},a=d.getElementsByTagName("min")[0];b.min=a?a.textContent:void 0;a=d.getElementsByTagName("max")[0];b.max=a?a.textContent:void 0;d=d.getElementsByTagName("values");for(a=0;a<d.length;a++){var f=d[a].getAttribute("for"),g=d[a].getElementsByTagName("value");
b[f]=[];for(var u=0;u<g.length;u++)b[f].push(parseFloat(g[u].textContent))}return b};phyd3.phyloxml.parseGraph=function(d){for(var b={name:"",legend:{},data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var f=d.childNodes[a];switch(f.nodeName){case "name":b.name=f.textContent;break;case "legend":b.legend=phyd3.phyloxml.parseLegend(f);break;case "data":b.data=phyd3.phyloxml.parseData(f);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+f.nodeName+" "+f.textContent+
...
{branchset:[],properties:[],confidence:[]},a=d.getElementsByTagName("phylogeny"),a=a[0];b.rooted=a.getAttribute("rooted");b.rerootable=a.getAttribute("rerootable");b.branch_length_unit=a.getAttribute("branch_length_unit");b.type=a.getAttribute("type");if(a&&a.childNodes)for(var f=0;f<a.childNodes.length;f++){var g=a.childNodes[f];switch(g.nodeName){case "clade":b.branchset.push(phyd3.phyloxml.parseClade(g));break;case "confidence":b.confidence.push(phyd3.phyloxml.parseConfidence(g));break;case "date":b.date=
g.textContent;break;case "description":b.description=g.textContent;break;case "id":b.id=g.textContent;break;case "name":b.name=g.textContent;break;case "property":b.properties.push(phyd3.phyloxml.parseProperty(g));break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+g.nodeName+" "+g.textContent+" - skipping...")}}var a=d.getElementsByTagName("taxonomies"),a=a[0],u={};if(a&&a.childNodes)for(f=0;f<a.childNodes.length;f++){var q=a.childNodes[f];if("color"==q.nodeName){var g=
q.getElementsByTagName("code")[0].textContent,w=q.getElementsByTagName("value")[0].textContent;u[g]={color:w}}if("taxonomy"==q.nodeName){var g=q.getAttribute("code"),w=(w=q.getElementsByTagName("color")[0])?w.textContent:w,z=q.getElementsByTagName("name")[0],z=z?z.textContent:z,q=(q=q.getElementsByTagName("url")[0])?q.textContent:q;u[g]={color:w,name:z,url:q}}}b.taxcolors=u;a=d.getElementsByTagName("domains");a=a[0];u={};if(a&&a.childNodes)for(f=0;f<a.childNodes.length;f++)q=a.childNodes[f],"color"==
q.nodeName&&(g=q.getElementsByTagName("code")[0].textContent,w=q.getElementsByTagName("value")[0].textContent,u[g]={color:w}),"domain"==q.nodeName&&(g=q.getAttribute("name"),w=(w=q.getElementsByTagName("color")[0])?w.textContent:w,z=(z=q.getElementsByTagName("description")[0])?z.textContent:z,q=(q=q.getElementsByTagName("url")[0])?q.textContent:q,u[g]={color:w,description:z,url:q});b.domcolors=u;a=d.getElementsByTagName("graphs");a=a[0];g=[];if(a&&a.childNodes)for(f=0;f<a.childNodes.length;f++)w=
a.childNodes[f],"graph"==w.nodeName&&g.push(phyd3.phyloxml.parseGraph(w));b.graphs=g;a=d.getElementsByTagName("labels");a=a[0];d=[];if(a&&a.childNodes)for(f=0;f<a.childNodes.length;f++)g=a.childNodes[f],"label"==g.nodeName&&d.push(phyd3.phyloxml.parseLabel(g));b.labels=d;return b}})();
/* Blob.js
