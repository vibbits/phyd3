...
r.layerY;var q="popup"+parseInt(Date.now()*Math.random()*1E3);console.log(r);var f=d3.select(b).append("div").attr("class","popup").attr("id",q).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(f)+"px").style("width",parseInt(a.popupWidth)+"px").style("color",a.foregroundColor).style("background-color",a.backgroundColor),n=f.append("button").attr("class","btn btn-link").style("position","absolute").style("right","8px");n.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden",
...
b,f.legend.fields[1]={name:f.legend.fields[0].name,color:f.legend.fields[0].background?f.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(f.type){case "pie":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){var n=!1;p.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(n=!0)});for(var h=p.selectAll(".cid_"+cid).append("svg:g").attr("class","graph pie gid"+f.id),k=[],l=0;l<f.data[cid].length;l++)void 0!=f.data[cid][l]&&k.push({i:l,value:f.data[cid][l],
leaf:n});h.selectAll("path.pie.gid"+f.id).data(b(k)).enter().append("path").attr("class","pie hover-visible gid"+f.id).attr("stroke",e()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return f.legend.fields?(f.legend.fields[b]||(f.legend.fields[b]={},f.legend.fields[b].name="Series "+(b+1),f.legend.fields[b].color=phyd3.phylogram.randomColor()),f.legend.fields[b].color.replace(/0x/,"#")):""}).append("title").text(function(a,b){return f.legend.fields?(f.legend.fields[b]&&f.legend.fields[b].name?
...
f.id).data(k).enter().append("path").attr("class","binary hover-visible gid"+f.id).attr("style",function(a,b){b=(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":K[f.id]=[];for(l=0;l<f.legend.fields.length;l++)h=d3.max(d3.values(f.data),function(a){if(a)return a[l]}),K[f.id][l]=d3.scale.linear().domain([0,
h]);for(cid in f.data)if(f.data[cid]){h=p.select(".cid_"+cid).append("svg:g").attr("class","graph multibar gid"+f.id);k=[];for(l=0;l<f.data[cid].length;l++)void 0!=f.data[cid][l]&&k.push({i:l,value:f.data[cid][l]});h.selectAll("rect.multibar.gid"+f.id).data(k).enter().append("rect").attr("class","multibar hover-visible gid"+f.id).attr("fill",function(a,b){return(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a,
b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "heatmap":var h=d3.max(d3.values(f.data),function(a){if(a)return d3.max(a)}),k=d3.min(d3.values(f.data),function(a){if(a)return d3.min(a)}),m=d3.scale.quantize().domain([k,h]).range(colorbrewer[f.legend.gradient.name][f.legend.gradient.classes]);for(cid in f.data)if(f.data[cid]){h=p.select(".cid_"+cid).append("svg:g").attr("class","graph heatmap gid"+f.id);k=[];if(f.data[cid])for(l=0;l<f.data[cid].length;l++)void 0!=
f.data[cid][l]&&k.push({i:l,value:f.data[cid][l]});h.selectAll("rect.heatmap.gid"+f.id).data(k).enter().append("rect").attr("class","heatmap hover-visible gid"+f.id).attr("fill",function(a,b){return m(a.value)}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+f.type)}}ea();J()}else v=0,p.selectAll("g.graph").remove(),p.selectAll("text.legend").remove();
C()}function J(){var b=a.nodeHeight,g=H+I;u.selectAll("g.graph").attr("transform",function(b){return"translate("+(a.lineupNodes?phyd3.phylogram.dx-b.y+g:g)+",0)"});var f=p.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);p.selectAll("text.legend").remove();v=0;if(d.graphs){for(var h=0;h<d.graphs.length;h++){var n=d.graphs[h];switch(n.type){case "pie":f.selectAll("path.pie.gid"+n.id).attr("d",function(a){return d3.svg.arc().innerRadius(0).outerRadius(b)(a)}).attr("transform",
function(a){return" translate("+parseInt(a.data.leaf?b+v:0)+",0)"});a.showGraphLegend&&p.append("text").attr("class","legend").text(0!=n.legend.show?n.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+v+2*b)+",-10) rotate(-90)");v+=2*b+5;break;case "binary":f.selectAll("path.binary.gid"+n.id).attr("d",function(a){var d=d3.svg.symbol().size(4*(b-2)*(b-2));d.type(n.legend.fields[a.i].shape);return d(a)}).attr("transform",function(a){return" translate("+(a.leaf?v+10+a.i*(2*b+5):0)+
" ,0)"});if(a.showGraphLegend)for(var k=0;k<n.legend.fields.length;k++)p.append("text").attr("class","legend").text(0!=n.legend.show?n.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+v+k*(2*b+5)+2*b)+", -10) rotate(-90)");v+=(n.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":for(k=0;k<n.legend.fields.length;k++)K[n.id][k]=K[n.id][k].range([0,a.graphWidth]);f.selectAll("rect.multibar.gid"+n.id).attr("height",parseInt(2*b)).attr("width",function(a,b){return parseInt(K[n.id][a.i]?
K[n.id][a.i](a.value):0)}).attr("transform",function(d,e){return" translate("+parseInt(v+d.i*(a.graphWidth+5))+",-"+parseInt(b)+")"});if(a.showGraphLegend)for(k=0;k<n.legend.fields.length;k++)p.append("text").attr("class","legend").text(0!=n.legend.show?n.legend.fields[k].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+v+k*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");v+=n.legend.fields.length*(a.graphWidth+5);break;case "heatmap":f.selectAll("rect.heatmap.gid"+n.id).attr("width",
2*b).attr("height",2*b).attr("transform",function(a,d){return" translate("+(v+2*a.i*b)+",-"+b+")"});if(a.showGraphLegend)for(k=0;k<n.legend.fields.length;k++)p.append("text").attr("class","legend").text(0!=n.legend.show?n.legend.fields[k].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+v+(k+1)*b*2)+",-10) rotate(-90)");v+=2*n.legend.fields.length*b+5}}p.selectAll("text.legend").attr("fill",e()).attr("font-size",2*a.nodeHeight)}}function ma(){var b=a.nodeHeight;v=0;if(d.graphs)for(var e=
0;e<d.graphs.length;e++){var f=d.graphs[e];switch(f.type){case "pie":v+=2*b+5;break;case "binary":v+=(f.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":v+=f.legend.fields.length*(a.graphWidth+5);break;case "heatmap":v+=2*f.legend.fields.length*b+5}}return 2*a.margin+(a.showNodeNames?H:0)+(a.showGraphs?v:0)+(a.showDomains?a.domainWidth:0)}function ea(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,f=a.nodeHeight,g=d.x,l=d.y,h=0;h<b.length;h++){var r=b[h].x,q=b[h].y;
if((r-g)*(r-g)+(q-l)*(q-l)<=4*f*f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};u.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});p.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);p.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function D(b){phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;var g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([L*
a.scaleY,E*a.scaleX]);A=g(d);a.showPhylogram||phyd3.phylogram.scaleBranchLengths(A,E*a.scaleX);var f=p.selectAll("path.link");b||(f=f.data(g.links(A)),f.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",e()));f.attr("d",phyd3.phylogram.rightAngleDiagonal);M=void 0;c=0;f=A.filter(function(a){return!a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?ia(f[g],!a.lineupNodes):!0;M=void 0;f=A.filter(function(a){return a.children});for(g=0;g<f.length;g++)0<P(f[g]).trim().length?
f[g].show=a.dynamicHide?ia(f[g],!0):!0:f[g].show=!1;b||(R=R.data(A),R.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",void 0===a.popupAction?ka:a.popupAction).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+
1)+"px"));R.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function N(){D(!0);S()}function ia(b,d){var e=!0,g=b.y+1,h=b.y+5.5*P(b).length,k=b.x-a.nodeHeight,l=b.x+a.nodeHeight;if(!M)return M=b,!0;a.lineupNodes&&!b.children&&(g+=phyd3.phylogram.dx-b.y,h+=phyd3.phylogram.dx-b.y);var q=M,m=q.y+1,r=q.y+5.5*P(q).length,p=q.x-a.nodeHeight,t=q.x+a.nodeHeight;a.lineupNodes&&!q.children&&(m+=phyd3.phylogram.dx-q.y,r+=phyd3.phylogram.dx-q.y);
if(m<=g&&g<=r&&p<=k&&k<=t||m<=h&&h<=r&&p<=k&&k<=t||m<=g&&g<=r&&p<=l&&l<=t||m<=h&&h<=r&&p<=l&&l<=t)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(p=phyd3.phylogram.lineAreas[d],q=p.start[0],m=p.end[0],r=p.start[1],p=p.end[1],r==p){if(k<=r&&p<=l&&!(q>h||m<g)){e=!1;break}}else if(q==m&&g<=q&&m<=h&&!(r>l||p<k)){e=!1;break}e&&(M=b);return e}function S(){var b=Y.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;p.attr("transform",function(a){return"translate("+parseInt(d)+
...
"showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend="showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames="showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in a?a.showPhylogram:!1;var A,F,M,K=[],I=100,H=100,v=0,O=100,ja=!1;if(d.graphs)for(var Z=0;Z<d.graphs.length;Z++)if(0!=d.graphs[Z].legend.show){ja=!0;break}O=ja?O:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?O:0);var T=$(b).width(),E="auto"==a.treeWidth?T-
ma():a.treeWidth,L=a.height-(2*a.margin+(a.showGraphs?O:0)),E=parseInt(E),L=parseInt(L);0>E&&(E=T-2*H-(a.showGraphs?2*O:0));var Y=d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,g=.5;d.altKey||d.ctrlKey||(e=d.layerX/T,g=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=L*b*g;if(d.altKey||!d.ctrlKey)a.graphWidth+=
0==b?0:0>b?-10:10,10>a.graphWidth&&(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=E*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(N):requestAnimFrame(S);d.preventDefault()}});d3.select(b).select("svg").remove();var p=d3.select(b).insert("svg").attr("width",T+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version",
"1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(Y);p.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height","100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);p.append("svg:text").attr("dy","20px").attr("stroke",e()).attr("stroke-width","1px").attr("font-size","15px").text(d.name?d.name:"");p.append("svg:text").attr("dy","40px").attr("stroke",e()).attr("stroke-width","0.5px").attr("font-size","10px").text(d.description?
d.description:"");var p=p.append("svg:g").attr("id","main").attr("transform","translate("+a.marginX+", "+a.marginY+")"),R=p.selectAll("g.node");D();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,D());var u=p.selectAll("g.leaf.node"),B=u.selectAll("g.domain");aa();ba();m();h();ha();ca();ga();R.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");W();Q();G();S();z();d3.select("#dynamicHide").on("click",
function(){a.dynamicHide=!a.dynamicHide;D(!0);G()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var b=e();p.selectAll("path.link").attr("stroke",b);p.selectAll("text.legend").attr("fill",b);u.selectAll("path.support").attr("stroke",b);u.selectAll("path.domain").attr("stroke",b);u.selectAll("text.nodelabel").attr("stroke",b).attr("fill",b);W();w()});d3.select("#phylogram").on("click",
function(){a.showPhylogram=!a.showPhylogram;D(!0);z();G()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;D(!0);ca();z();G()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=!a.showLengthValues;ba()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;aa();G()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=!a.showNodeNames;Q();z()});d3.select("#nodeLabels").on("click",function(){a.showLabels=
!a.showLabels;ga()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;Q();z()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;Q();z()});d3.select("#nodesType").on("change",function(){a.showNodesType=$(this).val();N();Q()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;W()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=
a.nodeHeightStep);D(!0);z();G()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=a.nodeHeightStep;D(!0);z();G()});d3.select("#resetZoom").on("click",function(){a.domainWidth=a.domainWidthStep;a.scaleX=1;a.scaleY=1;a.translateX=0;a.translateY=0;D(!0);Y.translate([0,0]);S();z()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=L*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(N)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;
a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=L*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(N)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=E*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(N)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=E*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(N)});d3.select("#domains").on("click",function(){a.showDomains=
!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",null),d3.select("#domainWidthHigher").attr("disabled",null),d3.select("#domainLevelLower").attr("disabled",null),d3.select("#domainLevelHigher").attr("disabled",null)):(d3.select("#domainNames").attr("disabled","disabled"),d3.select("#domainColors").attr("disabled","disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),
d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled","disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));m();h()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;w()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;h()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=
a.domainWidthStep);F=phyd3.phylogram.scaledomainWidths(A,a.domainWidth);C()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;F=phyd3.phylogram.scaledomainWidths(A,a.domainWidth);C()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;t()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=a.domainLevelStep;t()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=
a.margin+(a.showGraphs?O:0);J();S()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));ha()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=
a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);z()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=a.graphWidthStep;z()});d3.select("#linkSVG").on("click",function(){var a=g();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",function(){var a=g(),b=document.createElement("canvas");canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})})}})();
