...
$jscomp.polyfill=function(d,b,a,e){if(b){a=$jscomp.global;d=d.split(".");for(e=0;e<d.length-1;e++){var g=d[e];g in a||(a[g]={});a=a[g]}d=d[d.length-1];e=a[d];b=b(e);b!=e&&null!=b&&$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:b})}};$jscomp.polyfill("Array.prototype.values",function(d){return d?d:function(){return $jscomp.iteratorFromArray(this,function(b,a){return a})}},"es6","es3");$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6-impl","es3");
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(d){var b=[],a={};d=d.split(/\s*(;|\(|\)|,|:)\s*/);for(var e=0,g=0;g<d.length;g++){var u=d[g];switch(u){case "(":u={};a.id=e;e++;a.branchset=[u];b.push(a);a=u;break;case ",":u={};b[b.length-1].branchset.push(u);a=u;break;case ")":a=b.pop();break;case ":":break;default:var q=d[g-1];")"==q||"("==q||","==q?a.name=u:":"==q&&(a.branchLength=parseFloat(u));a.id=e;e++}}return a}})();
...
end:b[2]});!d.children&&b[2][0]>phyd3.phylogram.dx&&(phyd3.phylogram.dx=b[2][0]);return"M"+b[0]+" "+b[1]+" "+b[2]};phyd3.phylogram.scaleBranchLengths=function(d,b){function a(b,d){d(b);if(b.children)for(var e=b.children.length-1;0<=e;e--)a(b.children[e],d)}a(d[0],function(a){0>a.branchLength&&(a.branchLength*=-1);a.rootDist=(a.parent?a.parent.rootDist:0)+(a.branchLength||0)});var e=d.map(function(a){return a.rootDist}),g=d3.scale.linear().domain([0,d3.max(e)]).range([0,b]);a(d[0],function(a){a.y=
parseInt(g(a.rootDist))});return g};phyd3.phylogram.randomColor=function(){function d(a,b,d){0>d&&(d+=1);1<d&&--d;return d<1/6?a+6*(b-a)*d:.5>d?b:d<2/3?a+(b-a)*(2/3-d)*6:a}var b=Math.random();return function(a,b,g){if(0==b)g=b=a=g;else{var e=.5>g?g*(1+b):g+b-g*b,q=2*g-e;g=d(q,e,a+1/3);b=d(q,e,a);a=d(q,e,a-1/3)}return"#"+Math.round(255*g).toString(16)+Math.round(255*b).toString(16)+Math.round(255*a).toString(16)}((b+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(d,b){d=d.map(function(a){return a.sequences&&
a.sequences[0]&&a.sequences[0].domainArchitecture&&a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(d)]).range([0,b])};phyd3.phylogram.build=function(d,b,a){function e(){console.log("repaint");d3.select(d).select("svg").remove();n=d3.select(d).insert("svg").attr("width",U+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version","1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(Z);
n.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height","100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);n.append("svg:text").attr("dy","20px").attr("stroke",u()).attr("stroke-width","1px").attr("font-size","15px").text(b.name?b.name:"");n.append("svg:text").attr("dy","40px").attr("stroke",u()).attr("stroke-width","0.5px").attr("font-size","10px").text(b.description?b.description:"");n.append("defs").append("marker").attr("id","markerBoxplot").attr("markerWidth",
"1").attr("markerHeight","10").attr("refX","1").attr("refY","5").append("line").attr("x1","0").attr("x2","0").attr("y1","0").attr("y2","10").attr("stroke",u()).attr("stroke-width","2px");n=n.append("svg:g").attr("id","main").attr("transform","translate("+a.marginX+", "+a.marginY+")");N=n.selectAll("g.node");G();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,G());x=n.selectAll("g.leaf.node");D=x.selectAll("g.domain");ha();ia();z();
aa();ja();ka();la();N.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");ba();O();E();V();B()}function g(){n.selectAll("rect.searchResults").remove();var a=jQuery("#searchQuery").val(),d=new RegExp(a,"i");a.length&&ma(b,d)}function u(){return a.invertColors?a.backgroundColor:a.foregroundColor}function q(){d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var k=u();n.selectAll("path.link").attr("stroke",k);
n.selectAll("text.legend").attr("fill",k);n.selectAll("text.nodelabel").attr("stroke",k).attr("fill",k);x.selectAll("path.support").attr("stroke",k);x.selectAll("path.domain").attr("stroke",k);ba();ca()}function w(){var k=d.replace("#",""),k=document.getElementById(k).querySelector("svg"),b=k.getElementById("main"),f=b.getBBox(),b=b.getAttributeNode("transform"),e=k.getAttributeNode("width"),l=k.getAttributeNode("height"),h=b.value,p=e.value,m=l.value;b.value="translate("+a.marginX+", "+a.marginY+
")";e.value=(Math.max(+e.value.replace("px",""),f.width)+a.marginX).toString();l.value=(Math.max(+l.value.replace("px",""),f.height)+a.marginY).toString();if("undefined"!=typeof window.XMLSerializer)var g=(new XMLSerializer).serializeToString(k);else"undefined"!=typeof k.xml&&(g=k.xml);b.value=h;e.value=p;l.value=m;return g}function z(){a.showDomains?(J=phyd3.phylogram.scaledomainWidths(F,a.domainWidth),x.append("svg:path").attr("class","domain").attr("stroke",u()).attr("visibility",function(a,b){return a.show?
"visibile":"hidden"}),D=D.data(function(a,b,f){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(f=0;f<a.length;f++)a[f].i=b;a.sort(function(a,f){return Math.abs(f.to-f.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),D.append("svg:rect").attr("class","domain hover-visible").attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a){return a.name}),X(),
H(),ca()):(D.remove(),x.selectAll("path.domain").remove(),D=x.selectAll("g.domain"))}function aa(){a.showDomainNames?(D.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",u()).attr("font-size","10px").text(function(a){return a.name}),H()):D.selectAll("text.domain").remove()}function X(){var b=x.data();x.selectAll("g.domain").attr("visibility",function(k,f,d){return b[d].show&&k.confidence<=a.domainLevel?"visible":"hidden"});x.selectAll("path.domain").attr("visibility",function(a){return a.show?
"visible":"hidden"});d3.select("#domainLevel").attr("value",a.domainLevel.toPrecision(1))}function ca(){D.selectAll("rect.domain").attr("fill",function(k){return a.showDomainColors&&b.domcolors[k.name]?b.domcolors[k.name].color.replace(/0x/,"#"):u()})}function H(){var b=x.data(),d=K+(a.showLabels?L:0)+(a.showGraphs?v:0);J=phyd3.phylogram.scaledomainWidths(F,a.domainWidth);x.selectAll("path.domain").attr("d",function(a,k,e){k=phyd3.phylogram.dx-b[e].y;a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?
a.sequences[0].domainArchitecture.sequenceLength:0;return"M"+parseInt(d+k)+",0L"+parseInt(d+k+J(a))+",0"});D.selectAll("rect.domain").attr("width",function(a){return parseInt(J(a.to-a.from))}).attr("transform",function(f,k,e){return"translate("+parseInt(d+(phyd3.phylogram.dx-b[f.i].y)+J(f.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);D.selectAll("text.domain").attr("transform",function(f){return"translate("+parseInt(d+(phyd3.phylogram.dx-b[f.i].y)+J(f.from))+","+parseInt(-1*
a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",a.domainWidth)}function ha(){a.showSupportValues?(n.selectAll("g.inner.node").append("svg:text").attr("class","supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(a){var b="";if(a.confidences)for(var f=0;f<a.confidences.length;f++)b+=parseFloat(a.confidences[f].value)+" ";return b}),B(),E()):n.selectAll("text.supportValue").remove()}function ia(){a.showLengthValues?(n.selectAll("g.node").append("svg:text").attr("class",
"branchLength").attr("dx",-2).attr("text-anchor","end").attr("fill",a.branchLengthColor).text(function(a){return a.branchLength?parseFloat(a.branchLength).toFixed(5):""}),B(),E()):n.selectAll("text.branchLength").remove()}function da(a,b,f){var d=a.attr("id")+"_"+a.selectAll("div.panel-default").size(),k=a.append("div").attr("class","panel panel-default");k.append("div").attr("class","panel-heading").attr("role","tab").attr("id","heading"+d).append("h4").attr("class","panel-title").append("a").attr("class",
"collapsed").attr("aria-expanded",f?"true":"false").attr("role","button").attr("data-toggle","collapse").attr("data-parent","#"+a.attr("id")).attr("href","#collapse"+d).attr("aria-controls","collapse"+d).html(b);return k.append("div").attr("id","collapse"+d).attr("class","panel-collapse collapse "+(f?"in":"")).attr("role","tabpanel").attr("aria-labelledby","heading"+d).append("div").attr("class","panel-body table-responsive")}function ua(k){var e=d3.event,f=e.layerX;y=e.layerY;var W="popup"+parseInt(Date.now()*
Math.random()*1E3),f=d3.select(d).append("div").attr("class","popup").attr("id",W).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(f)+"px").style("width",parseInt(a.popupWidth)+"px").style("color","black").style("background-color","white"),l=f.append("button").attr("class","btn btn-link").style("position","absolute").style("right","8px");l.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden","true");l.on("click",function(){d3.select("#"+W).remove();
n.selectAll("g.node.cid_"+k.id).selectAll("rect.pointer").style("opacity","0")});f=f.append("div").attr("class","panel-group").attr("id","accordion_"+parseInt(Date.now()*Math.random()*1E3)).attr("role","tablist").attr("aria-multiselectable","true");l="text"==e.target.nodeName||e.target.classList.contains("pointer")?!0:!1;l=da(f,"Node",l).append("table").attr("class","table table-condensed table-bordered").append("tbody");if(k.name){var h=l.append("tr");h.append("td").text("Name");h.append("td").text(k.name)}if(k.taxonomies)for(var p=
0;p<k.taxonomies.length;p++){var m=k.taxonomies[p],h=l.append("tr");h.append("td").text("Taxononomy");h=h.append("td");b.taxcolors[m.code]&&b.taxcolors[m.code].url&&(h=h.append("a").attr("href",b.taxcolors[m.code].url).attr("target","_blank"));var g="",g=g+(b.taxcolors[m.code]&&b.taxcolors[m.code].name?b.taxcolors[m.code].name+" ":""),g=g+" ",g=g+(m.scientificName?"\x3ci\x3e"+m.scientificName+"\x3c/i\x3e":""),g=g+" ",g=g+(m.commonName?m.commonName:""),g=g+" ",g=g+(m.code?"("+m.code+")":"");h.html(g)}if(k.confidences)for(p=
0;p<k.confidences.length;p++)h=l.append("tr"),h.append("td").text("Confidence"),h.append("td").html(k.confidences[p].value);h=l.append("tr");h.append("td").text("Depth");h.append("td").text(k.depth);h=l.append("tr");h.append("td").text("Branch length");h.append("td").text(k.branchLength?k.branchLength:0);h=l.append("tr");h.append("td").text("Distance from root");h.append("td").text(k.rootDist);for(p=0;p<k.properties.length;p++)h=k.properties[p],t=h.ref,m=h.value,m=m.trim(),/^http:\/\//.test(m)&&(m=
"\x3ca href\x3d'"+m+"' target\x3d'_blank'\x3e"+m+"\x3c/a\x3e\x3cbr /\x3e"),h=l.append("tr"),h.append("td").text(t),h.append("td").html(m);for(var t in k.events)m=k.events[t],h=l.append("tr"),h.append("td").text(t),h.append("td").html(m);if(k.sequences)for(p=0;p<k.sequences.length;p++){t=k.sequences[p];m="";m+=t.symbol?t.symbol+" ":"";m+=t.name?t.name+" ":"";m+=t.location?t.location+" ":"";m+=t.geneName?t.geneName:"";m.length&&(h=l.append("tr"),h.append("td").text("Sequence"),h.append("td").html(m));
t.accession&&(m="",m+=t.accession.value?t.accession.value+" ":"",m+=t.accession.source?"["+t.accession.source+"] ":"",m+=t.accession.comment?"("+t.accession.comment+")":"",m.length&&(h=l.append("tr"),h.append("td").text("Accession"),h.append("td").html(m)));t.molSeq&&t.molSeq.value&&(h=l.append("tr"),h.append("td").text("Molecular Sequence"),h.append("td").html(t.molSeq.value));if(t.uris){m="";for(h=0;h<t.uris.length;h++)m=t.uris[h],m="\x3ca href\x3d'"+m.value+"'\x3e"+(m.desc?m.desc:m.value)+"\x3c/a\x3e";
m.length&&(h=l.append("tr"),h.append("td").text("See also"),h.append("td").html(m))}if(k.sequences[p].domainArchitecture&&k.sequences[p].domainArchitecture.domains){l=e.target.parentNode.classList.contains("domain")?!0:!1;l=da(f,"Domains",l).append("table").attr("id","dt"+W).attr("class","table table-condensed table-bordered");t=l.append("thead").append("tr");t.append("th").text("#");t.append("th").text("Name");t.append("th").text("Description");t.append("th").text("From");t.append("th").text("To");
t.append("th").text("P value");g=l.append("tbody");for(m=0;m<k.sequences[p].domainArchitecture.domains.length;m++){var C=k.sequences[p].domainArchitecture.domains[m],h=g.append("tr");h.append("td").style("background",b.domcolors[C.name]&&b.domcolors[C.name].color?b.domcolors[C.name].color.replace("0x","#"):"").text(" ");t=h.append("td");b.domcolors[C.name]&&b.domcolors[C.name].url&&(t=t.append("a").attr("href",b.domcolors[C.name].url).attr("target","_blank"));t.text(C.name);h.append("td").text(b.domcolors[C.name]?
b.domcolors[C.name].description:"");h.append("td").text(C.from);h.append("td").text(C.to);h.append("td").text(C.confidence)}jQuery("#dt"+W).dataTable({searching:!1,paging:!1,language:{info:""},order:[[3,"asc"]],columns:[{orderable:!1},null,null,null,null,null]})}}if(b.graphs)for(p=0;p<b.graphs.length;p++)if(g=b.graphs[p],g.data&&g.data[k.id]&&g.data[k.id].length)for(l=e.target.parentNode.classList.contains(g.type)?!0:!1,l=da(f,g.name,l).append("table").attr("class","table table-condensed table-bordered").append("tbody"),
m=0;m<g.legend.fields.length;m++)h=l.append("tr"),t=h.append("td"),g.legend.fields[m].url&&(t=t.append("a").attr("href",g.legend.fields[m].url).attr("target","_blank")),t.text(g.legend.fields[m].name),h.append("td").text(g.data[k.id][m]);n.selectAll("g.node.cid_"+k.id).selectAll("rect.pointer").style("opacity","1");e.stopPropagation()}function ka(){a.lineupNodes?n.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",u()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):
n.selectAll("path.support").remove()}function Y(d,e){if(!e&&(d.children&&"only leaf"==a.showNodesType||!d.children&&"only inner"==a.showNodesType))return"";e="";if(a.showTaxonomy&&d.taxonomies)for(var f=0;f<d.taxonomies.length;f++){var k=d.taxonomies[f];a.showFullTaxonomy&&(e+=b.taxcolors[k.code]&&b.taxcolors[k.code].name?b.taxcolors[k.code].name:"",e+=" ",e+=k.scientificName?k.scientificName:"",e+=" ",e+=k.commonName?k.commonName:"",e+=" ");e+=k.code?k.code:"";e+=" "}e+=(a.showNodeNames&&d.name?
d.name:"")+" ";if(a.showSequences&&d.sequences)for(f=0;f<d.sequences.length;f++)if(k=d.sequences[f],e+=k.symbol?k.symbol:"",e+=" ",e+=k.accession?k.accession.value:"",e+=" ",e+=k.name?k.name:"",e+=" ",e+=k.geneName?k.geneName:"",e+=" ",k.annotations)for(var l=0;l<k.annotations.length;l++)e+=k.annotations[l].desc?k.annotations[l].desc:"",e+=" ";return e}function O(){var b=0;ea=0;x.selectAll("text.name").text(function(a){var f=Y(a);f.length>b&&(b=f.length,ea=a.id);return f});n.selectAll("g.node.inner").selectAll("text.name").text(Y);
a.showGraphs&&P();a.showDomains&&H()}function E(){n.selectAll("text.branchLength").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("text.supportValues").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&x.selectAll("path.support").attr("visibility",function(a){return a.show?"visible":"hidden"});a.showLabels&&na();a.showGraphs&&oa();a.showDomains&&X()}
function ba(){n.selectAll("text.name").attr("stroke",u()).attr("stroke-width",a.outline+"px").attr("fill",function(d){var k=null;if(a.showTaxonomyColors&&b.taxcolors&&d.taxonomies)for(var f=0;f<d.taxonomies.length;f++){var e=d.taxonomies[f];b.taxcolors[e.code]&&b.taxcolors[e.code].color&&(k=b.taxcolors[e.code].color.replace(/0x/,"#"))}return k?k:u()})}function pa(){x.selectAll("text.name").attr("dx",function(b){return parseInt(a.lineupNodes?phyd3.phylogram.dx-b.y+5:5)});x.selectAll("path.support").attr("d",
function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-a.y)+",0"});a.showLabels&&fa();a.showGraphs&&P();a.showDomains&&H()}function B(){var b=0;n.selectAll("text.name").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.branchLength").attr("dy",-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("g.leaf.cid_"+ea).selectAll("text.name").each(function(){var a=
this.getBBox();a.width>b&&(b=a.width)});K=b+=10;d3.select("#nodeHeight").attr("value",2*a.nodeHeight+"px");pa();a.showLabels&&fa();a.showGraphs&&P();a.showDomains&&H()}function la(){if(a.showLabels&&b.labels){for(var d=0;d<b.labels.length;d++){var e=b.labels[d];e.id||(e.id=parseInt(Date.now()*Math.random()*1E3));e.data.tag&&n.selectAll("g.node").each(function(a){var b=a[e.data.tag],d=e.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==e.data.tag)for(pid=0;pid<a.properties.length;pid++){var f=
a.properties[pid];if(f.ref==d){b=f.value;break}}b&&(e.data[a.id]=b)});switch(e.type){case "text":for(cid in e.data)e.data[cid]&&n.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+e.id).attr("dy",3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",u()).attr("fill",u()).attr("font-size",1.5*a.nodeHeight+"px").text(e.data[cid]).append("title").text(e.name+": "+e.data[cid]);break;case "color":for(cid in e.data)if(e.data[cid]){var f=a.nodeHeight,g=e.data[cid].replace(/0x/,
"#");n.selectAll(".cid_"+cid).append("rect").attr("height",2*f).attr("width",2*f).attr("class","nodelabel color lid"+e.id).attr("style","fill: "+g+"; stroke: "+g).append("title").text(e.name)}}n.append("text").attr("class","labellegend lid"+e.id).text(0!=e.showLegend?e.name:"")}na();fa()}else n.selectAll(".nodelabel").remove(),n.selectAll(".labellegend").remove(),L=0;P();H()}function fa(){var d=a.nodeHeight;L=0;if(b.labels){for(var e=0;e<b.labels.length;e++){var f=b.labels[e],g=0;n.selectAll(".nodelabel.lid"+
f.id).attr("transform",function(a){var b=0,e=0;"color"==f.type&&(b=e=-d);var k=0;"text"==this.nodeName&&this.firstChild?k=this.firstChild.length*d/1.5:"rect"==this.nodeName&&(k=2*d);k>g&&(g=k);a.branchset.length?(b+=a.y,b-=d):b+=phyd3.phylogram.dx+K;return"translate("+parseInt(b+d+L-a.y)+","+e+")"});n.selectAll("text.labellegend.lid"+f.id).attr("transform","translate("+parseInt(phyd3.phylogram.dx+L+K+2*d)+",-10) rotate(-90)");L+=g+2*d}e=x.selectAll(".nodelabel");e.selectAll("text").attr("dy",a.nodeHeight/
2).attr("font-size",1.5*a.nodeHeight+"px");e.selectAll("rect").attr("width",2*a.nodeHeight).attr("height",2*a.nodeHeight)}}function na(){n.selectAll(".nodelabel").attr("visibility",function(b){return b.branchset.length&&"only leaf"==a.showNodesType||!b.branchset.length&&"only inner"==a.showNodesType?"hidden":b.show?"visible":"hidden"})}function ja(){if(a.showGraphs&&b.graphs&&b.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);for(var d=d3.layout.pie().value(function(a){return a.value}).sort(null),
e=v=0;e<b.graphs.length;e++){var f=b.graphs[e];f.id||(f.id=parseInt(Date.now()*Math.random()*1E3));if(f.data.tag)var g=n.selectAll("g.node").each(function(a){var b=a[f.data.tag],d=f.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==f.data.tag)for(var e=0;e<a.properties.length;e++){var k=a.properties[e];if(k.ref==d){b=k.value;break}}b&&(f.data[a.id]=[],f.data[a.id][0]=b,"pie"==f.type&&f.data.max&&(f.data[a.id][1]=f.data.max-b,f.legend.fields[1]={name:f.legend.fields[0].name,color:f.legend.fields[0].background?
f.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(f.type){case "pie":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){var l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});for(var g=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph pie gid"+f.id),h=[],p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p],leaf:l});g=g.selectAll("path.pie.gid"+f.id).data(d(h)).enter().append("path").attr("class",
"pie hover-visible gid"+f.id).attr("stroke",u()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return f.legend.fields?(f.legend.fields[b]||(f.legend.fields[b]={},f.legend.fields[b].name="Series "+(b+1),f.legend.fields[b].color=phyd3.phylogram.randomColor()),f.legend.fields[b].color.replace(/0x/,"#")):""}).append("title").text(function(a,b){return f.legend.fields?(f.legend.fields[b]&&f.legend.fields[b].name?f.legend.fields[b].name+": ":"")+(f.legend.fields[b].invert?f.data.max-a.data.value:
a.data.value):""})}break;case "binary":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){h=[];l=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(l=!0)});g=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+f.id);for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p],shape:f.legend.fields[p]?f.legend.fields[p].shape:"",leaf:l});g=g.selectAll("path.binary.gid"+f.id).data(h).enter().append("path").attr("class","binary hover-visible gid"+
f.id).attr("style",function(a,b){b=(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":Q[f.id]=[];for(p=0;p<f.legend.fields.length;p++)g=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),Q[f.id][p]=d3.scale.linear().domain([0,g]);for(cid in f.data)if(f.data[cid]){g=n.select(".cid_"+
cid).append("svg:g").attr("class","graph multibar gid"+f.id);h=[];for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p]});g=g.selectAll("rect.multibar.gid"+f.id).data(h).enter().append("rect").attr("class","multibar hover-visible gid"+f.id).attr("fill",function(a,b){return(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a,b){return(f.legend.fields[b]?
f.legend.fields[b].name+": ":"")+a.value})}break;case "boxplot":A[f.id]=null;g=0;h=Number.MAX_SAFE_INTEGER;for(p=0;5>p;p++){var m=d3.max(d3.values(f.data),function(a){if(a)return a[p]}),q=d3.max(d3.values(f.data),function(a){if(a)return a[p]});m>g&&(g=m);q<h&&(h=q)}A[f.id]=d3.scale.linear().domain([h,g]);for(cid in f.data)f.data[cid]&&(g=n.select(".cid_"+cid).append("svg:g").attr("class","graph boxplot gid"+f.id),h=[],h.push({min:f.data[cid][0],q1:f.data[cid][1],median:f.data[cid][2],q3:f.data[cid][3],
max:f.data[cid][4]}),g=g.selectAll("rect.boxplot.gid"+f.id).data(h).enter(),g.append("line").attr("class","boxplot baseline hover-visible gid"+f.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",u()),g.append("rect").attr("class","boxplot q1 hover-visible gid"+f.id).attr("fill",(f.legend.fields[0]?f.legend.fields[0].color:"").replace(/0x/,"#")).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline).append("title").text(function(a){return"Min: "+
a.min+", Q1: "+a.q1+", Median: "+a.median}),g.append("rect").attr("class","boxplot q3 hover-visible gid"+f.id).attr("fill",(f.legend.fields[1]?f.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",u()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+a.median+", Q3: "+a.q3+", Max: "+a.max}),g.append("line").attr("class","boxplot median hover-visible gid"+f.id).attr("stroke",u()).attr("stroke-width","2px"));break;case "heatmap":var m=d3.max(d3.values(f.data),
function(a){if(a)return d3.max(a)}),q=d3.min(d3.values(f.data),function(a){if(a)return d3.min(a)}),t=d3.scale.quantize().domain([q,m]).range(colorbrewer[f.legend.gradient.name][f.legend.gradient.classes]);for(cid in f.data)if(f.data[cid]){g=n.select(".cid_"+cid).append("svg:g").attr("class","graph heatmap gid"+f.id);h=[];if(f.data[cid])for(p=0;p<f.data[cid].length;p++)void 0!=f.data[cid][p]&&h.push({i:p,value:f.data[cid][p]});g=g.selectAll("rect.heatmap.gid"+f.id).data(h).enter().append("rect").attr("class",
"heatmap hover-visible gid"+f.id).attr("fill",function(a,b){return t(a.value)}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+f.type)}}oa();P()}else v=0,n.selectAll("g.graph").remove(),n.selectAll("text.legend").remove();H()}function P(){var d=a.nodeHeight,e=K+L;x.selectAll("g.graph").attr("transform",function(a){return"translate("+
(phyd3.phylogram.dx-a.y+e)+",0)"});var f=n.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);n.selectAll("text.legend").remove();v=0;if(b.graphs){for(var g=0;g<b.graphs.length;g++){var l=b.graphs[g];switch(l.type){case "pie":f.selectAll("path.pie.gid"+l.id).attr("d",function(a){if(0<a.value)return d3.svg.arc().innerRadius(0).outerRadius(d)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?d+v:0)+",0)"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class",
"legend").text(0!=l.legend.show?l.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+e+v+2*d)+",-10) rotate(-90)");v+=2*d+5;break;case "binary":f.selectAll("path.binary.gid"+l.id).attr("d",function(a){var b=d3.svg.symbol().size(4*(d-2)*(d-2));b.type(l.legend.fields[a.i].shape);return b(a)}).attr("transform",function(a){return" translate("+(a.leaf?v+10+a.i*(2*d+5):0)+" ,0)"});if(a.showGraphs&&a.showGraphLegend)for(var h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=
l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+e+v+h*(2*d+5)+2*d)+", -10) rotate(-90)");v+=(l.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":for(h=0;h<l.legend.fields.length;h++)Q[l.id][h]=Q[l.id][h].range([0,a.graphWidth]);f.selectAll("rect.multibar.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a,b){return parseInt(Q[l.id][a.i]?Q[l.id][a.i](a.value):0)}).attr("transform",function(b,e){return" translate("+parseInt(v+b.i*(a.graphWidth+
5))+",-"+parseInt(d)+")"});if(a.showGraphs&&a.showGraphLegend)for(h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+e+v+h*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");v+=l.legend.fields.length*(a.graphWidth+5);break;case "boxplot":A[l.id]=A[l.id].range([0,a.graphWidth]);f.selectAll("rect.q1.boxplot.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(A[l.id](a.median)-
A[l.id](a.q1))}).attr("transform",function(a,b){a=v+A[l.id](a.q1);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});f.selectAll("rect.q3.boxplot.gid"+l.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(A[l.id](a.q3)-A[l.id](a.median))}).attr("transform",function(a,b){a=v+A[l.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});f.selectAll("line.baseline.boxplot.gid"+l.id).attr("y1",parseInt(d)).attr("y2",parseInt(d)).attr("x1",function(a){return A[l.id](a.min)}).attr("x2",
function(a){return A[l.id](a.max)}).attr("transform",function(a,b){return" translate("+parseInt(v)+",-"+parseInt(d)+")"});f.selectAll("line.median.boxplot.gid"+l.id).attr("y1",0).attr("y2",parseInt(2*d)).attr("x1",function(a){return A[l.id](a.median)}).attr("x2",function(a){return A[l.id](a.median)}).attr("transform",function(a,b){return" translate("+parseInt(v)+",-"+parseInt(d)+")"});a.showGraphs&&a.showGraphLegend&&n.append("text").attr("class","legend").text(0!=l.legend.show?l.name:"").attr("transform",
"translate("+(phyd3.phylogram.dx+e+v+2*d)+", -10) rotate(-90)");v+=a.graphWidth+5;break;case "heatmap":f.selectAll("rect.heatmap.gid"+l.id).attr("width",2*d).attr("height",2*d).attr("transform",function(a,b){return" translate("+(v+2*a.i*d)+",-"+d+")"});if(a.showGraphs&&a.showGraphLegend)for(h=0;h<l.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=l.legend.show?l.legend.fields[h].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+e+v+(h+1)*d*2)+",-10) rotate(-90)");
v+=2*l.legend.fields.length*d+5}}n.selectAll("text.legend").attr("fill",u()).attr("font-size",2*a.nodeHeight)}}function va(){var d=a.nodeHeight;v=0;if(b.graphs)for(var e=0;e<b.graphs.length;e++){var f=b.graphs[e];switch(f.type){case "pie":v+=2*d+5;break;case "binary":v+=(f.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":v+=f.legend.fields.length*(a.graphWidth+5);break;case "heatmap":v+=2*f.legend.fields.length*d+5}}return 2*a.margin+(a.showNodeNames?K:0)+(a.showGraphs?v:0)+(a.showDomains?
a.domainWidth:0)}function oa(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,f=a.nodeHeight,k=d.x,g=d.y,m=0;m<b.length;m++){var n=b[m].x,t=b[m].y;if((n-k)*(n-k)+(t-g)*(t-g)<=4*f*f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};x.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);n.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function G(d,g){console.log("draw tree",
d,g);phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([R*a.scaleY,I*a.scaleX]);F=g(b);a.showPhylogram||phyd3.phylogram.scaleBranchLengths(F,I*a.scaleX);var f=n.selectAll("path.link");d||(f=f.data(g.links(F)),f.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",u()));f.attr("d",phyd3.phylogram.rightAngleDiagonal);S=void 0;c=0;f=F.filter(function(a){return!a.children});
for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?qa(f[g],!a.lineupNodes):!0;S=void 0;f=F.filter(function(a){return a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?qa(f[g],!0):!0;d||(N=N.data(F),N.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",function(d){var f=d3.event;f.ctrlKey?(ra(b,d.id),G(!0)):f.altKey?(sa(b,d.id),e()):void 0!==a.popupAction?a.popupAction(d):
ua(d)}).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+"px"));N.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function ma(b,d){if(b.name.match(d)){var e=!b.children&&a.lineupNodes?phyd3.phylogram.dx-b.y:0;n.selectAll("g.node.cid_"+b.id).append("rect").attr("class",
"searchResults").attr("width",K+"px").attr("height",2*a.nodeHeight+2+"px").attr("fill","yellow").style("opacity","0.3").attr("x",e+"px").attr("y","-"+(a.nodeHeight+1)+"px")}if(b.children)for(e=0;e<b.children.length;e++)r=ma(b.children[e],d);return!1}function ra(a,b,d){if(d||a.id==b)d=!0,a.branchset=a.branchset.reverse();if(a.children)for(var e=0;e<a.children.length;e++)ra(a.children[e],b,d)}function sa(a,d){if(a.id==d)b.branchset=[a];else if(a.children)for(var e=0;e<a.children.length;e++)sa(a.children[e],
d)}function M(){G(!0);V()}function qa(b,d){var e=!0,g=b.y+1,k=b.y+5.5*Y(b,!0).length,h=b.x-a.nodeHeight,p=b.x+a.nodeHeight;if(!S)return S=b,!0;a.lineupNodes&&!b.children&&(g+=phyd3.phylogram.dx-b.y,k+=phyd3.phylogram.dx-b.y);var m=S,n=m.y+1,t=m.y+5.5*Y(m,!0).length,q=m.x-a.nodeHeight,u=m.x+a.nodeHeight;a.lineupNodes&&!m.children&&(n+=phyd3.phylogram.dx-m.y,t+=phyd3.phylogram.dx-m.y);if(n<=g&&g<=t&&q<=h&&h<=u||n<=k&&k<=t&&q<=h&&h<=u||n<=g&&g<=t&&q<=p&&p<=u||n<=k&&k<=t&&q<=p&&p<=u)e=!1;if(e&&d)for(d=
0;d<phyd3.phylogram.lineAreas.length;d++)if(q=phyd3.phylogram.lineAreas[d],m=q.start[0],n=q.end[0],t=q.start[1],q=q.end[1],t==q){if(h<=t&&q<=p&&!(m>k||n<g)){e=!1;break}}else if(m==n&&g<=m&&n<=k&&!(t>p||q<h)){e=!1;break}e&&(S=b);return e}function V(){var b=Z.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;n.attr("transform",function(a){return"translate("+parseInt(d)+","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(pa(),a.dynamicHide&&E());g()}a=a||{};a.scaleY=a.scaleY||1;a.scaleX=
a.scaleX||1;a.translateX=a.translateX||0;a.translateY=a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||100;a.domainWidth=a.domainWidth||100;a.domainWidthStep=a.domainWidthStep||100;a.graphWidth=a.graphWidth||20;a.graphWidthStep=a.graphWidthStep||10;a.domainLevel=a.domainLevel||1;a.domainLevelStep=a.domainLevelStep||10;a.outline=a.outline||.3;a.popupWidth=a.popupWidth||
500;a.foregroundColor=a.foregroundColor||"#000";a.backgroundColor=a.backgroundColor||"#fff";a.branchLengthColor=a.branchLengthColor||"red";a.supportValuesColor=a.supportValuesColor||"blue";a.showNodesType=a.showNodesType||"only leaf";a.treeWidth=a.treeWidth||"auto";a.showFullTaxonomy="showFullTaxonomy"in a?a.showFullTaxonomy:!1;a.showLabels="showLabels"in a?a.showLabels:!0;a.showDomains="showDomains"in a?a.showDomains:!0;a.dynamicHide="dynamicHide"in a?a.dynamicHide:!1;a.invertColors="invertColors"in
a?a.invertColors:!1;a.lineupNodes="lineupNodes"in a?a.lineupNodes:!0;a.showSupportValues="showSupportValues"in a?a.showSupportValues:!1;a.showLengthValues="showLengthValues"in a?a.showLengthValues:!1;a.showTaxonomy="showTaxonomy"in a?a.showTaxonomy:!0;a.showTaxonomyColors="showTaxonomyColors"in a?a.showTaxonomyColors:!0;a.showDomainNames="showDomainNames"in a?a.showDomainNames:!1;a.showDomainColors="showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend=
"showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames="showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in a?a.showPhylogram:!1;var n,N,x,D,F,J,S,A=[],Q=[],L=100,K=100,v=0,T=100,ea=0,wa=jQuery.extend(!0,{},b),ta=!1;if(b.graphs)for(var ga=0;ga<b.graphs.length;ga++)if(0!=b.graphs[ga].legend.show){ta=!0;break}T=ta?T:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?T:0);var U=jQuery(d).width(),I="auto"==a.treeWidth?U-va():a.treeWidth,R=a.height-(2*a.margin+(a.showGraphs?
T:0)),I=parseInt(I),R=parseInt(R);0>I&&(I=U-2*K-(a.showGraphs?2*T:0));var Z=d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,g=.5;d.altKey||d.ctrlKey||(e=d.layerX/U,g=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=R*b*g;if(d.altKey||!d.ctrlKey)a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&
(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=I*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(M):requestAnimFrame(V)}});d3.select("#dynamicHide").on("click",function(){a.dynamicHide=!a.dynamicHide;G(!0);E()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;q()});jQuery("#foregroundColorButton").colorpicker().on("changeColor",
function(){a.foregroundColor=jQuery("#foregroundColor").val();q()});jQuery("#backgroundColorButton").colorpicker().on("changeColor",function(){a.backgroundColor=jQuery("#backgroundColor").val();q()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();M();O()});d3.select("#phylogram").on("click",function(){a.showPhylogram=!a.showPhylogram;G(!0);B();E()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;G(!0);ka();B();E()});d3.select("#lengthValues").on("click",
function(){a.showLengthValues=!a.showLengthValues;ia()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;ha();E()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=!a.showNodeNames;O();B()});d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;la()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;O();B()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;O();B()});
d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();M();O()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;ba()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);G(!0);B();E()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=a.nodeHeightStep;G(!0);B();E()});d3.select("#resetZoom").on("click",function(){b=
jQuery.extend(!0,{},wa);a.domainWidth=a.domainWidthStep;a.scaleX=1;a.scaleY=1;a.translateX=0;a.translateY=0;Z.translate([0,0]);e()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=R*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(M)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=R*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(M)});d3.select("#zoominX").on("click",function(){a.scaleX+=
a.scaleStep;a.translateX+=I*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(M)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=I*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(M)});d3.select("#domains").on("click",function(){a.showDomains=!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",
...
"disabled"));z();aa()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;ca()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;aa()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);J=phyd3.phylogram.scaledomainWidths(F,a.domainWidth);H()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;
J=phyd3.phylogram.scaledomainWidths(F,a.domainWidth);H()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;X()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=a.domainLevelStep;X()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?T:0);P();V()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",
null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));ja()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);B()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=
a.graphWidthStep;B()});d3.select("#linkSVG").on("click",function(){var a=w();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",function(){var a=w(),b=document.createElement("canvas");d3.select("g#main").node().getBBox();canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})});d3.select("#searchQuery").on("change",function(){g()});e()}})();
...
{show:parseInt(d.getAttribute("show")),fields:[],gradient:{}},a=d.getElementsByTagName("field"),e=0;e<a.length;e++){var g=a[e],u=g.getElementsByTagName("name")[0],u=u?u.textContent:"",q=g.getElementsByTagName("color")[0],q=q?q.textContent:"",w=g.getElementsByTagName("background")[0],w=w?w.textContent:"",z=g.getElementsByTagName("shape")[0],z=z?z.textContent:"",g=(g=g.getElementsByTagName("url")[0])?g.textContent:"";b.fields.push({name:u,color:q,background:w,shape:z,url:g})}if(d=d.getElementsByTagName("gradient")[0])u=
(u=d.getElementsByTagName("name")[0])?u.textContent:"",d=(d=d.getElementsByTagName("classes")[0])?parseInt(d.textContent):0,b.gradient={name:u,classes:d};return b};phyd3.phyloxml.parseData=function(d){var b={tag:d.getAttribute("tag"),ref:d.getAttribute("ref")},a=d.getElementsByTagName("min")[0];b.min=a?a.textContent:void 0;a=d.getElementsByTagName("max")[0];b.max=a?a.textContent:void 0;d=d.getElementsByTagName("values");for(a=0;a<d.length;a++){var e=d[a].getAttribute("for"),g=d[a].getElementsByTagName("value");
b[e]=[];for(var u=0;u<g.length;u++)b[e].push(parseFloat(g[u].textContent))}return b};phyd3.phyloxml.parseGraph=function(d){for(var b={name:"",legend:{},data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "name":b.name=e.textContent;break;case "legend":b.legend=phyd3.phyloxml.parseLegend(e);break;case "data":b.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+
" - skipping...")}}return b};phyd3.phyloxml.parseLabel=function(d){for(var b={showLegend:!1,name:"",data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "name":b.name=e.textContent;b.showLegend=e.getAttribute("show");break;case "data":b.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+" - skipping...")}}return b};phyd3.phyloxml.parse=function(d){var b=
...
a.childNodes[e],"graph"==w.nodeName&&g.push(phyd3.phyloxml.parseGraph(w));b.graphs=g;a=d.getElementsByTagName("labels");a=a[0];d=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)g=a.childNodes[e],"label"==g.nodeName&&d.push(phyd3.phyloxml.parseLabel(g));b.labels=d;return b}})();
/* Blob.js
