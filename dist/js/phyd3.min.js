...
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(b){var d=[],a={};b=b.split(/\s*(;|\(|\)|,|:)\s*/);for(var e=0,g=0;g<b.length;g++){var q=b[g];switch(q){case "(":q={};a.id=e;e++;a.branchset=[q];d.push(a);a=q;break;case ",":q={};d[d.length-1].branchset.push(q);a=q;break;case ")":a=d.pop();break;case ":":break;default:var l=b[g-1];")"==l||"("==l||","==l?a.name=q:":"==l&&(a.branchLength=parseFloat(q));a.id=e;e++}}return a}})();
...
function(){function b(a,b,d){0>d&&(d+=1);1<d&&--d;return d<1/6?a+6*(b-a)*d:.5>d?b:d<2/3?a+(b-a)*(2/3-d)*6:a}var d=Math.random();return function(a,d,g){if(0==d)g=d=a=g;else{var e=.5>g?g*(1+d):g+d-g*d,l=2*g-e;g=b(l,e,a+1/3);d=b(l,e,a);a=b(l,e,a-1/3)}return"#"+Math.round(255*g).toString(16)+Math.round(255*d).toString(16)+Math.round(255*a).toString(16)}((d+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(b,d){b=b.map(function(a){return a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture&&
a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(b)]).range([0,d])};phyd3.phylogram.build=function(b,d,a){function e(){return a.invertColors?a.backgroundColor:a.foregroundColor}function g(){var d=b.replace("#",""),d=document.getElementById(d).querySelector("svg"),e=d.getElementById("main"),f=e.getBBox(),e=e.getAttributeNode("transform"),t=d.getAttributeNode("width"),k=d.getAttributeNode("height"),h=e.value,
m=t.value,r=k.value;e.value="translate("+a.marginX+", "+a.marginY+")";t.value=(Math.max(+t.value.replace("px",""),f.width)+a.marginX).toString();k.value=(Math.max(+k.value.replace("px",""),f.height)+a.marginY).toString();if("undefined"!=typeof window.XMLSerializer)var g=(new XMLSerializer).serializeToString(d);else"undefined"!=typeof d.xml&&(g=d.xml);e.value=h;t.value=m;k.value=r;return g}function q(){a.showDomains?(H=phyd3.phylogram.scaledomainWidths(C,a.domainWidth),x.append("svg:path").attr("class",
"domain").attr("stroke",e()).attr("visibility",function(a,d){return a.show?"visibile":"hidden"}),D=D.data(function(a,d,f){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(f=0;f<a.length;f++)a[f].i=d;a.sort(function(a,f){return Math.abs(f.to-f.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),D.append("svg:rect").attr("class","domain hover-visible").attr("stroke",a.foregroundColor).attr("stroke-width",
a.outline+"px").append("title").text(function(a){return a.name}),v(),E(),z()):(D.remove(),x.selectAll("path.domain").remove(),D=x.selectAll("g.domain"))}function l(){a.showDomainNames?(D.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",e()).attr("font-size","10px").text(function(a){return a.name}),E()):D.selectAll("text.domain").remove()}function v(){var d=x.data();x.selectAll("g.domain").attr("visibility",function(b,f,p){return d[p].show&&b.confidence<=a.domainLevel?"visible":
"hidden"});x.selectAll("path.domain").attr("visibility",function(a){return a.show?"visible":"hidden"});d3.select("#domainLevel").attr("value",a.domainLevel.toPrecision(1))}function z(){D.selectAll("rect.domain").attr("fill",function(b){return a.showDomainColors&&d.domcolors[b.name]?d.domcolors[b.name].color.replace(/0x/,"#"):e()})}function E(){var d=x.data(),b=J+(a.showLabels?K:0)+(a.showGraphs?u:0);H=phyd3.phylogram.scaledomainWidths(C,a.domainWidth);x.selectAll("path.domain").attr("d",function(f,
e,p){e=a.lineupNodes?phyd3.phylogram.dx-d[p].y:0;f=f.sequences&&f.sequences[0]&&f.sequences[0].domainArchitecture?f.sequences[0].domainArchitecture.sequenceLength:0;return"M"+parseInt(b+e)+",0L"+parseInt(b+e+H(f))+",0"});D.selectAll("rect.domain").attr("width",function(a){return parseInt(H(a.to-a.from))}).attr("transform",function(f,e,p){return"translate("+parseInt(b+(a.lineupNodes?phyd3.phylogram.dx-d[f.i].y:0)+H(f.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);D.selectAll("text.domain").attr("transform",
function(f){return"translate("+parseInt(b+(a.lineupNodes?phyd3.phylogram.dx-d[f.i].y:0)+H(f.from))+","+parseInt(-1*a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",a.domainWidth)}function ba(){a.showSupportValues?(n.selectAll("g.inner.node").append("svg:text").attr("class","supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(a){var d="";if(a.confidences)for(var f in a.confidences)d+=parseFloat(a.confidences[f].value)+" ";return d}),B()):
n.selectAll("text.supportValue").remove()}function ca(){a.showLengthValues?(n.selectAll("g.node").append("svg:text").attr("class","branchLength").attr("dx",-2).attr("text-anchor","end").attr("fill",a.branchLengthColor).text(function(a){return a.branchLength?parseFloat(a.branchLength).toFixed(5):""}),B()):n.selectAll("text.branchLength").remove()}function W(a,d,f){var b=a.attr("id")+"_"+a.selectAll("div.panel-default").size(),e=a.append("div").attr("class","panel panel-default");e.append("div").attr("class",
...
"panel-body table-responsive")}function la(e){var w=d3.event,f=w.layerX;y=w.layerY;var p="popup"+parseInt(Date.now()*Math.random()*1E3),f=d3.select(b).append("div").attr("class","popup").attr("id",p).style("position","absolute").style("top",parseInt(y)+"px").style("left",parseInt(f)+"px").style("width",parseInt(a.popupWidth)+"px").style("color",a.foregroundColor).style("background-color",a.backgroundColor),k=f.append("button").attr("class","btn btn-link").style("position","absolute").style("right",
"8px");k.append("span").attr("class","glyphicon glyphicon-remove").attr("aria-hidden","true");k.on("click",function(){d3.select("#"+p).remove();n.selectAll("g.node.cid_"+e.id).selectAll("rect.pointer").style("opacity","0")});f=f.append("div").attr("class","panel-group").attr("id","accordion_"+parseInt(Date.now()*Math.random()*1E3)).attr("role","tablist").attr("aria-multiselectable","true");k="text"==w.target.nodeName||w.target.classList.contains("pointer")?!0:!1;k=W(f,"Node",k).append("table").attr("class",
"table table-condensed table-bordered").append("tbody");if(e.name){var h=k.append("tr");h.append("td").text("Name");h.append("td").text(e.name)}if(e.taxonomies)for(var m=0;m<e.taxonomies.length;m++){var r=e.taxonomies[m],h=k.append("tr");h.append("td").text("Taxononomy");h=h.append("td");d.taxcolors[r.code]&&d.taxcolors[r.code].url&&(h=h.append("a").attr("href",d.taxcolors[r.code].url).attr("target","_blank"));var g="",g=g+(d.taxcolors[r.code]&&d.taxcolors[r.code].name?d.taxcolors[r.code].name+" ":
""),g=g+" ",g=g+(r.scientificName?"\x3ci\x3e"+r.scientificName+"\x3c/i\x3e":""),g=g+" ",g=g+(r.commonName?r.commonName:""),g=g+" ",g=g+(r.code?"("+r.code+")":"");h.html(g)}if(e.confidences)for(m=0;m<e.confidences.length;m++)h=k.append("tr"),h.append("td").text("Confidence"),h.append("td").html(e.confidences[m].value);h=k.append("tr");h.append("td").text("Depth");h.append("td").text(e.depth);h=k.append("tr");h.append("td").text("Branch length");h.append("td").text(e.branchLength?e.branchLength:0);
h=k.append("tr");h.append("td").text("Distance from root");h.append("td").text(e.rootDist);for(m=0;m<e.properties.length;m++)h=e.properties[m],l=h.ref,r=h.value,r=r.trim(),/^http:\/\//.test(r)&&(r="\x3ca href\x3d'"+r+"' target\x3d'_blank'\x3e"+r+"\x3c/a\x3e\x3cbr /\x3e"),h=k.append("tr"),h.append("td").text(l),h.append("td").html(r);for(var l in e.events)r=e.events[l],h=k.append("tr"),h.append("td").text(l),h.append("td").html(r);if(e.sequences)for(m=0;m<e.sequences.length;m++)if(e.sequences[m].domainArchitecture&&
e.sequences[m].domainArchitecture.domains){k=w.target.parentNode.classList.contains("domain")?!0:!1;k=W(f,"Domains",k).append("table").attr("id","dt"+p).attr("class","table table-condensed table-bordered");l=k.append("thead").append("tr");l.append("th").text("#");l.append("th").text("Name");l.append("th").text("Description");l.append("th").text("From");l.append("th").text("To");l.append("th").text("P value");k=k.append("tbody");for(r=0;r<e.sequences[m].domainArchitecture.domains.length;r++)g=e.sequences[m].domainArchitecture.domains[r],
h=k.append("tr"),h.append("td").style("background",d.domcolors[g.name]&&d.domcolors[g.name].color?d.domcolors[g.name].color.replace("0x","#"):"").text(" "),l=h.append("td"),d.domcolors[g.name]&&d.domcolors[g.name].url&&(l=l.append("a").attr("href",d.domcolors[g.name].url).attr("target","_blank")),l.text(g.name),h.append("td").text(d.domcolors[g.name]?d.domcolors[g.name].description:""),h.append("td").text(g.from),h.append("td").text(g.to),h.append("td").text(g.confidence);$("#dt"+p).dataTable({searching:!1,
paging:!1,language:{info:""},order:[[3,"asc"]],columns:[{orderable:!1},null,null,null,null,null]})}if(d.graphs)for(m=0;m<d.graphs.length;m++)if(g=d.graphs[m],g.data&&g.data[e.id]&&g.data[e.id].length)for(k=w.target.parentNode.classList.contains(g.type)?!0:!1,k=W(f,g.name,k).append("table").attr("class","table table-condensed table-bordered").append("tbody"),r=0;r<g.legend.fields.length;r++)h=k.append("tr"),l=h.append("td"),g.legend.fields[r].url&&(l=l.append("a").attr("href",g.legend.fields[r].url).attr("target",
"_blank")),l.text(g.legend.fields[r].name),h.append("td").text(g.data[e.id][r]);n.selectAll("g.node.cid_"+e.id).selectAll("rect.pointer").style("opacity","1");w.stopPropagation()}function da(){a.lineupNodes?n.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",e()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):n.selectAll("path.support").remove()}function R(b){if(b.children&&"only leaf"==a.showNodesType||!b.children&&"only inner"==a.showNodesType)return"";var e=
"";if(a.showTaxonomy&&b.taxonomies)for(var f in b.taxonomies){var p=b.taxonomies[f];a.showFullTaxonomy&&(e+=d.taxcolors[p.code]&&d.taxcolors[p.code].name?d.taxcolors[p.code].name:"",e+=" ",e+=p.scientificName?p.scientificName:"",e+=" ",e+=p.commonName?p.commonName:"",e+=" ");e+=p.code?p.code:"";e+=" "}e+=(a.showNodeNames&&b.name?b.name:"")+" ";if(a.showSequences&&b.sequences)for(var g in b.sequences)if(f=b.sequences[g],e+=f.symbol?f.symbol:"",e+=" ",e+=f.accession?f.accession.value:"",e+=" ",e+=f.name?
f.name:"",e+=" ",e+=f.geneName?f.geneName:"",e+=" ",f.annotations)for(var h in f.annotations)e+=f.annotations[h].desc?f.annotations[h].desc:"",e+=" ";return e}function S(){var d=0;x.selectAll("text.name").text(function(a){a=R(a);a.length>d&&(d=a.length);return a});n.selectAll("g.node.inner").selectAll("text.name").text(R);a.showGraphs&&L();a.showDomains&&E()}function I(){x.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&x.selectAll("path.support").attr("visibility",
function(a){return a.show?"visible":"hidden"});a.showLabels&&ea();a.showGraphs&&fa();a.showDomains&&v()}function X(){n.selectAll("text.name").attr("stroke",e()).attr("stroke-width",a.outline+"px").attr("fill",function(b){var p=null;if(a.showTaxonomyColors&&d.taxcolors&&b.taxonomies)for(var f in b.taxonomies){var g=b.taxonomies[f];d.taxcolors[g.code]&&d.taxcolors[g.code].color&&(p=d.taxcolors[g.code].color.replace(/0x/,"#"))}return p?p:e()})}function ga(){x.selectAll("text.name").attr("dx",function(d){return parseInt(a.lineupNodes?
phyd3.phylogram.dx-d.y+5:5)});x.selectAll("path.support").attr("d",function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-a.y)+",0"});a.showLabels&&Y();a.showGraphs&&L();a.showDomains&&E()}function B(){n.selectAll("text.name").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.branchLength").attr("dy",-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");n.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");J=100*a.nodeHeight/
6+10;d3.select("#nodeHeight").attr("value",a.nodeHeight);ga();a.showLabels&&Y();a.showGraphs&&L();a.showDomains&&E()}function ha(){if(a.showLabels&&d.labels){for(var b=0;b<d.labels.length;b++){var g=d.labels[b];g.id||(g.id=parseInt(Date.now()*Math.random()*1E3));g.data.tag&&n.selectAll("g.node").each(function(a){var b=a[g.data.tag],d=g.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==g.data.tag)for(pid in a.properties){var e=a.properties[pid];if(e.ref==d){b=e.value;break}}b&&(g.data[a.id]=
b)});switch(g.type){case "text":for(cid in g.data)g.data[cid]&&n.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+g.id).attr("dy",3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",e()).attr("fill",e()).attr("font-size",1.5*a.nodeHeight+"px").attr("visibility","visible").text(g.data[cid]).append("title").text(g.name+": "+g.data[cid]);break;case "color":for(cid in g.data)if(g.data[cid]){var f=a.nodeHeight,t=g.data[cid].replace(/0x/,"#");n.selectAll(".cid_"+
cid).append("rect").attr("height",2*f).attr("width",2*f).attr("class","nodelabel color lid"+g.id).attr("style","fill: "+t+"; stroke: "+t).append("title").text(g.name)}}}ea();Y()}else n.selectAll(".nodelabel").remove(),K=0;L();E()}function Y(){var b=a.nodeHeight;K=0;if(d.labels){for(var e=0;e<d.labels.length;e++){var f=d.labels[e],g=0;x.selectAll(".nodelabel.lid"+f.id).attr("transform",function(d){var e=0,m=0;"color"==f.type&&(e=m=-b);var p=0;"text"==this.nodeName&&this.firstChild?p=this.firstChild.length*
b/1.5:"rect"==this.nodeName&&(p=2*b);p>g&&(g=p);return"translate("+parseInt(e+b+K+(a.lineupNodes?phyd3.phylogram.dx-d.y+J:J))+","+m+")"});K+=g+2*b}e=x.selectAll(".nodelabel");e.selectAll("text").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");e.selectAll("rect").attr("width",2*a.nodeHeight).attr("height",2*a.nodeHeight)}}function ea(){x.selectAll(".nodelabel").attr("visibility",function(a){return a.show?"visible":"hidden"})}function ia(){if(a.showGraphs&&d.graphs&&d.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);
for(var b=d3.layout.pie().value(function(a){return a.value}).sort(null),g=u=0;g<d.graphs.length;g++){var f=d.graphs[g];f.id||(f.id=parseInt(Date.now()*Math.random()*1E3));if(f.data.tag)var t=n.selectAll("g.node").each(function(a){var b=a[f.data.tag],d=f.data.ref,d=d?d:"value",b="object"==typeof b?b[d]:b;if("property"==f.data.tag)for(pid in a.properties){var e=a.properties[pid];if(e.ref==d){b=e.value;break}}b&&(f.data[a.id]=[],f.data[a.id][0]=b,"pie"==f.type&&f.data.max&&(f.data[a.id][1]=f.data.max-
b,f.legend.fields[1]={name:f.legend.fields[0].name,color:f.legend.fields[0].background?f.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(f.type){case "pie":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){var k=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(k=!0)});for(var t=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph pie gid"+f.id),h=[],m=0;m<f.data[cid].length;m++)void 0!=f.data[cid][m]&&h.push({i:m,value:f.data[cid][m],
leaf:k});t=t.selectAll("path.pie.gid"+f.id).data(b(h)).enter().append("path").attr("class","pie hover-visible gid"+f.id).attr("stroke",e()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return f.legend.fields?(f.legend.fields[b]||(f.legend.fields[b]={},f.legend.fields[b].name="Series "+(b+1),f.legend.fields[b].color=phyd3.phylogram.randomColor()),f.legend.fields[b].color.replace(/0x/,"#")):""}).append("title").text(function(a,b){return f.legend.fields?(f.legend.fields[b]&&f.legend.fields[b].name?
f.legend.fields[b].name+": ":"")+(f.legend.fields[b].invert?f.data.max-a.data.value:a.data.value):""})}break;case "binary":for(cid in f.data)if(f.data[cid]&&Array.isArray(f.data[cid])){h=[];k=!1;n.select(".cid_"+cid).each(function(a){0==a.branchset.length&&(k=!0)});t=n.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+f.id);for(m=0;m<f.data[cid].length;m++)void 0!=f.data[cid][m]&&h.push({i:m,value:f.data[cid][m],shape:f.legend.fields[m]?f.legend.fields[m].shape:"",leaf:k});t=
t.selectAll("path.binary.gid"+f.id).data(h).enter().append("path").attr("class","binary hover-visible gid"+f.id).attr("style",function(a,b){b=(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":M[f.id]=[];for(m=0;m<f.legend.fields.length;m++)t=d3.max(d3.values(f.data),function(a){if(a)return a[m]}),
M[f.id][m]=d3.scale.linear().domain([0,t]);for(cid in f.data)if(f.data[cid]){t=n.select(".cid_"+cid).append("svg:g").attr("class","graph multibar gid"+f.id);h=[];for(m=0;m<f.data[cid].length;m++)void 0!=f.data[cid][m]&&h.push({i:m,value:f.data[cid][m]});t=t.selectAll("rect.multibar.gid"+f.id).data(h).enter().append("rect").attr("class","multibar hover-visible gid"+f.id).attr("fill",function(a,b){return(f.legend.fields[b]?f.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",a.foregroundColor).attr("stroke-width",
a.outline).append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;case "boxplot":A[f.id]=null;t=0;h=Number.MAX_SAFE_INTEGER;for(m=0;5>m;m++){var r=d3.max(d3.values(f.data),function(a){if(a)return a[m]}),l=d3.max(d3.values(f.data),function(a){if(a)return a[m]});r>t&&(t=r);l<h&&(h=l)}A[f.id]=d3.scale.linear().domain([h,t]);for(cid in f.data)f.data[cid]&&(t=n.select(".cid_"+cid).append("svg:g").attr("class","graph boxplot gid"+f.id),h=[],h.push({min:f.data[cid][0],
q1:f.data[cid][1],median:f.data[cid][2],q3:f.data[cid][3],max:f.data[cid][4]}),t=t.selectAll("rect.boxplot.gid"+f.id).data(h).enter(),t.append("line").attr("class","boxplot baseline hover-visible gid"+f.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",e()),t.append("rect").attr("class","boxplot q1 hover-visible gid"+f.id).attr("fill",(f.legend.fields[0]?f.legend.fields[0].color:"").replace(/0x/,"#")).attr("stroke",a.foregroundColor).attr("stroke-width",
a.outline).append("title").text(function(a){return"Min: "+a.min+", Q1: "+a.q1+", Median: "+a.median}),t.append("rect").attr("class","boxplot q3 hover-visible gid"+f.id).attr("fill",(f.legend.fields[1]?f.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",e()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+a.median+", Q3: "+a.q3+", Max: "+a.max}),t.append("line").attr("class","boxplot median hover-visible gid"+f.id).attr("stroke",e()).attr("stroke-width","2px"));
break;case "heatmap":var r=d3.max(d3.values(f.data),function(a){if(a)return d3.max(a)}),l=d3.min(d3.values(f.data),function(a){if(a)return d3.min(a)}),q=d3.scale.quantize().domain([l,r]).range(colorbrewer[f.legend.gradient.name][f.legend.gradient.classes]);for(cid in f.data)if(f.data[cid]){t=n.select(".cid_"+cid).append("svg:g").attr("class","graph heatmap gid"+f.id);h=[];if(f.data[cid])for(m=0;m<f.data[cid].length;m++)void 0!=f.data[cid][m]&&h.push({i:m,value:f.data[cid][m]});t=t.selectAll("rect.heatmap.gid"+
f.id).data(h).enter().append("rect").attr("class","heatmap hover-visible gid"+f.id).attr("fill",function(a,b){return q(a.value)}).attr("stroke",a.foregroundColor).attr("stroke-width",a.outline+"px").append("title").text(function(a,b){return(f.legend.fields[b]?f.legend.fields[b].name+": ":"")+a.value})}break;default:console.log("Graph not supported "+f.type)}}fa();L()}else u=0,n.selectAll("g.graph").remove(),n.selectAll("text.legend").remove();E()}function L(){var b=a.nodeHeight,g=J+K;x.selectAll("g.graph").attr("transform",
function(b){return"translate("+(a.lineupNodes?phyd3.phylogram.dx-b.y+g:g)+",0)"});var f=n.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);n.selectAll("text.legend").remove();u=0;if(d.graphs){for(var l=0;l<d.graphs.length;l++){var k=d.graphs[l];switch(k.type){case "pie":f.selectAll("path.pie.gid"+k.id).attr("d",function(a){if(0<a.value)return d3.svg.arc().innerRadius(0).outerRadius(b)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?b+u:0)+",0)"});
a.showGraphLegend&&n.append("text").attr("class","legend").text(0!=k.legend.show?k.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+u+2*b)+",-10) rotate(-90)");u+=2*b+5;break;case "binary":f.selectAll("path.binary.gid"+k.id).attr("d",function(a){var d=d3.svg.symbol().size(4*(b-2)*(b-2));d.type(k.legend.fields[a.i].shape);return d(a)}).attr("transform",function(a){return" translate("+(a.leaf?u+10+a.i*(2*b+5):0)+" ,0)"});if(a.showGraphLegend)for(var h=0;h<k.legend.fields.length;h++)n.append("text").attr("class",
"legend").text(0!=k.legend.show?k.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+u+h*(2*b+5)+2*b)+", -10) rotate(-90)");u+=(k.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":for(h=0;h<k.legend.fields.length;h++)M[k.id][h]=M[k.id][h].range([0,a.graphWidth]);f.selectAll("rect.multibar.gid"+k.id).attr("height",parseInt(2*b)).attr("width",function(a,b){return parseInt(M[k.id][a.i]?M[k.id][a.i](a.value):0)}).attr("transform",function(d,e){return" translate("+parseInt(u+
d.i*(a.graphWidth+5))+",-"+parseInt(b)+")"});if(a.showGraphLegend)for(h=0;h<k.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=k.legend.show?k.legend.fields[h].name:"").attr("transform","translate("+(phyd3.phylogram.dx+g+u+h*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");u+=k.legend.fields.length*(a.graphWidth+5);break;case "boxplot":A[k.id]=A[k.id].range([0,a.graphWidth]);f.selectAll("rect.q1.boxplot.gid"+k.id).attr("height",parseInt(2*b)).attr("width",function(a){return parseInt(A[k.id](a.median)-
A[k.id](a.q1))}).attr("transform",function(a,d){a=u+A[k.id](a.q1);return" translate("+parseInt(a)+",-"+parseInt(b)+")"});f.selectAll("rect.q3.boxplot.gid"+k.id).attr("height",parseInt(2*b)).attr("width",function(a){return parseInt(A[k.id](a.q3)-A[k.id](a.median))}).attr("transform",function(a,d){a=u+A[k.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(b)+")"});f.selectAll("line.baseline.boxplot.gid"+k.id).attr("y1",parseInt(b)).attr("y2",parseInt(b)).attr("x1",function(a){return A[k.id](a.min)}).attr("x2",
function(a){return A[k.id](a.max)}).attr("transform",function(a,d){return" translate("+parseInt(u)+",-"+parseInt(b)+")"});f.selectAll("line.median.boxplot.gid"+k.id).attr("y1",0).attr("y2",parseInt(2*b)).attr("x1",function(a){return A[k.id](a.median)}).attr("x2",function(a){return A[k.id](a.median)}).attr("transform",function(a,d){return" translate("+parseInt(u)+",-"+parseInt(b)+")"});u+=a.graphWidth+5;break;case "heatmap":f.selectAll("rect.heatmap.gid"+k.id).attr("width",2*b).attr("height",2*b).attr("transform",
function(a,d){return" translate("+(u+2*a.i*b)+",-"+b+")"});if(a.showGraphLegend)for(h=0;h<k.legend.fields.length;h++)n.append("text").attr("class","legend").text(0!=k.legend.show?k.legend.fields[h].name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+g+u+(h+1)*b*2)+",-10) rotate(-90)");u+=2*k.legend.fields.length*b+5}}n.selectAll("text.legend").attr("fill",e()).attr("font-size",2*a.nodeHeight)}}function ma(){var b=a.nodeHeight;u=0;if(d.graphs)for(var e=0;e<d.graphs.length;e++){var f=
d.graphs[e];switch(f.type){case "pie":u+=2*b+5;break;case "binary":u+=(f.legend.fields.length+1)*(2*b+5)+5;break;case "multibar":u+=f.legend.fields.length*(a.graphWidth+5);break;case "heatmap":u+=2*f.legend.fields.length*b+5}}return 2*a.margin+(a.showNodeNames?J:0)+(a.showGraphs?u:0)+(a.showDomains?a.domainWidth:0)}function fa(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,f=a.nodeHeight,g=d.x,l=d.y,p=0;p<b.length;p++){var n=b[p].x,w=b[p].y;if((n-g)*(n-g)+(w-l)*(w-l)<=4*f*
f){e=!1;break}}return e?(b.push(d),"visible"):"hidden"};x.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});n.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);n.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function F(b){phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;var g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([N*a.scaleY,G*a.scaleX]);C=g(d);a.showPhylogram||
phyd3.phylogram.scaleBranchLengths(C,G*a.scaleX);var f=n.selectAll("path.link");b||(f=f.data(g.links(C)),f.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",e()));f.attr("d",phyd3.phylogram.rightAngleDiagonal);O=void 0;c=0;f=C.filter(function(a){return!a.children});for(g=0;g<f.length;g++)f[g].show=a.dynamicHide?ja(f[g],!a.lineupNodes):!0;O=void 0;f=C.filter(function(a){return a.children});for(g=0;g<f.length;g++)0<R(f[g]).trim().length?f[g].show=a.dynamicHide?ja(f[g],
!0):!0:f[g].show=!1;b||(T=T.data(C),T.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).style("cursor","pointer").on("click",void 0===a.popupAction?la:a.popupAction).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+
"px"));T.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function P(){F(!0);U()}function ja(b,d){var e=!0,g=b.y+1,k=b.y+5.5*R(b).length,h=b.x-a.nodeHeight,l=b.x+a.nodeHeight;if(!O)return O=b,!0;a.lineupNodes&&!b.children&&(g+=phyd3.phylogram.dx-b.y,k+=phyd3.phylogram.dx-b.y);var p=O,n=p.y+1,q=p.y+5.5*R(p).length,w=p.x-a.nodeHeight,u=p.x+a.nodeHeight;a.lineupNodes&&!p.children&&(n+=phyd3.phylogram.dx-p.y,q+=phyd3.phylogram.dx-p.y);
if(n<=g&&g<=q&&w<=h&&h<=u||n<=k&&k<=q&&w<=h&&h<=u||n<=g&&g<=q&&w<=l&&l<=u||n<=k&&k<=q&&w<=l&&l<=u)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(w=phyd3.phylogram.lineAreas[d],p=w.start[0],n=w.end[0],q=w.start[1],w=w.end[1],q==w){if(h<=q&&w<=l&&!(p>k||n<g)){e=!1;break}}else if(p==n&&g<=p&&n<=k&&!(q>l||w<h)){e=!1;break}e&&(O=b);return e}function U(){var b=Z.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;n.attr("transform",function(a){return"translate("+parseInt(d)+
","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(ga(),a.dynamicHide&&I())}a=a||{};a.scaleY=a.scaleY||1;a.scaleX=a.scaleX||1;a.translateX=a.translateX||0;a.translateY=a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||100;a.domainWidth=a.domainWidth||100;a.domainWidthStep=a.domainWidthStep||100;a.graphWidth=a.graphWidth||20;a.graphWidthStep=a.graphWidthStep||10;a.domainLevel=
a.domainLevel||1;a.domainLevelStep=a.domainLevelStep||10;a.outline=a.outline||.3;a.popupWidth=a.popupWidth||500;a.foregroundColor=a.foregroundColor||"#000";a.backgroundColor=a.backgroundColor||"#fff";a.branchLengthColor=a.branchLengthColor||"red";a.supportValuesColor=a.supportValuesColor||"blue";a.showNodesType=a.showNodesType||"only leaf";a.treeWidth=a.treeWidth||"auto";a.showFullTaxonomy="showFullTaxonomy"in a?a.showFullTaxonomy:!1;a.showLabels="showLabels"in a?a.showLabels:!0;a.showDomains="showDomains"in
a?a.showDomains:!0;a.dynamicHide="dynamicHide"in a?a.dynamicHide:!1;a.invertColors="invertColors"in a?a.invertColors:!1;a.lineupNodes="lineupNodes"in a?a.lineupNodes:!0;a.showSupportValues="showSupportValues"in a?a.showSupportValues:!1;a.showLengthValues="showLengthValues"in a?a.showLengthValues:!1;a.showTaxonomy="showTaxonomy"in a?a.showTaxonomy:!0;a.showTaxonomyColors="showTaxonomyColors"in a?a.showTaxonomyColors:!0;a.showDomainNames="showDomainNames"in a?a.showDomainNames:!1;a.showDomainColors=
"showDomainColors"in a?a.showDomainColors:!0;a.showGraphs="showGraps"in a?a.showGraphs:!0;a.showGraphLegend="showGraphLegend"in a?a.showGraphLegend:!0;a.showNodeNames="showNodeNames"in a?a.showNodeNames:!0;a.showPhylogram="showPhylogram"in a?a.showPhylogram:!1;var C,H,O,A=[],M=[],K=100,J=100,u=0,Q=100,ka=!1;if(d.graphs)for(var aa=0;aa<d.graphs.length;aa++)if(0!=d.graphs[aa].legend.show){ka=!0;break}Q=ka?Q:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?Q:0);var V=$(b).width(),G="auto"==a.treeWidth?
V-ma():a.treeWidth,N=a.height-(2*a.margin+(a.showGraphs?Q:0)),G=parseInt(G),N=parseInt(N);0>G&&(G=V-2*J-(a.showGraphs?2*Q:0));var Z=d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,g=.5;d.altKey||d.ctrlKey||(e=d.layerX/V,g=d.layerY/a.height);if(d.ctrlKey||!d.altKey)a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=N*b*g;if(d.altKey||
!d.ctrlKey)a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=G*b*e;a.lastScale=b;0!=a.lastScale?requestAnimFrame(P):requestAnimFrame(U)}});d3.select(b).select("svg").remove();var n=d3.select(b).insert("svg").attr("width",V+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version",
"1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(Z);n.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height","100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);n.append("svg:text").attr("dy","20px").attr("stroke",e()).attr("stroke-width","1px").attr("font-size","15px").text(d.name?d.name:"");n.append("svg:text").attr("dy","40px").attr("stroke",e()).attr("stroke-width","0.5px").attr("font-size","10px").text(d.description?
d.description:"");n.append("defs").append("marker").attr("id","markerBoxplot").attr("markerWidth","1").attr("markerHeight","10").attr("refX","1").attr("refY","5").append("line").attr("x1","0").attr("x2","0").attr("y1","0").attr("y2","10").attr("stroke",e()).attr("stroke-width","2px");var n=n.append("svg:g").attr("id","main").attr("transform","translate("+a.marginX+", "+a.marginY+")"),T=n.selectAll("g.node");F();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),
a.showPhylogram=!0,F());var x=n.selectAll("g.leaf.node"),D=x.selectAll("g.domain");ba();ca();q();l();ia();da();ha();T.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");X();S();I();U();B();d3.select("#dynamicHide").on("click",function(){a.dynamicHide=!a.dynamicHide;F(!0);I()});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);
var b=e();n.selectAll("path.link").attr("stroke",b);n.selectAll("text.legend").attr("fill",b);x.selectAll("path.support").attr("stroke",b);x.selectAll("path.domain").attr("stroke",b);x.selectAll("text.nodelabel").attr("stroke",b).attr("fill",b);X();z()});d3.select("#phylogram").on("click",function(){a.showPhylogram=!a.showPhylogram;F(!0);B();I()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;F(!0);da();B();I()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=
!a.showLengthValues;ca()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;ba();I()});d3.select("#nodeNames").on("click",function(){a.showNodeNames=!a.showNodeNames;S();B()});d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;ha()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;S();B()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;S();B()});d3.select("#nodesType").on("change",
function(){a.showNodesType=$(this).val();P();S()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;X()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);F(!0);B();I()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=a.nodeHeightStep;F(!0);B();I()});d3.select("#resetZoom").on("click",function(){a.domainWidth=a.domainWidthStep;a.scaleX=1;
a.scaleY=1;a.translateX=0;a.translateY=0;F(!0);Z.translate([0,0]);U();B()});d3.select("#zoominY").on("click",function(){a.scaleY+=a.scaleStep;a.translateY+=N*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(P)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=N*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(P)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=G*a.scaleStep/2;
a.lastScale=a.scaleStep;requestAnimFrame(P)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX-=G*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(P)});d3.select("#domains").on("click",function(){a.showDomains=!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",null),d3.select("#domainWidthHigher").attr("disabled",
null),d3.select("#domainLevelLower").attr("disabled",null),d3.select("#domainLevelHigher").attr("disabled",null)):(d3.select("#domainNames").attr("disabled","disabled"),d3.select("#domainColors").attr("disabled","disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled","disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));q();l()});d3.select("#domainColors").on("click",
function(){a.showDomainColors=!a.showDomainColors;z()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;l()});d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);H=phyd3.phylogram.scaledomainWidths(C,a.domainWidth);E()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;H=phyd3.phylogram.scaledomainWidths(C,a.domainWidth);E()});
d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;v()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=a.domainLevelStep;v()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?Q:0);L();U()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),
d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),d3.select("#graphWidthHigher").attr("disabled","disabled"));ia()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);B()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=a.graphWidthStep;B()});d3.select("#linkSVG").on("click",
function(){var a=g();saveAs(new Blob([unescape(encodeURIComponent(a))],{type:"application/svg+xml"}),"phylogram.svg")});d3.select("#linkPNG").on("click",function(){var a=g(),b=document.createElement("canvas");canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})})}})();
...
return d};phyd3.phyloxml.parseLegend=function(b){for(var d={show:parseInt(b.getAttribute("show")),fields:[],gradient:{}},a=b.getElementsByTagName("field"),e=0;e<a.length;e++){var g=a[e],q=g.getElementsByTagName("name")[0],q=q?q.textContent:"",l=g.getElementsByTagName("color")[0],l=l?l.textContent:"",v=g.getElementsByTagName("background")[0],v=v?v.textContent:"",z=g.getElementsByTagName("shape")[0],z=z?z.textContent:"",g=(g=g.getElementsByTagName("url")[0])?g.textContent:"";d.fields.push({name:q,color:l,
background:v,shape:z,url:g})}if(b=b.getElementsByTagName("gradient")[0])q=(q=b.getElementsByTagName("name")[0])?q.textContent:"",b=(b=b.getElementsByTagName("classes")[0])?parseInt(b.textContent):0,d.gradient={name:q,classes:b};return d};phyd3.phyloxml.parseData=function(b){var d={tag:b.getAttribute("tag"),ref:b.getAttribute("ref")},a=b.getElementsByTagName("min")[0];d.min=a?a.textContent:void 0;a=b.getElementsByTagName("max")[0];d.max=a?a.textContent:void 0;b=b.getElementsByTagName("values");for(a=
0;a<b.length;a++){var e=b[a].getAttribute("for"),g=b[a].getElementsByTagName("value");d[e]=[];for(var q=0;q<g.length;q++)d[e].push(parseFloat(g[q].textContent))}return d};phyd3.phyloxml.parseGraph=function(b){for(var d={name:"",legend:{},data:{},type:b.getAttribute("type")},a=0;a<b.childNodes.length;a++){var e=b.childNodes[a];switch(e.nodeName){case "name":d.name=e.textContent;break;case "legend":d.legend=phyd3.phyloxml.parseLegend(e);break;case "data":d.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;
...
break;case "date":d.date=g.textContent;break;case "description":d.description=g.textContent;break;case "id":d.id=g.textContent;break;case "name":d.name=g.textContent;break;case "property":d.properties.push(phyd3.phyloxml.parseProperty(g));break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+g.nodeName+" "+g.textContent+" - skipping...")}}var a=b.getElementsByTagName("taxonomies"),a=a[0],q={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++){var l=a.childNodes[e];if("color"==
l.nodeName){var g=l.getElementsByTagName("code")[0].textContent,v=l.getElementsByTagName("value")[0].textContent;q[g]={color:v}}if("taxonomy"==l.nodeName){var g=l.getAttribute("code"),v=(v=l.getElementsByTagName("color")[0])?v.textContent:v,z=l.getElementsByTagName("name")[0],z=z?z.textContent:z,l=(l=l.getElementsByTagName("url")[0])?l.textContent:l;q[g]={color:v,name:z,url:l}}}d.taxcolors=q;a=b.getElementsByTagName("domains");a=a[0];q={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)l=a.childNodes[e],
"color"==l.nodeName&&(g=l.getElementsByTagName("code")[0].textContent,v=l.getElementsByTagName("value")[0].textContent,q[g]={color:v}),"domain"==l.nodeName&&(g=l.getAttribute("name"),v=(v=l.getElementsByTagName("color")[0])?v.textContent:v,z=(z=l.getElementsByTagName("description")[0])?z.textContent:z,l=(l=l.getElementsByTagName("url")[0])?l.textContent:l,q[g]={color:v,description:z,url:l});d.domcolors=q;a=b.getElementsByTagName("graphs");a=a[0];g=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)v=
